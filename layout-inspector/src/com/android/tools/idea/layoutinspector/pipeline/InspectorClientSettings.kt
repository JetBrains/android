...
/** Inspector pipeline settings that should be considered global within a project and preserved across multiple inspector clients. */
class InspectorClientSettings(private val project: Project) {
  /** The user's preference to use continuous capturing mode in the layout inspector, whenever supported by the current client. */
  var inLiveMode
  ...
  /** Enable capturing of bitmap screenshots. The agent will otherwise only capture view boundaries and SKP screenshots. */
