 ...
 */
class AppInspectionTreeLoader(private val project: Project, private val client: AppInspectionInspectorClient) : TreeLoader {
  override fun loadComponentTree(data: Any?, resourceLookup: ResourceLookup): Pair<AndroidWindow?, Int>? {
    return null
  }

  override fun getAllWindowIds(data: Any?): List<*>? {
    return null
  }
}
