...
class LegacyPropertiesProviderTest {
  ...
  fun testExample() {
    ...
    assertThat(properties[SdkConstants.ANDROID_URI, SdkConstants.ATTR_ID].value).isEqualTo("@id/textView")
    assertThat(properties[SdkConstants.ANDROID_URI, SdkConstants.ATTR_TEXT].value).isEqualTo("Hello\\nWorld , =  @ :")
    assertThat(properties[SdkConstants.ANDROID_URI, SdkConstants.ATTR_TEXT_COLOR].value).isEqualTo("#8A000000")
    assertThat(properties[SdkConstants.ANDROID_URI, SdkConstants.ATTR_ALPHA].value).isEqualTo("1.0")
    assertThat(properties[SdkConstants.ANDROID_URI, SdkConstants.ATTR_GRAVITY].value).isEqualTo("top|start")
    assertThat(properties[SdkConstants.ANDROID_URI, SdkConstants.ATTR_LAYOUT_MARGIN_TOP].value).isEqualTo("0")
    assertThat(properties[SdkConstants.ANDROID_URI, SdkConstants.ATTR_LAYOUT_MARGIN_BOTTOM].value).isEqualTo("0")
    assertThat(properties[SdkConstants.ANDROID_URI, SdkConstants.ATTR_LAYOUT_MARGIN_LEFT].value).isEqualTo("0")
    assertThat(properties[SdkConstants.ANDROID_URI, SdkConstants.ATTR_LAYOUT_MARGIN_RIGHT].value).isEqualTo("0")
  }
}
