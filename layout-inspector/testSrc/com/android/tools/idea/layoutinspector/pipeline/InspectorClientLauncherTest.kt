...
class InspectorClientLauncherTest {
  ...
  fun launchJobIsCancelled() {
    ...
    val failingClientFactory = ClientFactory { params ->
      object :
        FakeInspectorClient(
          "Initial failing client",
          projectRule.project,
    ...
    val successfulClientFactory = ClientFactory { params ->
      object :
        FakeInspectorClient(
          "Only connect to process 2",
          projectRule.project,
    ...
    val launcher =
      InspectorClientLauncher(
        processes,
        listOf(failingClientFactory, successfulClientFactory),
        projectRule.project,
        NotificationModel(projectRule.project),
        AndroidCoroutineScope(disposableRule.disposable),
        disposableRule.disposable
    ...
    assertThat(client2LaunchJob?.isCompleted).isTrue()
