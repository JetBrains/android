...
class ResourceLookupResolverTest {
  ...
  private fun createResourceLookupResolver(theme: String, vararg qualifiers: String): ResourceLookupResolver {
    ...
    val resourceResolver = cache.getResourceResolver(mgr.target, theme, folderConfiguration, emptyList())
  ...
  fun testColorValueFromTextStyleMaterialBody1() {
    ...
    checkLocation(locations[1], "themes_material.xml:435", "<item name=\"textColorPrimary\">@color/text_color_primary</item>")
    checkLocation(
      locations[2],
      "text_color_primary.xml:21",
      "<item android:alpha=\"?attr/primaryContentAlpha\"\n" + "        android:color=\"?attr/colorForeground\"/>",
    )
    checkLocation(locations[3], "themes_material.xml:417", "<item name=\"colorForeground\">@color/foreground_material_light</item>")
  ...
  private class Data(parentDisposable: Disposable) {
    ...
    val relativeLayout = ViewNode(1, "RelativeLayout", demo, Rectangle(0, 0, 300, 900), relativeId, "", 0, false)
    val title = ViewNode(2, "TextView", demo, Rectangle(30, 60, 300, 100), titleId, "Hello Folks", 0, false)
    val frameLayout = ViewNode(3, "RelativeLayout", demo, Rectangle(0, 200, 300, 700), frameId, "", 0, false)
    val textView1 = ViewNode(4, "TextView", demo, Rectangle(400, 60, 300, 100), null, "TextView without an ID", 0, false)
    val textView2 = ViewNode(5, "TextView", demo, Rectangle(0, 200, 300, 700), null, "TextView without an ID", 0, false)
    val button = ViewNode(6, "Button", demo, Rectangle(30, 400, 300, 100), buttonId, "OK", 0, false)
    val singleTextView = ViewNode(7, "TextView", designText, Rectangle(0, 0, 400, 50), null, "Tab3", 0, false)
    val context =
