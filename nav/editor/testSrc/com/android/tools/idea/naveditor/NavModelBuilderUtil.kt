...
object NavModelBuilderUtil {
  ...
  fun model(
    ...
    extentSize: Dimension = Dimension(500, 500),
  ): ModelBuilder {
  ...
  @NavTestDsl open class NavComponentDescriptor(tagName: String) : ComponentDescriptor(tagName)
}
