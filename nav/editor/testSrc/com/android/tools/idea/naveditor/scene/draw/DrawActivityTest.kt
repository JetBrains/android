...
private val FRAME_RECT = SwingRectangle(Rectangle2D.Float(10f, 20f, 100f, 300f))
...
private val IMAGE_BORDER_STROKE = SwingStroke(BasicStroke(1f))
private val TEXT_RECT = SwingRectangle(Rectangle2D.Float(10f, 281f, 100f, 39f))
private val TEXT_COLOR = Color.BLUE
private val FONT = SwingFont("Default", Font.BOLD, SwingLength(18f))
