...
interface AndroidIoManager {
  companion object {
    @JvmStatic fun getInstance(): AndroidIoManager = ApplicationManager.getApplication().getService(AndroidIoManager::class.java)!!
  }
   ...
   * dedicated to Android-related disk IO across the entire application. Since the platform doesn't provide a similar API, the bound is only
   * applicable to Android-related code.
   */
