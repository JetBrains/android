    ...
    system.runAdb { adb ->
      system.runEmulator { emulator ->
        ...
        system.runStudio(project, watcher.dashboardName) { studio ->
          ...
          // Verify DeviceMonitorPanel is shown.
          studio.waitForComponentByClass("JTabbedPane", "DeviceMonitorPanel")
          system.installation.ideaLog.waitForMatchingLine(".*Process list updated to ([1-9]+[0-9]*) processes(.*)", 60, TimeUnit.SECONDS)

          // Verify DeviceExplorerPanel is shown.
          studio.waitForComponentByClass("JTabbedPane", "DeviceExplorerPanel")
