...
/** Mapping from AWT VK codes to DOM key names. https://developer.mozilla.org/en-US/docs/Web/API/UI_Events/Keyboard_event_key_values */
val VK_TO_DOM_KEY_NAME: Map<Int, String> =
  mapOf(
    KeyEvent.VK_0 to "0",
    KeyEvent.VK_1 to "1",
    KeyEvent.VK_2 to "2",
