 ...
 *
 * @param touchscreenScalingFactor the ratio between the size of the device display and the size in logical pixels of its projection on the
 *   host screen. Used only for the synthetic wheel events generated by touchscreens.
 */
...
/**
 * Returns a value between [MouseWheelEvent.preciseWheelRotation] and [MouseWheelEvent.wheelRotation] interpolated using
 * [PRECISE_WHEEL_ROTATION_WEIGHT].
 */
...
@VisibleForTesting internal const val ANDROID_SCROLL_ADJUSTMENT_FACTOR = 1 / 3.0
