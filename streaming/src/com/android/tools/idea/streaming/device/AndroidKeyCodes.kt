...
internal val VK_TO_AKEYCODE = mapOf(
    ...
    KeyEvent.VK_3 to AKEYCODE_3,
    KeyEvent.VK_4 to AKEYCODE_4,
    KeyEvent.VK_5 to AKEYCODE_5,
    KeyEvent.VK_6 to AKEYCODE_6,
    KeyEvent.VK_7 to AKEYCODE_7,
    KeyEvent.VK_8 to AKEYCODE_8,
    KeyEvent.VK_9 to AKEYCODE_9,
    KeyEvent.VK_A to AKEYCODE_A,
    KeyEvent.VK_ALT to AKEYCODE_ALT_LEFT,
    KeyEvent.VK_QUOTE to AKEYCODE_APOSTROPHE,
    KeyEvent.VK_AT to AKEYCODE_AT,
    KeyEvent.VK_B to AKEYCODE_B,
    KeyEvent.VK_BACK_SLASH to AKEYCODE_BACKSLASH,
    KeyEvent.VK_C to AKEYCODE_C,
    KeyEvent.VK_CAPS_LOCK to AKEYCODE_CAPS_LOCK,
    KeyEvent.VK_CLEAR to AKEYCODE_CLEAR,
    KeyEvent.VK_COMMA to AKEYCODE_COMMA,
    KeyEvent.VK_COPY to AKEYCODE_COPY,
    KeyEvent.VK_CONTROL to AKEYCODE_CTRL_LEFT,
    KeyEvent.VK_CUT to AKEYCODE_CUT,
    KeyEvent.VK_D to AKEYCODE_D,
    ...
    KeyEvent.VK_E to AKEYCODE_E,
    KeyEvent.VK_ENTER to AKEYCODE_ENTER,
    KeyEvent.VK_EQUALS to AKEYCODE_EQUALS,
    KeyEvent.VK_ESCAPE to AKEYCODE_ESCAPE,
    KeyEvent.VK_F to AKEYCODE_F,
    KeyEvent.VK_F1 to AKEYCODE_F1,
    KeyEvent.VK_F10 to AKEYCODE_F10,
    KeyEvent.VK_F11 to AKEYCODE_F11,
    KeyEvent.VK_F12 to AKEYCODE_F12,
    KeyEvent.VK_F2 to AKEYCODE_F2,
    KeyEvent.VK_F3 to AKEYCODE_F3,
    KeyEvent.VK_F4 to AKEYCODE_F4,
    KeyEvent.VK_F5 to AKEYCODE_F5,
    KeyEvent.VK_F6 to AKEYCODE_F6,
    KeyEvent.VK_F7 to AKEYCODE_F7,
    KeyEvent.VK_F8 to AKEYCODE_F8,
    KeyEvent.VK_F9 to AKEYCODE_F9,
    KeyEvent.VK_DELETE to AKEYCODE_FORWARD_DEL,
    KeyEvent.VK_G to AKEYCODE_G,
    KeyEvent.VK_BACK_QUOTE to AKEYCODE_GRAVE,
    KeyEvent.VK_H to AKEYCODE_H,
    KeyEvent.VK_HELP to AKEYCODE_HELP,
    KeyEvent.VK_I to AKEYCODE_I,
    KeyEvent.VK_INSERT to AKEYCODE_INSERT,
    KeyEvent.VK_J to AKEYCODE_J,
    KeyEvent.VK_K to AKEYCODE_K,
    KeyEvent.VK_KANA to AKEYCODE_KANA,
    KeyEvent.VK_L to AKEYCODE_L,
    KeyEvent.VK_INPUT_METHOD_ON_OFF to AKEYCODE_LANGUAGE_SWITCH,
    KeyEvent.VK_OPEN_BRACKET to AKEYCODE_LEFT_BRACKET,
    KeyEvent.VK_M to AKEYCODE_M,
    KeyEvent.VK_STOP to AKEYCODE_MEDIA_STOP,
    KeyEvent.VK_META to AKEYCODE_META_LEFT,
    KeyEvent.VK_WINDOWS to AKEYCODE_META_LEFT,
    KeyEvent.VK_MINUS to AKEYCODE_MINUS,
    KeyEvent.VK_END to AKEYCODE_MOVE_END,
    KeyEvent.VK_HOME to AKEYCODE_MOVE_HOME,
    KeyEvent.VK_NONCONVERT to AKEYCODE_MUHENKAN,
    KeyEvent.VK_N to AKEYCODE_N,
    KeyEvent.VK_NUM_LOCK to AKEYCODE_NUM_LOCK,
    KeyEvent.VK_NUMPAD0 to AKEYCODE_NUMPAD_0,
    KeyEvent.VK_NUMPAD1 to AKEYCODE_NUMPAD_1,
    KeyEvent.VK_NUMPAD2 to AKEYCODE_NUMPAD_2,
    KeyEvent.VK_NUMPAD3 to AKEYCODE_NUMPAD_3,
    KeyEvent.VK_NUMPAD4 to AKEYCODE_NUMPAD_4,
    KeyEvent.VK_NUMPAD5 to AKEYCODE_NUMPAD_5,
    KeyEvent.VK_NUMPAD6 to AKEYCODE_NUMPAD_6,
    KeyEvent.VK_NUMPAD7 to AKEYCODE_NUMPAD_7,
    KeyEvent.VK_NUMPAD8 to AKEYCODE_NUMPAD_8,
    KeyEvent.VK_NUMPAD9 to AKEYCODE_NUMPAD_9,
    KeyEvent.VK_ADD to AKEYCODE_NUMPAD_ADD,
    KeyEvent.VK_DIVIDE to AKEYCODE_NUMPAD_DIVIDE,
    KeyEvent.VK_DECIMAL to AKEYCODE_NUMPAD_DOT,
    KeyEvent.VK_LEFT_PARENTHESIS to AKEYCODE_NUMPAD_LEFT_PAREN,
    KeyEvent.VK_MULTIPLY to AKEYCODE_NUMPAD_MULTIPLY,
    KeyEvent.VK_RIGHT_PARENTHESIS to AKEYCODE_NUMPAD_RIGHT_PAREN,
    KeyEvent.VK_SUBTRACT to AKEYCODE_NUMPAD_SUBTRACT,
    KeyEvent.VK_O to AKEYCODE_O,
    KeyEvent.VK_P to AKEYCODE_P,
    KeyEvent.VK_PAGE_DOWN to AKEYCODE_PAGE_DOWN,
    KeyEvent.VK_PAGE_UP to AKEYCODE_PAGE_UP,
    KeyEvent.VK_PASTE to AKEYCODE_PASTE,
    KeyEvent.VK_PERIOD to AKEYCODE_PERIOD,
    KeyEvent.VK_PLUS to AKEYCODE_PLUS,
    KeyEvent.VK_NUMBER_SIGN to AKEYCODE_POUND,
    KeyEvent.VK_Q to AKEYCODE_Q,
    KeyEvent.VK_R to AKEYCODE_R,
    KeyEvent.VK_CLOSE_BRACKET to AKEYCODE_RIGHT_BRACKET,
    KeyEvent.VK_S to AKEYCODE_S,
    KeyEvent.VK_SCROLL_LOCK to AKEYCODE_SCROLL_LOCK,
    KeyEvent.VK_SEMICOLON to AKEYCODE_SEMICOLON,
    KeyEvent.VK_SHIFT to AKEYCODE_SHIFT_LEFT,
    KeyEvent.VK_SLASH to AKEYCODE_SLASH,
    KeyEvent.VK_SPACE to AKEYCODE_SPACE,
    KeyEvent.VK_ASTERISK to AKEYCODE_STAR,
    KeyEvent.VK_T to AKEYCODE_T,
    KeyEvent.VK_TAB to AKEYCODE_TAB,
    KeyEvent.VK_U to AKEYCODE_U,
    KeyEvent.VK_V to AKEYCODE_V,
