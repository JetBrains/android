// Copy of https://android.googlesource.com/platform/frameworks/base/+/master/core/java/android/hardware/devicestate/IDeviceStateManagerCallback.aidl
// with inlined 'import android.hardware.devicestate.DeviceStateInfo;'
/**
