...
class DeviceUiSettingsControllerTest {
  ...
  private val model: UiSettingsModel by lazy { UiSettingsModel(Dimension(1344, 2992), 480, API_LEVEL, DeviceType.HANDHELD) }
  ...
  fun before() {
    ...
    val appLanguageServices = AppLanguageService { context ->
