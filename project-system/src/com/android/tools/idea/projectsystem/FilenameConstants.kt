...
object FilenameConstants {
   ...
   *
   * These classes are base classes implemented by impl classes (e.g. "DemoBindingImpl.java") generated elsewhere, and it is expected that
   * user code will interact with them.
   *
