...
interface ProjectSystemBuildManager {
  ...
  @Deprecated("Do not add new uses of this method as it's error prone") val isBuilding: Boolean
  ...
  enum class BuildMode {
    ...
    /**
     * Clean will remove all the compiled artifacts from the project. It will remove class files and other artifacts generated by any of the
     * other modes.
     */
    CLEAN,
  }
  ...
  data class BuildResult(val mode: BuildMode, val status: BuildStatus) {
    companion object {
      @JvmStatic fun createUnknownBuildResult(): BuildResult = BuildResult(BuildMode.UNKNOWN, BuildStatus.UNKNOWN)
    }
  }
  ...
  interface BuildListener {
    ...
    @AnyThread fun buildStarted(mode: BuildMode) {}

    /**
     * Method called after a build finishes successfully but before the [buildCompleted] listeners. This method can be used to clear any
     * caches before [buildCompleted] has all the results available.
     */
    @AnyThread fun beforeBuildCompleted(result: BuildResult) {}

    /** Method called after a build finishes. */
    @AnyThread fun buildCompleted(result: BuildResult) {}
  }
}
