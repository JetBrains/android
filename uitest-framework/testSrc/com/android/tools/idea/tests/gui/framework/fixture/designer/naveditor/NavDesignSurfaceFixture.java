...
public class NavDesignSurfaceFixture extends DesignSurfaceFixture<NavDesignSurfaceFixture, NavDesignSurface> {
  ...
  public SceneComponentFixture findDestination(@NotNull final String id) {
    ...
    // Waiting for the component to be populated
    Wait.seconds(10)
      .expecting("component to be populated")
      .until(() -> getScene().findSceneComponentById(id) != null);
  ...
  public AddDestinationMenuFixture openAddDestinationMenu() {
    return AddDestinationMenuFixture.create(robot(), openMenu(AddDestinationMenu.class));
  }

  @NotNull
  public AddDestinationMenuFixture getAddDestinationMenu() {
    return AddDestinationMenuFixture.create(robot(), getMenu(AddDestinationMenu.class));
  }
