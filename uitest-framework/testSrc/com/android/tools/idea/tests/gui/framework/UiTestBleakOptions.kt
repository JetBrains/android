...
private val globalIgnoreList = IgnoreList<LeakInfo>(listOf(
  ...
  IgnoreListEntry { it.leaktrace.referenceMatches(-2, "com.android.tools.idea.testing.DisposerExplorer", "object2ParentNode") },
  IgnoreListEntry { it.leaktrace.referenceMatches(-2, "com.android.tools.idea.diagnostics.report.MetricsLogFileProviderKt", "DefaultMetricsLogFileProvider") },
  IgnoreListEntry { it.leaktrace.referenceMatches(-5, "com.android.tools.idea.tests.gui.framework.GuiPerfLogger", "myMetric") },
  ...
  IgnoreListEntry { it.leaktrace.referenceMatches(-2, "com.intellij.openapi.vcs.impl.FileStatusManagerImpl", "cachedStatuses") },
  IgnoreListEntry { it.leaktrace.referenceMatches(-2, "com.intellij.openapi.vcs.impl.FileStatusManagerImpl", "whetherExactlyParentChanged") },
  IgnoreListEntry { it.leaktrace.referenceMatches(-3, "com.intellij.util.indexing.VfsAwareMapIndexStorage", "myCache") },
  IgnoreListEntry { it.leaktrace.referenceMatches(-2, "com.intellij.util.indexing.IndexingStamp", "ourTimestampsCache") },
  IgnoreListEntry { it.leaktrace.referenceMatches(-2, "com.intellij.util.indexing.IndexingStamp", "ourFinishedFiles") },
  IgnoreListEntry { it.leaktrace.referenceMatches(-2, "com.intellij.openapi.fileEditor.impl.EditorWindow", "removedTabs") },
  ...
  IgnoreListEntry { it.leaktrace.referenceMatches(-2, "com.intellij.util.concurrency.AppScheduledExecutorService\$BackendThreadPoolExecutor", "workers") },
  ...
  IgnoreListEntry { it.leaktrace.referenceMatches(-3, "com.intellij.openapi.command.impl.SharedUndoRedoStacksHolder", "myDocumentStacks") },
