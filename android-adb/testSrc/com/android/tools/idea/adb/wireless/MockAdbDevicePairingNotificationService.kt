...
@UiThread
class MockAdbDevicePairingNotificationService(project: Project) : AdbDevicePairingNotificationService {
  private val delegateService = AdbDevicePairingNotificationServiceImpl(project)
