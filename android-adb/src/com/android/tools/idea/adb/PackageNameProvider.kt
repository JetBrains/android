...
object PackageNameProvider {
  ...
  /**
   * Tries to infer the package name for [processName]. The package name is not always equal to the process name, because of the `process`
   * attribute that can be added to the app's manifest.
   *
