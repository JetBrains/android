 ...
 * tab for {@link QrCodePanel} and one tab for {@link PinCodePanel}.
 */
@UiThread
public class PairingContentPanel {
  ...
  public PairingContentPanel(@NotNull Disposable parentDisposable) {
    myPinCodePanel.setParentDisposable(parentDisposable);
  ...
  public void setPinCodeComponent(@NotNull JComponent component) {
    ...
    myPinCodePanel.setAsyncProcessText("Available Wi-Fi devices");
  }
}
