...
val PLATFORM_SUPPORT_LIBS =
  // This list isn't particularly principled, but instead reflects the state of
  // GoogleMavenArtifactId at the point that
  // that class stopped keeping track of whether (by some unknown metric) the library was a platform
  // support library.
  // This list should probably be viewed as a tasteful set of available libraries for testing
...
val GOOGLE_PLAY_SERVICES =
  listOf(PLAY_SERVICES, PLAY_SERVICES_ADS, PLAY_SERVICES_WEARABLE, PLAY_SERVICES_MAPS).map {
    TestProjectSystem.Artifact(it, TestVersion.create(1))
  }
