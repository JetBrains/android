...
class SelectLastRecordingFromRecordingListAction : ProfilerTaskActionBase() {
  ...
  override fun actionPerformed(e: AnActionEvent) {
    val recordingListModel = getStudioProfilers(e.project!!).pastRecordingsTabModel.recordingListModel
    val lastRecordingInList = recordingListModel.recordingList.value.last()
    recordingListModel.onRecordingSelection(lastRecordingInList)
  }
}