...
public class ProfilerServiceProxyTest {
  @Test
  public void testBindServiceContainsAllMethods() {
    ManagedChannel channel = InProcessChannelBuilder.forName("testBindServiceContainsAllMethods").build();
    ProfilerServiceProxy proxy = new ProfilerServiceProxy(channel);
