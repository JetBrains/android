...
import com.android.tools.idea.naveditor.scene.NavColors.SELECTED_ACTION
...
object ActionDecorator : NavBaseDecorator() {
  ...
  private fun actionColor(context: SceneContext, component: SceneComponent): Color {
    return when {
      component.isSelected || component.nlComponent.getClientProperty(HIGHLIGHTED_CLIENT_PROPERTY) == true -> SELECTED_ACTION
