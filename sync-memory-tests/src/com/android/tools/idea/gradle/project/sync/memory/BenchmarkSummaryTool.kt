 ...
 *
 * Example: After the following bazel test run, `bazel test
 * //tools/adt/idea/sync-memory-tests:intellij.android.sync-memory-tests_tests__Benchmark100 --config=remote --runs_per_test=10`
 *
 * Invoke this tool like following: `bazel run //tools/adt/idea/sync-memory-tests:benchmark_summary_tool\ --
 * //tools/adt/idea/sync-memory-tests:intellij.android.sync-memory-tests_tests__Benchmark100\ `bazel info bazel-testlogs`\ 10
 */
