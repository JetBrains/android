...
class PsAndroidArtifactTest {
  ...
  fun getPossibleConfigurationNamesWithMainArtifact() {
    ...
    assertThat(configurationNames).containsExactly("compile", "debugCompile", "api", "debugApi", "implementation", "debugImplementation")

    configurationNames = getPossibleConfigurationNames(IdeArtifactName.MAIN, "debug", listOf("flavor1"))
    assertThat(configurationNames)
      .containsExactly(
        "compile",
        "debugCompile",
        "flavor1Compile",
  ...
  fun getPossibleConfigurationNamesWitTestArtifact() {
    ...
    assertThat(configurationNames)
      .containsExactly("testCompile", "testDebugCompile", "testApi", "testDebugApi", "testImplementation", "testDebugImplementation")
  ...
  fun getPossibleConfigurationNamesWitAndroidTestArtifact() {
    ...
    assertThat(configurationNames).containsExactly("androidTestCompile", "androidTestApi", "androidTestImplementation")
    ...
    assertThat(configurationNames)
      .containsExactly(
        ...
        "androidTestApi",
        "androidTestFlavor1Api",
        "androidTestImplementation",
        "androidTestFlavor1Implementation",
      )
  ...
  fun getPossibleConfigurationNamesWitTestFixturesArtifact() {
    ...
    assertThat(configurationNames).containsExactly("testFixturesCompile", "testFixturesApi", "testFixturesImplementation")

    configurationNames = getPossibleConfigurationNames(IdeArtifactName.TEST_FIXTURES, "debug", listOf("flavor1"))
    assertThat(configurationNames)
      .containsExactly(
        "testFixturesCompile",
        "testFixturesFlavor1Compile",
        "testFixturesApi",
        "testFixturesFlavor1Api",
        "testFixturesImplementation",
        "testFixturesFlavor1Implementation",
      )
    ...
    assertThat(configurationNames)
      .containsExactly(
        "testFixturesCompile",
        "testFixturesFlavor1Compile",
        "testFixturesFlavor2Compile",
        "testFixturesApi",
        "testFixturesFlavor1Api",
        "testFixturesFlavor2Api",
        "testFixturesImplementation",
        "testFixturesFlavor1Implementation",
