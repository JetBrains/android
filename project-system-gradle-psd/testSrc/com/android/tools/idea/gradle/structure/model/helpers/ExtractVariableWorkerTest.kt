...
class ExtractVariableWorkerTest {
  ...
  fun testExtractAndroidModuleDependencyVersion() {
    ...
    preparedProject.open { resolvedProject ->
      ...
      val mockito = appModule.dependencies.findLibraryDependencies("org.mockito:mockito-core:5.12.0").firstOrNull()
  ...
  fun testExtractJavaModuleDependencyVersion() {
    ...
    preparedProject.open { resolvedProject ->
      ...
      val mockito = javaModule.dependencies.findLibraryDependencies("org.mockito:mockito-core:5.12.0").firstOrNull()
