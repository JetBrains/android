...
class ExtractVariableWorkerTest {
  ...
  fun testExtractAndroidModuleDependencyVersion() {
    ...
    preparedProject.open { resolvedProject ->
      ...
      val mockito = appModule.dependencies.findLibraryDependencies("org.mockito:mockito-core:5.6.0").firstOrNull()
      ...
      run {
        ...
        assertThat(
          newProperty.getParsedValue(),
          equalTo(ParsedValue.Set.Parsed("5.6.0", DslText.Literal).annotated())
        )
        worker.commit("mockitoCoreVersion")

        assertThat(
          appModule.variables.getOrCreateVariable("mockitoCoreVersion").value,
          equalTo(ParsedValue.Set.Parsed("5.6.0", DslText.Literal))
        )
      }
    }
  }
  ...
  fun testExtractJavaModuleDependencyVersion() {
    ...
    preparedProject.open { resolvedProject ->
      ...
      val mockito = javaModule.dependencies.findLibraryDependencies("org.mockito:mockito-core:5.6.0").firstOrNull()
