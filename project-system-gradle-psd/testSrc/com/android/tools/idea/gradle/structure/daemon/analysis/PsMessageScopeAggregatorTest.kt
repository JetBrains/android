...
class PsMessageScopeAggregatorTest {
  ...
  fun simple() {
    ...
    assertThat(
      aggregator.aggregate(setOf(PsMessageScope("debug", artifact = "Test"))),
      equalTo(setOf(PsMessageAggregatedScope("debug", scope = "Test"))),
    )
    assertThat(
      aggregator.aggregate(setOf(PsMessageScope("release", artifact = "AndroidTest"))),
      equalTo(setOf(PsMessageAggregatedScope("release", scope = "AndroidTest"))),
    )

    assertThat(
      aggregator.aggregate(setOf(PsMessageScope("debug"), PsMessageScope("release"))),
      equalTo(setOf(PsMessageAggregatedScope(buildType = null))),
    )

    assertThat(
      aggregator.aggregate(setOf(PsMessageScope("debug"), PsMessageScope("release", artifact = "Test"))),
  ...
  fun withOneDimensionAllFlavors() {
    ...
    assertThat(
      aggregator.aggregate(
        setOf(PsMessageScope("debug", listOf("A")), PsMessageScope("debug", listOf("B")), PsMessageScope("debug", listOf("C")))
      ),
    ...
    assertThat(
      aggregator.aggregate(
        setOf(PsMessageScope("release", listOf("A")), PsMessageScope("release", listOf("B")), PsMessageScope("release", listOf("C")))
      ),
    ...
    assertThat(
      ...
      equalTo(setOf(PsMessageAggregatedScope("debug", listOf(null)), PsMessageAggregatedScope("release", listOf(null), scope = "Test"))),
    )
  }
  ...
  fun withOneDimensionOneFlavor() {
    val aggregator = PsMessageScopeAggregator(setOf("debug", "release"), listOf(setOf("A", "B", "C")))
    assertThat(
      aggregator.aggregate(setOf(PsMessageScope("debug", listOf("C")))),
      equalTo(setOf(PsMessageAggregatedScope("debug", listOf("C")))),
    )

    assertThat(
      aggregator.aggregate(setOf(PsMessageScope("release", listOf("C")))),
      equalTo(setOf(PsMessageAggregatedScope("release", listOf("C")))),
    )

    assertThat(
      aggregator.aggregate(setOf(PsMessageScope("debug", listOf("C"), artifact = "Test"))),
      equalTo(setOf(PsMessageAggregatedScope("debug", listOf("C"), scope = "Test"))),
    )

    assertThat(
      aggregator.aggregate(setOf(PsMessageScope("debug", listOf("C")), PsMessageScope("release", listOf("C")))),
      equalTo(setOf(PsMessageAggregatedScope(buildType = null, productFlavors = listOf("C")))),
    )

    assertThat(
      aggregator.aggregate(setOf(PsMessageScope("debug", listOf("C")), PsMessageScope("release", listOf("C"), artifact = "Test"))),
      equalTo(setOf(PsMessageAggregatedScope("debug", listOf("C")), PsMessageAggregatedScope("release", listOf("C"), scope = "Test"))),
    )
  }
  ...
  fun withOneDimensionNoFlavors_errorneousConfig() {
    ...
    assertThat(
      aggregator.aggregate(setOf(PsMessageScope("debug", listOf("A")))),
  ...
  fun withTwoDimensionsOneFlavor() {
    val aggregator = PsMessageScopeAggregator(setOf("debug", "release"), listOf(setOf("A", "B"), setOf("X", "Y")))
    assertThat(
      aggregator.aggregate(setOf(PsMessageScope("debug", listOf("A", "X")), PsMessageScope("debug", listOf("A", "Y")))),
      equalTo(setOf(PsMessageAggregatedScope("debug", listOf("A", null)))),
    )

    assertThat(
      aggregator.aggregate(setOf(PsMessageScope("release", listOf("A", "X")), PsMessageScope("release", listOf("B", "X")))),
      equalTo(setOf(PsMessageAggregatedScope("release", listOf(null, "X")))),
    )

    assertThat(
      aggregator.aggregate(
        setOf(PsMessageScope("debug", listOf("A", "X"), artifact = "Test"), PsMessageScope("debug", listOf("B", "Y"), artifact = "Test"))
      ),
      equalTo(
        setOf(
