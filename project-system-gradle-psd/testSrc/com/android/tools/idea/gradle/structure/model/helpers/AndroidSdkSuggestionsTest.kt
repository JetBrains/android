...
class AndroidSdkSuggestionsTest {
  ...
  private val localPackage1: LocalPackage =
    FakePackage.FakeLocalPackage("build-tools;24.0.3").apply { setRevision(Revision.parseRevision("24.0.3")) }

  private val localPackage2: LocalPackage =
    FakePackage.FakeLocalPackage("build-tools;27.0.0").apply { setRevision(Revision.parseRevision("27.0.0")) }

  private val localPackage3: LocalPackage =
    FakePackage.FakeLocalPackage("build-tools;4109860.0.0").apply { setRevision(Revision.parseRevision("4109860.0.0")) }
  ...
  fun setUp() {
    ...
    whenever(sdkManager.packages)
      .thenReturn(RepositoryPackages(listOf(localPackage1, localPackage2, localPackage3, localPackage4), listOf()))
  ...
  fun installedEnvironment_buildTools() {
    assertThat(
      ...
      equalTo(listOf(ValueDescriptor("24.0.3", null), ValueDescriptor("27.0.0", null), ValueDescriptor("4109860.0.0", null))),
    )
  }
