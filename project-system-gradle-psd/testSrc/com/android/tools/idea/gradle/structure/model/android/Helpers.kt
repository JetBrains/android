...
/** Waits when future will be completed Also dispatches all EDT invocation events to avoid EDT blocking in tests */
fun <R> waitForFuture(future: ListenableFuture<R>, timeout: Long, timeUnit: TimeUnit): R? {
  ...
  return invokeAndWaitIfNeeded { PlatformTestUtil.waitForPromise(asyncPromise, timeUnit.toMillis(timeout)) }
}
