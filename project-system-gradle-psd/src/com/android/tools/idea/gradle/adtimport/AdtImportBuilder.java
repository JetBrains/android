  ...
  public List<Module> commit(Project project,
    ...
    try {
      ...
      if (myCreateProject) {
        ...
        PlatformProjectOpenProcessor.openExistingProject(projectDir, projectDir, new OpenProjectTask(true, null, false, false, project, null, true, null, null, -1, -1, true, false, true, null, false, false, true, null, null, null));
      }
      else {
