...
fun signingConfigPropertiesModel() =
  PropertiesUiModel(
    listOf(
      uiProperty(
        PsSigningConfig.SigningConfigDescriptors.storeFile,
        ::simplePropertyEditor,
        PSDEvent.PSDField.PROJECT_STRUCTURE_DIALOG_FIELD_MODULES_SIGNINGCONFIGS_STORE_FILE,
      ),
      uiProperty(
        PsSigningConfig.SigningConfigDescriptors.storePassword,
        ::simplePropertyEditor,
      ...
      uiProperty(
        PsSigningConfig.SigningConfigDescriptors.keyAlias,
        ::simplePropertyEditor,
        PSDEvent.PSDField.PROJECT_STRUCTURE_DIALOG_FIELD_MODULES_SIGNINGCONFIGS_KEY_ALIAS,
      ),
      uiProperty(
        PsSigningConfig.SigningConfigDescriptors.keyPassword,
        ::simplePropertyEditor,
