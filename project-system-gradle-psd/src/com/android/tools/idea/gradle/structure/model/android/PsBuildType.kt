...
open class PsBuildType(final override val parent: PsAndroidModule, private val renamed: (String, String) -> Unit) : PsChildModel() {
  ...
  override val name
    get() = resolvedModel?.name ?: parsedModel?.name() ?: ""

  override val path: PsBuildTypeNavigationPath
    get() = PsBuildTypeNavigationPath(parent.path.buildTypesPath, name)
  ...
  object BuildTypeDescriptors : ModelDescriptor<PsBuildType, IdeBuildType, BuildTypeModel> {
    ...
    val applicationIdSuffix: SimpleProperty<PsBuildType, String> =
      property(
    ...
    val debuggable: SimpleProperty<PsBuildType, Boolean> =
      property(
        "Debuggable",
    ...
    val jniDebuggable: SimpleProperty<PsBuildType, Boolean> =
      property(
        "Jni Debuggable",
    ...
    val minifyEnabled: SimpleProperty<PsBuildType, Boolean> =
      property(
        "Minify Enabled",
    ...
    val multiDexEnabled: SimpleProperty<PsBuildType, Boolean> =
      property(
        "Multi Dex Enabled",
    ...
    val renderscriptDebuggable: SimpleProperty<PsBuildType, Boolean> =
      property(
    ...
    val renderscriptOptimLevel: SimpleProperty<PsBuildType, Int> =
      property(
    ...
    val signingConfig: SimpleProperty<PsBuildType, Unit> =
      property(
        "Signing Config",
    ...
    val testCoverageEnabled: SimpleProperty<PsBuildType, Boolean> =
      property(
    ...
    val versionNameSuffix: SimpleProperty<PsBuildType, String> =
      property(
        "Version Name Suffix",
    ...
    val zipAlignEnabled: SimpleProperty<PsBuildType, Boolean> =
      property(
        "Zip Align Enabled",
    ...
    val matchingFallbacks: ListProperty<PsBuildType, String> =
      listProperty(
        "Matching Fallbacks",
        resolvedValueGetter = { null },
    ...
    val consumerProGuardFiles: ListProperty<PsBuildType, File> =
      listProperty(
    ...
    val proGuardFiles: ListProperty<PsBuildType, File> =
      listProperty(
          "ProGuard Files",
    ...
    val manifestPlaceholders: MapProperty<PsBuildType, Any> =
      mapProperty(
    ...
    val enableUnitTestCoverage: SimpleProperty<PsBuildType, Boolean> =
      property(
    ...
    val enableAndroidTestCoverage: SimpleProperty<PsBuildType, Boolean> =
      property(
