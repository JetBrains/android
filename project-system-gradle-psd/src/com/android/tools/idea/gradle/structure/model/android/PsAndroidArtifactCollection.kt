...
class PsAndroidArtifactCollection internal constructor(parent: PsVariant) :
  PsCollectionBase<PsAndroidArtifact, IdeArtifactName, PsVariant>(parent) {
  init {
    refresh()
  }
  ...
  override fun update(key: IdeArtifactName, model: PsAndroidArtifact) {
    val resolved =
      parent.resolvedModel?.let { variant ->
