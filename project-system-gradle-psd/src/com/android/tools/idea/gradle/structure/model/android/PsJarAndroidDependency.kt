...
class PsDeclaredJarAndroidDependency constructor(parent: PsAndroidModule) : PsJarAndroidDependency(parent), PsDeclaredJarDependency {
  override lateinit var parsedModel: DependencyModel
    private set
  ...
  override val filePath: String
    get() = (parsedModel as? FileDependencyModel)?.file()?.asString() ?: (parsedModel as? FileTreeDependencyModel)?.dir()?.asString() ?: ""
  ...
  override val includes: List<String>
    get() = getFileTreeStringListProperty { includes() }

  override val excludes: List<String>
    get() = getFileTreeStringListProperty { excludes() }
...
abstract class PsJarAndroidDependency internal constructor(parent: PsAndroidModule) : PsAndroidDependency(parent), PsJarDependency {
