...
import static com.android.tools.profilers.memory.MemoryProfilerTestBase.mockClassObject;
import static com.android.tools.profilers.memory.MemoryProfilerTestBase.mockClassObjectAutogeneratedInstances;
...
public class MemoryClassViewTest {
  ...
  public void buildClassesTreeTest() {
    ...
    assertEquals(0, javaLangPackage.getAdapter().getInstanceCount());
    ...
    assertEquals(8, comPackage.getAdapter().getInstanceCount());
    ...
    assertEquals(7, androidPackage.getAdapter().getInstanceCount());
  ...
  public void navigationTest() {
    ...
    ClassObject mockClass = mockClassObject(testClassName, 1, 2, 3, Collections.emptyList());
  ...
  public void testCorrectColumnsAndRendererContents() {
    ...
    for (int i = 0; i < root.getChildCount(); i++) {
      ...
      treeInfo.verifyRendererValues(root.getChildAt(i),
                                    klass.getName(),
                                    Integer.toString(klass.getInstanceCount()),
