...
public class MemoryProfilerStageViewTest extends MemoryProfilerTestBase {
  ...
  public void testCaptureAndHeapView() throws Exception {
    ...
    InstanceObject mockInstance1 = mockInstanceObject(dummyClassName1, "DUMMY_INSTANCE", 1, 2, 3);
    InstanceObject mockInstance2 = mockInstanceObject(dummyClassName2, "DUMMY_INSTANCE", 4, 5, 6);
