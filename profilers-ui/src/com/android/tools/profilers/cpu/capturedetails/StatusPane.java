...
abstract class StatusPane extends CapturePane {
  ...
  void populateContent(@NotNull JPanel panel) {
    ...
    JPanel statusPanel = new JPanel(new TabularLayout("*,Fit,20px,Fit,*","*,Fit,Fit,Fit,*").setVGap(JBUI.scale(5)));
    ...
    statusPanel.add(createButtonPanel(new TabularLayout("*,Fit,*")), new TabularLayout.Constraint(3, 1, 3));
