 ...
 *
 * These tests convert Lint models to a stable text format which does not depend on local environment (and ideally should not depend on the
 * versions of irrelevant libraries) and compare them to pre-recorded golden results.
 *
 ...
 * "//tools/adt/idea/android-lint:intellij.android.lint.tests_tests__all --filter=LintModelSnapshotComparisonTest".
 */
@RunsInEdt
