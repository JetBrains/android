...
public class DeviceSpecNameParamImpl extends ASTWrapperPsiElement implements DeviceSpecNameParam {
  ...
  @Override
  @NotNull
  public PsiElement getDeviceIdT() {
    return findNotNullChildByType(DEVICE_ID_T);
  }
