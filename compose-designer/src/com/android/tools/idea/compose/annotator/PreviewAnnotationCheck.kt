...
internal object PreviewAnnotationCheck {
  ...
  fun checkAnnotation(
    ...
    val result = checkPreviewAnnotationIfNeeded(annotationEntry)
    ...
    if (messageBuffer.isNotEmpty() && result.proposedFix != null) {
      ...
      val uElement = (annotationEntry.toUElement() as? UAnnotation) ?: return null
      val deviceValueExpression =
        uElement.findDeclaredAttributeValue("device")?.sourcePsiElement ?: return null
   ...
   */
  @TestOnly
  internal fun checkPreviewAnnotationIfNeeded(annotationEntry: KtAnnotationEntry): CheckResult {
