...
class ComposePreviewElementsTest {
  ...
  fun testPreviewConfigurationCleaner() {
    ...
    assertEquals(
      PreviewConfiguration.cleanAndGet(9000, null, MAX_WIDTH, MAX_HEIGHT, null, null, null, "id:device"),
...
""")
  ...
  @Test
  fun testEquals() {
    class TestComposePreviewElementInstance(override val instanceId: String,
