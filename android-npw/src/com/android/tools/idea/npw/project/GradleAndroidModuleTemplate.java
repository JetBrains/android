...
public class GradleAndroidModuleTemplate {
   ...
   * locations for tests (androidHostTest, androidDeviceTest)
   */
  public static NamedModuleTemplate createMultiplatformTemplateAt(@NotNull File moduleRoot) {
    ...
    return new NamedModuleTemplate("main", new KotlinMultiplatformModulePathsImpl(
      ...
      new File(baseSrcDir.getPath(), "androidHostTest" + File.separatorChar + FD_KOTLIN),
      new File(baseSrcDir.getPath(), "androidDeviceTest" + File.separatorChar + FD_KOTLIN),
      null,
