...
class BytecodeLevelComboProvider : ComponentProvider<ComboBox<BytecodeLevel>>() {
  override fun createComponent(): ComboBox<BytecodeLevel> =
    ComboBox(DefaultComboBoxModel(BytecodeLevel.values())).apply {
      renderer =
        object : SimpleListCellRenderer<BytecodeLevel>() {
