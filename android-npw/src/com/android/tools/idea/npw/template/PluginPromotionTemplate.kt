 ...
 *
 * Unlike a regular [com.android.tools.idea.wizard.template.Template], a promotion template does not generate any project files. When the
 * user picks it, the wizard offers to install the plugin identified by [pluginId] instead.
 */
interface PluginPromotionTemplate {
  ...
  /** Returns a thumbnail which is drawn in the UI. */
  fun thumb(): Thumb
