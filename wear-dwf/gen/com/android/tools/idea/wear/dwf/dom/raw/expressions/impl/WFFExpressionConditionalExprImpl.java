...
public class WFFExpressionConditionalExprImpl extends WFFExpressionExprImpl implements WFFExpressionConditionalExpr {

  public WFFExpressionConditionalExprImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public WFFExpressionConditionalOp getConditionalOp() {
    return findNotNullChildByClass(WFFExpressionConditionalOp.class);
  }
