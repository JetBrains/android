...
public class WFFExpressionUnaryPlusExprImpl extends WFFExpressionExprImpl implements WFFExpressionUnaryPlusExpr {

  public WFFExpressionUnaryPlusExprImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @Nullable
  public WFFExpressionExpr getExpr() {
    return findChildByClass(WFFExpressionExpr.class);
  }
