...
public class WFFExpressionBitComplExprImpl extends WFFExpressionExprImpl implements WFFExpressionBitComplExpr {

  public WFFExpressionBitComplExprImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull WFFExpressionVisitor visitor) {
    visitor.visitBitComplExpr(this);
  }
