...
public class WFFExpressionCallExprImpl extends WFFExpressionExprImpl implements WFFExpressionCallExpr {

  public WFFExpressionCallExprImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public WFFExpressionArgList getArgList() {
    return findNotNullChildByClass(WFFExpressionArgList.class);
  }

  @Override
  @NotNull
  public WFFExpressionFunctionId getFunctionId() {
    return findNotNullChildByClass(WFFExpressionFunctionId.class);
  }
