...
public class WFFExpressionModExprImpl extends WFFExpressionExprImpl implements WFFExpressionModExpr {

  public WFFExpressionModExprImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull WFFExpressionVisitor visitor) {
    visitor.visitModExpr(this);
  }
  ...
  @Override
  @NotNull
  public List<WFFExpressionExpr> getExprList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, WFFExpressionExpr.class);
  }
