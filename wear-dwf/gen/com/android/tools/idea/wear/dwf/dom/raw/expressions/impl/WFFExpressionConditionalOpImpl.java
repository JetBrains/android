...
public class WFFExpressionConditionalOpImpl extends ASTWrapperPsiElement implements WFFExpressionConditionalOp {

  public WFFExpressionConditionalOpImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull WFFExpressionVisitor visitor) {
    visitor.visitConditionalOp(this);
  }
