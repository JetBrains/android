...
val WFF_EXPRESSION_FILE_TYPE = IFileElementType(WFFExpressionLanguage)

class WFFExpressionTokenType(debugName: String) : IElementType(debugName, WFFExpressionLanguage)
