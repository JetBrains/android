...
public final class NdkBuildDslElement extends AbstractBuildDslElement {
  public static final PropertiesElementDescription<NdkBuildDslElement> NDK_BUILD =
    new PropertiesElementDescription<>("ndkBuild", NdkBuildDslElement.class, NdkBuildDslElement::new, NdkBuildDslElementSchema::new);

  public NdkBuildDslElement(@NotNull GradleDslElement parent, @NotNull GradleNameElement name) {
    super(parent, name);
  }

  public static final class NdkBuildDslElementSchema extends GradlePropertiesDslElementSchema {
    @NotNull
    @Override
    ...
    public String getAgpDocClass() {
      return "com.android.build.api.dsl.NdkBuild";
    }
  }
}
