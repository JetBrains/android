...
interface BasePluginsModel {
  ...
  /**
   * Modify the underlying object, if necessary, such that the given plugin is applied, and return the model corresponding to the plugin
   * declaration.
   *
  ...
  /**
   * Modify the underlying object such that the given plugin is declared at the specified version and with the specified apply status, and
   * return the model corresponding to the plugin declaration.
   *
   * @param plugin the name of a plugin
