...
class SdkIndexPsdWithoutVersionsTest : SdkIndexTestBase() {
  ...
  fun `Snapshot used by PSD without versions`() {
    ...
    verifySdkIndexIsInitializedAndUsedWhen(
      showFunction = { studio, _ -> openAndClosePSD(studio) },
      beforeClose = { verifyPsdIssues(numErrors = 7, numWarnings = 4) },
      expectedIssues =
        listOf(
          // Error
          listOf(
          ...
          // Error
          listOf("com.startapp:inapp-sdk version 3.9.1 contains unsafe unzipping patterns."),
          // Error
          listOf(
          ...
          // Warning
          listOf("androidx.annotation:annotation version 1.0.0 has been reported as outdated by its author"),
          // Warning
          listOf("com.google.ads.interactivemedia.v3:interactivemedia version 3.18.2 has been reported as outdated by its author"),
          // Warning
          listOf("io.objectbox:objectbox-android version 2.5.1 has been reported as outdated by its author"),
          // Warning
          listOf(
