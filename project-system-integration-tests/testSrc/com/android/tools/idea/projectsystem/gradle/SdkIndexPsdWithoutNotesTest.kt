    ...
    verifySdkIndexIsInitializedAndUsedWhen(
      ...
      expectedIssues =
        listOf(
          ...
          // Info
          listOf("com.google.android.gms:play-services-safetynet version 10.0.0 has an associated message from its author"),
          // Info
          listOf("io.objectbox:objectbox-android version 2.5.1 has an associated message from its author"),
        ),
    )
  }
}
