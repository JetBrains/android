...
public final class ColdBootNowEmulatorCommandBuilderTest {
  @Test
  public void addSnapshotParameters() {
    ...
    // Assert
    assertEquals("/home/user/Android/Sdk/emulator/emulator -no-snapshot-load -avd Pixel_4_API_30", command.getCommandLineString());
  }
}
