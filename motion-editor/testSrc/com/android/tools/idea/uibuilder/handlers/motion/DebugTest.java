...
public class DebugTest extends BaseMotionEditorTest {
  ...
  public void testDebugSerialization() {
    assertEquals(" null", com.android.tools.idea.uibuilder.handlers.motion.editor.utils.Debug.toString(null));
    ...
    assertEquals(" [number,dial_pad,dialtitle,button1,button2,button3,button4,button5,button6," +
                 ...
                 "people2,people3,people4,people5,people6,people7,people8]", com.android.tools.idea.uibuilder.handlers.motion.editor.utils.Debug.toString(layout.getChildTags()));
    layout.getChildren().clear();
    assertEquals(" []", com.android.tools.idea.uibuilder.handlers.motion.editor.utils.Debug.toString(layout.getChildTags()));
  }
