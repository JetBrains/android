...
class MotionLayoutPropertyProviderTest {
  ...
  fun testTransition() {
    ...
    val properties =
      motionRule.properties.getValue(MotionSceneAttrs.Tags.TRANSITION)
  ...
  fun testConstraint() {
    ...
    val properties =
      motionRule.properties.getValue(MotionSceneAttrs.Tags.CONSTRAINT)
    assertThat(properties.getByNamespace(SdkConstants.AUTO_URI).keys)
      .containsAllOf(
    ...
    val customProperties =
      motionRule.properties.getValue(MotionSceneAttrs.Tags.CUSTOM_ATTRIBUTE)
  ...
  fun testEmptyConstraint() {
    ...
    assertThat(motionRule.properties.keys)
      .containsExactly(MotionSceneAttrs.Tags.CONSTRAINT)
  ...
  fun testSectionedConstraint() {
    ...
    val layoutProperties =
      motionRule.properties.getValue(MotionSceneAttrs.Tags.LAYOUT)
    ...
    val motionProperties =
      motionRule.properties.getValue(MotionSceneAttrs.Tags.MOTION)
    ...
    val propertySetProperties =
      motionRule.properties.getValue(MotionSceneAttrs.Tags.PROPERTY_SET)
  ...
  fun testKeyPosition() {
    motionRule.selectKeyFrame(
      "start",
      "end",
      MotionSceneAttrs.Tags.KEY_POSITION,
      51,
      "widget",
    )
    val properties =
      motionRule.properties.getValue(MotionSceneAttrs.Tags.KEY_POSITION)
    assertThat(properties.getByNamespace(SdkConstants.AUTO_URI).keys)
      .containsExactly(
        "framePosition",
        "motionTarget",
  ...
  fun testKeyAttribute() {
    ...
    val properties =
      motionRule.properties.getValue(MotionSceneAttrs.Tags.KEY_ATTRIBUTE)
    assertThat(properties.getByNamespace(SdkConstants.AUTO_URI).keys)
      .containsExactly(
        "framePosition",
        "motionTarget",
  ...
  fun testKeyCycle() {
    ...
    val properties =
      motionRule.properties.getValue(MotionSceneAttrs.Tags.KEY_CYCLE)
    assertThat(properties.getByNamespace(SdkConstants.AUTO_URI).keys)
      .containsExactly(
        "framePosition",
        "motionTarget",
  ...
  fun testKeyTimeCycle() {
    ...
    val properties =
      motionRule.properties.getValue(MotionSceneAttrs.Tags.KEY_TIME_CYCLE)
    assertThat(properties.getByNamespace(SdkConstants.AUTO_URI).keys)
      .containsExactly(
        "framePosition",
        "motionTarget",
