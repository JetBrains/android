...
public class CommonActions {
  ...
  private static HashMap<String, Boolean> ourVisibilityFlags = new HashMap<>();
   ...
   public static boolean getPopupMenuActions(@NotNull SceneComponent component, @NotNull List<ViewAction> actions) {
    ...
    actions.add(new DisappearingActionMenu("Constrain", StudioIcons.LayoutEditor.Toolbar.CREATE_CONSTRAINTS, ConstraintViewActions.CONNECT_ACTIONS));
    actions.add(new DisappearingActionMenu("Organize", StudioIcons.LayoutEditor.Toolbar.PACK_HORIZONTAL, ConstraintViewActions.ORGANIZE_ACTIONS));
    actions.add(new DisappearingActionMenu("Align", StudioIcons.LayoutEditor.Toolbar.LEFT_ALIGNED, ConstraintViewActions.ALIGN_ACTIONS));
    actions.add(new DisappearingActionMenu("Chains", StudioIcons.LayoutEditor.Toolbar.CREATE_HORIZ_CHAIN, ConstraintViewActions.CHAIN_ACTIONS));
    actions.add(new DisappearingActionMenu("Center", StudioIcons.LayoutEditor.Toolbar.CENTER_HORIZONTAL, ConstraintViewActions.CENTER_ACTIONS));
    actions.add(new DisappearingActionMenu("Helpers", StudioIcons.LayoutEditor.Toolbar.GUIDELINE_VERTICAL, ConstraintViewActions.HELPER_ACTIONS));
  ...
  public static void getToolbarActions(@NotNull List<ViewAction> actions) {
    actions.add(ViewActionUtils.getViewOptionsAction(ImmutableList.of(
    ...
    actions
      .add(new NestedViewActionMenu("Guidelines", StudioIcons.LayoutEditor.Toolbar.GUIDELINE_VERTICAL, Lists.<List<ViewAction>>newArrayList(
  ...
  private static class ConstraintViewActions {
    ...
    private static ImmutableList<ViewAction> connectFrom(boolean reverse) {
      return ImmutableList.of(
        ...
        new ConnectAction(Scout.Connect.ConnectBaseLineToBaseLine, StudioIcons.LayoutEditor.Toolbar.BASELINE_ALIGNED_CONSTRAINT, "to baseline", reverse)
      );
    }
    ...
    private static final ImmutableList<ViewAction> HELPER_ACTIONS = ImmutableList.of(
      new AddElementAction(AddElementAction.VERTICAL_GUIDELINE,
                           StudioIcons.LayoutEditor.Toolbar.GUIDELINE_VERTICAL,
  ...
  private static class AddElementAction extends DirectViewAction {
    ...
    public void perform(@NotNull ViewEditor editor,
      ...
      while (parent != null && !NlComponentHelperKt.isOrHasSuperclass(parent, AndroidXConstants.CONSTRAINT_LAYOUT)) {
        ...
        switch (myType) {
          case HORIZONTAL_GUIDELINE: {
            NlComponent guideline = NlComponentHelperKt
              .createChild(parent, useAndroidx ? AndroidXConstants.CONSTRAINT_LAYOUT_GUIDELINE.newName() : AndroidXConstants.CONSTRAINT_LAYOUT_GUIDELINE.oldName(),
            ...
            guideline.setAttribute(SdkConstants.ANDROID_URI, SdkConstants.ATTR_ORIENTATION, SdkConstants.ATTR_GUIDELINE_ORIENTATION_HORIZONTAL);
          }
          break;
          case VERTICAL_GUIDELINE: {
            ...
            guideline.setAttribute(SdkConstants.ANDROID_URI, SdkConstants.ATTR_ORIENTATION, SdkConstants.ATTR_GUIDELINE_ORIENTATION_VERTICAL);
          }
          break;
          case GROUP: {
            NlComponent group = NlComponentHelperKt
              .createChild(parent, useAndroidx ? AndroidXConstants.CLASS_CONSTRAINT_LAYOUT_GROUP.newName() : AndroidXConstants.CLASS_CONSTRAINT_LAYOUT_GROUP.oldName(),
                           null, InsertType.CREATE);
            assert group != null;
            group.ensureId();
          }
          ...
          case CONSTRAINT_SET: {
            NlComponent constraints =
              NlComponentHelperKt.createChild(parent, useAndroidx
                                                      ? AndroidXConstants.CLASS_CONSTRAINT_LAYOUT_CONSTRAINTS.newName()
                                                      : AndroidXConstants.CLASS_CONSTRAINT_LAYOUT_CONSTRAINTS.oldName(), null, InsertType.CREATE);
          ...
          case LAYER: {
            NlComponent layer = NlComponentHelperKt
              .createChild(parent, useAndroidx ? AndroidXConstants.CLASS_CONSTRAINT_LAYOUT_LAYER.newName() : AndroidXConstants.CLASS_CONSTRAINT_LAYOUT_LAYER.oldName(),
                           null, InsertType.CREATE);
            assert layer != null;
            layer.ensureId();
          }
          ...
          case HORIZONTAL_BARRIER: {
            ...
            for (NlComponent child : selectedChildren) {
              if (NlComponentHelperKt.isOrHasSuperclass(child, AndroidXConstants.CONSTRAINT_LAYOUT_BARRIER)) {
                barriers++;
              }
              ...
              if (ConstraintHelperHandler.USE_HELPER_TAGS) {
                if (barrier != null) {
                  for (NlComponent child : selectedChildren) {
                    ...
                    NlComponent tag = NlComponentHelperKt.createChild(barrier, SdkConstants.TAG, null, InsertType.CREATE);
                    if (tag != null) {
                      tag.removeAndroidAttribute(SdkConstants.ATTR_LAYOUT_WIDTH);
                      tag.removeAndroidAttribute(SdkConstants.ATTR_LAYOUT_HEIGHT);
                      tag.setAttribute(SdkConstants.ANDROID_URI, SdkConstants.ATTR_ID, SdkConstants.ID_PREFIX + child.getId());
                      tag.setAttribute(SdkConstants.ANDROID_URI, SdkConstants.ATTR_VALUE, SdkConstants.VALUE_TRUE);
                    }
                  }
                }
            ...
            NlComponent barrier = NlComponentHelperKt
              .createChild(parent, useAndroidx ? AndroidXConstants.CONSTRAINT_LAYOUT_BARRIER.newName() : AndroidXConstants.CONSTRAINT_LAYOUT_BARRIER.oldName(), null,
                           InsertType.CREATE);
            assert barrier != null;
            barrier.ensureId();
  ...
  private static boolean isConstraintLayoutChild(List<NlComponent> children) {
    for (NlComponent child : children) {
      ...
      if (NlComponentHelperKt.isOrHasSuperclass(parent, AndroidXConstants.CONSTRAINT_LAYOUT)) {
        return true;
      }
    }
    return false;
