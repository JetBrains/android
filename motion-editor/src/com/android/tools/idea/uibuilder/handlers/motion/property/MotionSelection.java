...
public class MotionSelection {
  ...
  public String getComponentId() {
    ...
    return component.getAttribute(SdkConstants.ANDROID_URI, SdkConstants.ATTR_ID);
  }
  ...
  public String getConstraintSetId() {
    ...
    return parent != null ? parent.getAttributeValue(SdkConstants.ATTR_ID) : null;
  }
  ...
  private NlComponent getComponentFromConstraintTag(@NotNull MTag constraintTag) {
    String constraintId = parseId(constraintTag.getAttributeValue(SdkConstants.ATTR_ID));
  ...
  private static boolean matches(@NotNull NlComponent component, @NotNull String motionTarget) {
    String tag = component.getAttribute(SdkConstants.AUTO_URI, MotionSceneAttrs.LAYOUT_CONSTRAINT_TAG);
