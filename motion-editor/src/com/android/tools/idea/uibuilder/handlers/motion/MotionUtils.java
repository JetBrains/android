...
public class MotionUtils {
  ...
  public static void fillComponentModification(ComponentModification modification) {
    ...
    Object properties = component.getClientProperty(MotionSceneUtils.MOTION_LAYOUT_PROPERTIES);
  ...
  static {
    ourFilteredAttributes.put(SdkConstants.ATTR_ID, Pair.of(SdkConstants.ANDROID_URI, SdkConstants.SHERPA_URI));
    ourFilteredAttributes.put(SdkConstants.ATTR_LAYOUT_WIDTH, Pair.of(SdkConstants.ANDROID_URI, SdkConstants.SHERPA_URI));
    ourFilteredAttributes.put(SdkConstants.ATTR_LAYOUT_HEIGHT, Pair.of(SdkConstants.ANDROID_URI, SdkConstants.SHERPA_URI));
    ourFilteredAttributes.put(SdkConstants.ATTR_LAYOUT_MARGIN_START, Pair.of(SdkConstants.ANDROID_URI, SdkConstants.SHERPA_URI));
    ourFilteredAttributes.put(SdkConstants.ATTR_LAYOUT_MARGIN_END, Pair.of(SdkConstants.ANDROID_URI, SdkConstants.SHERPA_URI));
    ourFilteredAttributes.put(SdkConstants.ATTR_LAYOUT_MARGIN_LEFT, Pair.of(SdkConstants.ANDROID_URI, SdkConstants.SHERPA_URI));
    ourFilteredAttributes.put(SdkConstants.ATTR_LAYOUT_MARGIN_RIGHT, Pair.of(SdkConstants.ANDROID_URI, SdkConstants.SHERPA_URI));
    ourFilteredAttributes.put(SdkConstants.ATTR_LAYOUT_MARGIN_TOP, Pair.of(SdkConstants.ANDROID_URI, SdkConstants.SHERPA_URI));
    ourFilteredAttributes.put(SdkConstants.ATTR_LAYOUT_MARGIN_BOTTOM, Pair.of(SdkConstants.ANDROID_URI, SdkConstants.SHERPA_URI));
    ourFilteredAttributes.put(SdkConstants.ATTR_LAYOUT_EDITOR_ABSOLUTE_X, Pair.of(SdkConstants.TOOLS_URI, SdkConstants.SHERPA_URI));
    ourFilteredAttributes.put(SdkConstants.ATTR_LAYOUT_EDITOR_ABSOLUTE_Y, Pair.of(SdkConstants.TOOLS_URI, SdkConstants.SHERPA_URI));
  }
  ...
  public static MotionSceneTag getMotionScene(NlComponent component) {
    ...
    List<VirtualFile> resourcesXML = IdeResourcesUtil.getResourceSubdirs(ResourceFolderType.XML, StudioResourceRepositoryManager.getModuleResources(facet).getResourceDirs());
  ...
  public static boolean isAnchorConnected(AnchorTarget.Type type, NlAttributesHolder component, boolean useRtlAttributes, boolean isRtl) {
    if (type == AnchorTarget.Type.BASELINE) {
      return component.getAttribute(SdkConstants.SHERPA_URI, SdkConstants.ATTR_LAYOUT_BASELINE_TO_BASELINE_OF) != null;
    }
    boolean isConnected = false;
    Pair pair = ConstraintComponentUtilities.ourPotentialAttributes.get(type);
    if (pair != null) {
      // noinspection ConstantConditions
      isConnected |= component.getAttribute(SdkConstants.SHERPA_URI, (String)pair.getFirst()) != null;
      isConnected |= component.getAttribute(SdkConstants.SHERPA_URI, (String)pair.getSecond()) != null;
    }
    if (useRtlAttributes) {
      if (isRtl) {
