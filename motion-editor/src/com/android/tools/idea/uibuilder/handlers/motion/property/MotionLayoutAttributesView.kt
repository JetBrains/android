...
import com.android.tools.idea.uibuilder.handlers.motion.MotionConstraintPanel
...
import com.android.tools.idea.uibuilder.property.NlPropertiesViewProvider
...
class MotionLayoutAttributesView(model: MotionLayoutAttributesModel) :
  ...
  constructor(
    ...
    private fun addConstraintPanel(
      ...
      val panel = MotionConstraintPanel(
        listOfNotNull(selection.component))
...
class MotionLayoutAttributesViewProvider : NlPropertiesViewProvider {
  override fun create(model: NlPropertiesModel): PropertiesView<NlPropertyItem> {
    require(model is MotionLayoutAttributesModel) { "Invalid model provider to MotionLayoutAttributesViewProvider" }
    return MotionLayoutAttributesView(model)
  }
}
