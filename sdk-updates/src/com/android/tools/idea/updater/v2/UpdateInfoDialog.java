  ...
  protected Action[] createActions() {
    ...
    actions.add(new AbstractAction("Update Now") {
      ...
      public void actionPerformed(ActionEvent e) {
        final Downloader downloader = StudioDownloader.getInstance();
        final SettingsController settings = StudioSettingsController.getInstance();
        final RepoManager mgr = AndroidSdkHandler.getInstance().getSdkManager(new StudioLoggerProgressIndicator(getClass()));
