...
public class AndroidRunLayoutInspectorAction extends AnAction {
  public AndroidRunLayoutInspectorAction() {
    super(AndroidBundle.messagePointer("android.ddms.actions.layoutinspector.title"),
          AndroidBundle.messagePointer("android.ddms.actions.layoutinspector.description"), StudioIcons.Shell.Menu.LAYOUT_INSPECTOR);
  }
