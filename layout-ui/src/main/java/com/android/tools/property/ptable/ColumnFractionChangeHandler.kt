 ...
 *
 * The [nameColumnFraction] is updated with the position of the column divider in a fraction of the [currentWidth] of the 2 column panel.
 * [xOffset] is the offset of the mouse positions received, and [minFirstColumnSize] is the minimum size of the first column. The
 * onResizeModeChange will be called whenever the mouse shape should be changed.
 */
