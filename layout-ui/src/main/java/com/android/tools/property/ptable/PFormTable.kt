 ...
 *
 * By default a Swing table will <tab> over the table and use arrow keys for navigation inside the table. Sometimes it is convenient to make
 * the table feel like a form although the underlying implementation is still a table.
 */
