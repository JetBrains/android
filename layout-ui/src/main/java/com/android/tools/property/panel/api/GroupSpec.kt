 ...
 *
 * A group has a [name] and a [itemFilter] which matches the items which make up the group. A non editable value can be displayed in the
 * table by supplying a [value].
 */
