 ...
 *
 * Create a provider for a [PTableCellEditor] based on the column being edited. If the user is editing a property name: use the
 * [nameControlTypeProvider] and [nameEditorProvider] for creating an editor for a [nameType] property. If the user is editing a property
 * value: use the [valueControlTypeProvider] and [valueEditorProvider] for creating an editor for a [valueType] property.
 */
