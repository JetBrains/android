 ...
 *
 * The inspector panel is generated from [InspectorBuilder]s that each add rows to the inspector. A row can be either:
 * - Title row
...
interface InspectorPanel {
   ...
   *
   * Add [editor] with model [editorModel] to the inspector, and return the new [InspectorLineModel]. The editor is optionally placed as a
   * child of expandable [parent] line.
   */
   ...
   * Add an editor component with the property name for the label to the inspector.
   *
   * Same as [addCustomEditor], but takes the model and editor as a pair. Add an editor with a model as a [modelEditorPair] to the
   * inspector, and return the new [InspectorLineModel]. The editor is optionally placed as a child of expandable [parent] line.
   */
   ...
   *
   * Add a table with the items specified in [tableModel]. Specify if the table should be [searchable] i.e. the user can search for the
   * items in the table. Cell renderer and cell editors must be specified in [tableUI]. The table is optionally placed as a child of
   * expandable [parent] line.
   */
  fun addTable(
   ...
   *
   * Add a [component] (usually a JPanel) to the inspector, and return the new [InspectorLineModel]. The component is optionally placed as a
   * child of expandable [parent] line.
   */
