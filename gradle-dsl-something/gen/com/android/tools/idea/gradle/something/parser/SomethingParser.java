...
import static com.android.tools.idea.gradle.something.parser.SomethingParserUtil.*;
...
public class SomethingParser implements PsiParser, LightPsiParser {
  ...
  static boolean entry(PsiBuilder b, int l) {
    ...
    r = p && entry_2(b, l + 1) && r;
    exit_section_(b, l, m, r, p, SomethingParser::entry_recover);
    return r || p;
  }
