...
public class SomethingQualifiedImpl extends SomethingPropertyImpl implements SomethingQualified {

  public SomethingQualifiedImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull SomethingVisitor visitor) {
    visitor.visitQualified(this);
  }
  ...
  public SomethingProperty getProperty() {
    return findNotNullChildByClass(SomethingProperty.class);
  }
