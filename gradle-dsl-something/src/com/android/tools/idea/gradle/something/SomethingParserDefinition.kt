...
class SomethingParserDefinition : ParserDefinition {
  ...
  override fun createElement(node: ASTNode?): PsiElement = SomethingElementTypeHolder.Factory.createElement(node)
  override fun createFile(viewProvider: FileViewProvider): PsiFile = SomethingFile(viewProvider)
