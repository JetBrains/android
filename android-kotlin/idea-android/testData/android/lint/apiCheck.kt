...
class ApiCallTest: Activity() {
    ...
    fun test3(rect: Rect) {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.GINGERBREAD) {
            <error descr="Call requires API level 18 (current min is 1): `android.animation.RectEvaluator()`">RectEvaluator()</error>; // ERROR
        }
    }
    ...
    fun test4(rect: Rect) {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            ...
            <error descr="Call requires API level 21 (current min is 1): `android.animation.RectEvaluator()`">RectEvaluator(rect)</error>; // ERROR
        }
    }
    ...
    fun test(priority: Boolean, layout: ViewGroup) {
        if (android.os.Build.VERSION.SDK_INT >= Build.VERSION_CODES.ICE_CREAM_SANDWICH) {
            ...
            <error descr="Call requires API level 14 (current min is 1): `android.widget.GridLayout()`">GridLayout(null)</error>.<error descr="Call requires API level 14 (current min is 1): `android.widget.GridLayout#getOrientation`">getOrientation</error>(); // Flagged
        }
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.JELLY_BEAN) {
            ...
            <error descr="Call requires API level 14 (current min is 1): `android.widget.GridLayout()`">GridLayout(null)</error>; // Flagged
        }
    }
    ...
    abstract class ErrorVectorDravable : <error descr="Call requires API level 21 (current min is 1): `android.graphics.drawable.VectorDrawable()`"><error descr="Class requires API level 21 (current min is 1): `android.graphics.drawable.VectorDrawable`">VectorDrawable</error>()</error>, Parcelable

    @RequiresApi(21)
    class MyVectorDrawable : VectorDrawable()

    fun testTypes() {
        <error descr="Call requires API level 14 (current min is 1): `android.widget.GridLayout()`">GridLayout(this)</error>
    ...
    fun testCallWithApiAnnotation(textView: TextView) {
        <error descr="Call requires API level 21 (current min is 1): `MyVectorDrawable`">MyVectorDrawable()</error>
        <error descr="Call requires API level 16 (current min is 1): `testWithTargetApiAnnotation`">testWithTargetApiAnnotation</error>(textView)
    }
