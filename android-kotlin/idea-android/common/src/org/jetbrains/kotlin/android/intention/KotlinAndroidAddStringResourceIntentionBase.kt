...
abstract class KotlinAndroidAddStringResourceIntentionBase :
    SelfTargetingIntention<KtStringTemplateExpression>(
    ...
    private companion object {
        private val CLASS_IDS_WITH_GET_STRING =
            setOf(
        ...
        private val CLASS_IDS_REQUIRING_CONTEXT_PARAMETER = setOf(ClassId.fromString("android/view/View"))
    ...
    override fun isApplicableTo(element: KtStringTemplateExpression, caretOffset: Int): Boolean {
        ...
        return ProjectSystemService.getInstance(element.project).projectSystem.getModuleSystem(facet.module).supportsAndroidResources
    }
    ...
    private fun getCreateXmlResourceParameters(
        ...
        val dialog =
            CreateXmlResourceDialog(module, ResourceType.STRING, resourceName, stringValue, true, null, contextFile, allowValueEditing)
            ...
            for (child in element.children) {
                when (child) {
                    ...
                    is KtStringTemplateEntryWithExpression -> {
                        ...
                        Logger.getInstance(KotlinAndroidAddStringResourceIntentionBase::class.java)
                            .error("Unexpected child element type: ${child::class.simpleName}")
                }
            }
        }
    ...
    private fun createResourceReference(
        ...
        placeholderExpressions.forEachIndexed { i, expr -> template.addVariable("placeholder$i", TextExpression(expr.text), false) }
            ...
            .startTemplate(
                ...
                object : TemplateEditingAdapter() {
                    override fun waitingForInput(template: Template?) {
                        // TODO(273768010): K2 reference shortener does not work here. Check this line later with the up-to-date KT
                        // compiler.
    ...
    private fun needContextReceiver(element: PsiElement): Boolean {
        ...
        while (parent != null) {
            ...
            if (
                parent.hasDispatchReceiverOfAnyOfTypes(CLASS_IDS_REQUIRING_CONTEXT_PARAMETER) ||
    ...
    private fun KtElement.hasDispatchReceiverOfAnyOfTypes(classIds: Set<ClassId>) =
        when (this) {
