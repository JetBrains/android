...
@TestMetadata("idea-android/testData/android/folding")
...
public class AndroidResourceFoldingTestGenerated extends AbstractAndroidResourceFoldingTest {
    public void testAllFilesPresentInFolding() throws Exception {
        KotlinTestUtils.assertAllTestsPresentByMetadata(this.getClass(), new File("idea-android/testData/android/folding"), Pattern.compile("^(.+)\\.kt$"), TargetBackend.ANY, true);
    }
