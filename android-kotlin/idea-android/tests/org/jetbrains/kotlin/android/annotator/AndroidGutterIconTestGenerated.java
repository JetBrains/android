...
@TestMetadata("idea-android/testData/android/gutterIcon")
...
public class AndroidGutterIconTestGenerated extends AbstractAndroidGutterIconTest {
    public void testAllFilesPresentInGutterIcon() throws Exception {
        KotlinTestUtils.assertAllTestsPresentByMetadata(this.getClass(), new File("idea-android/testData/android/gutterIcon"), Pattern.compile("^(.+)\\.kt$"), TargetBackend.ANY, true);
    }
    ...
    public static class Res extends AbstractAndroidGutterIconTest {
        public void testAllFilesPresentInRes() throws Exception {
            KotlinTestUtils.assertAllTestsPresentByMetadata(this.getClass(), new File("idea-android/testData/android/gutterIcon/res"), Pattern.compile("^(.+)\\.kt$"), TargetBackend.ANY, true);
        }
    }
}
