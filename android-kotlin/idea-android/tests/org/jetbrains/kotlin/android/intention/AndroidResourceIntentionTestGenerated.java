...
@TestMetadata("idea-android/testData/android/resourceIntention")
...
public class AndroidResourceIntentionTestGenerated extends AbstractAndroidResourceIntentionTest {
    public void testAllFilesPresentInResourceIntention() throws Exception {
        KotlinTestUtils.assertAllTestsPresentInSingleGeneratedClass(this.getClass(), new File("idea-android/testData/android/resourceIntention"), Pattern.compile("^(.+)\\.test$"), TargetBackend.ANY);
    }
