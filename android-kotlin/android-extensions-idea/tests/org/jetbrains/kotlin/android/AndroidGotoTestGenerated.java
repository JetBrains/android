...
@TestMetadata("android-extensions-idea/testData/android/goto")
...
public class AndroidGotoTestGenerated extends AbstractAndroidGotoTest {
    public void testAllFilesPresentInGoto() throws Exception {
        KotlinTestUtils.assertAllTestsPresentByMetadata(this.getClass(), new File("android-extensions-idea/testData/android/goto"), Pattern.compile("^([^\\.]+)$"), TargetBackend.ANY, false);
    }
