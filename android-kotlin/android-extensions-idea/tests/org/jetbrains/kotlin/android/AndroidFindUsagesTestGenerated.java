...
@TestMetadata("android-extensions-idea/testData/android/findUsages")
...
public class AndroidFindUsagesTestGenerated extends AbstractAndroidFindUsagesTest {
    public void testAllFilesPresentInFindUsages() throws Exception {
        KotlinTestUtils.assertAllTestsPresentByMetadata(this.getClass(), new File("android-extensions-idea/testData/android/findUsages"), Pattern.compile("^([^\\.]+)$"), TargetBackend.ANY, false);
    }
