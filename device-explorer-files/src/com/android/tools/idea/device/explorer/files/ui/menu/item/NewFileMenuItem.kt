...
class NewFileMenuItem(listener: DeviceFileExplorerActionListener) : SingleSelectionTreeMenuItem(listener) {
  override fun getText(nodes: List<DeviceFileEntryNode>): String = "File"
