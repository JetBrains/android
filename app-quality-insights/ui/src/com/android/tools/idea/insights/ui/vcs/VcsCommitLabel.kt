...
const val VCS_INTEGRATION_LEARN_MORE_URL = "https://d.android.com/studio/releases/past-releases/as-iguana-release-notes#aqi-vcs"
...
class VcsCommitLabel : JPanel() {
      ...
      transparentPanel(BorderLayout()).apply {
        add(
          transparentPanel().apply {
            add(JBLabel("No data", AllIcons.Vcs.CommitNode, SwingConstants.LEFT).apply { toolTipText = "Commit ID" })
  ...
  fun updateOnIssueChange(vcsInfo: AppVcsInfo, project: Project) {
    ...
    when (vcsInfo) {
      ...
      is AppVcsInfo.NONE -> {
        cardPanelLayout.show(cardPanel, DATA_ABSENT_CARD)
        noDataTooltip.setDescription("Version control information is generated by AGP version 8.3 and higher, unless explicitly disabled.")
      }
    }
  }
}
