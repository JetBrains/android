...
interface CommonElementSelectability {
  ...
  /**
   * If false, the element in the ComboBox will not be selectable from keyboard/mouse. This would typically be used for header and separator
   * elements that don't represent an actual value.
   */
