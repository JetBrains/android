...
interface IdeMavenCoordinates {
  ...
  /**
   * Returns the project's classifier. The classifier allows to distinguish artifacts that were built from the same POM but differ in their
   * content.
   */
