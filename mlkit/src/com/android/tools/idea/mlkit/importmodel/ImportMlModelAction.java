...
public class ImportMlModelAction extends AnAction {
  @VisibleForTesting public static final String MIN_AGP_VERSION = "4.1.0-alpha04";
  @VisibleForTesting public static final String TITLE = "TensorFlow Lite Model";
  @VisibleForTesting public static final int MIN_SDK_VERSION = 19;
