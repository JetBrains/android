...
class BindingScopeEnlarger : ResolveScopeEnlarger() {
  ...
  fun getAdditionalResolveScope(facet: AndroidFacet): SearchScope? {
    ...
    return CachedValuesManager.getManager(project).getCachedValue(module) {
      ...
      CachedValueProvider.Result.create(scopeIncludingDeps, enabledFacetsProvider, resourcesModifiedTracker)
    }
  }
}
...
private fun AndroidFacet.getLocalBindingScope(): GlobalSearchScope {
  ...
  return CachedValuesManager.getManager(project).getCachedValue(module) {
    ...
    CachedValueProvider.Result.create(localScope, enabledFacetsProvider, resourcesModifiedTracker)
  }
}
