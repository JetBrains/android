...
/**
 * Scope enlarger for data binding and view binding modules, providing additional in-memory light classes that represent files that will
 * eventually be generated by the data binding compiler.
 */
...
private fun AndroidFacet.toLightBindingClassSearchScope() = LayoutBindingModuleCache.getInstance(this).lightBindingClassSearchScope
