...
/**
 * [DataBindingXmlTagDescriptor] is a wrapper around [DomElementXmlDescriptor] to which most of its function calls are delegated. It
 * overrides [getContentType] to provide custom functionality for data binding tags.
 */
class DataBindingXmlTagDescriptor(private val dataBindingElement: DomElement) :
   ...
   *
   * [CONTENT_TYPE_CHILDREN] will indicate this element can contain children and autocompletion will populate both start and end tags. Ex:
   * <tag></tag> [CONTENT_TYPE_EMPTY] indicates this is an empty tag and autocompletion will populate an empty tag. Ex <tag/>.
   */
