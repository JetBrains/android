...
/**
 * [DataBindingDomElementDescriptorProvider] provides [DataBindingXmlTagDescriptor] for tags that are [DataBindingElement]. Returns null, if
 * tag is not [DataBindingElement].
 */
