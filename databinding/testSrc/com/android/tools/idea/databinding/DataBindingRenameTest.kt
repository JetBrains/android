...
/**
 * Test of rename refactoring involving Java language elements generated by Data Binding or methods
 * declared in Java language elements.
 */
...
class DataBindingRenameTest(private val dataBindingMode: DataBindingMode) {
  ...
  private fun checkAndRenameElementAtCaret(newName: String) {
    ...
    // Having a performPsiModification block here is necessary or else IJ throws an "PSI invalidated
    // outside transaction" error
  ...
  /**
   * Checks renaming of a resource IDs when a Java field generated from that resource by Data
   * Binding is renamed.
   *
