...
def _produce_manifest(build_txt, resources_jar, channel, code_name, patch_name, out):
  ...
  contents = ('major: {major}\n'
           ...
           patch_name=patch_name, full_name=full, channel=channel)
...
def main(argv):
  ...
  parser.add_argument(
      ...
      default="",
      dest="patch_name",
      help="The patch name, e.g. Canary 1.")
  parser.add_argument(
      "--out",
      default="",
      dest="out",
