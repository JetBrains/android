...
class EmulatorConfigurationTest {
  ...
  fun testValidConfiguration() {
    ...
    assertThat(config?.avdFolder).isEqualTo(Paths.get("/home/username/.android/avd/Pixel_3_XL_API_29.avd"))
  ...
  fun testValidConfigurationMissingNonessentialData() {
    ...
    val config = EmulatorConfiguration.fromHardwareConfig(entryList)
    assertThat(config).isNotNull()
    assertThat(config?.avdFolder).isEqualTo(Paths.get("/home/username/.android/avd/Polestar_2_API_28.avd"))
