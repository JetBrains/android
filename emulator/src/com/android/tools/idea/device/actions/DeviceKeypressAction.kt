...
import com.android.tools.idea.device.AndroidKeyEventActionType
...
internal open class DeviceKeypressAction(private val keyCode: Int) : AbstractDeviceAction() {
  ...
  override fun actionPerformed(event: AnActionEvent) {
    ...
    val controlMessage = KeyEventMessage(AndroidKeyEventActionType.ACTION_DOWN_AND_UP, keyCode, 0)
