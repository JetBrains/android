...
/** An interface to access to instrumentation test results of a single test case executed on multiple devices. */
...
operator fun AndroidTestResultStats.plus(rhs: AndroidTestResultStats) =
  AndroidTestResultStats(passed + rhs.passed, failed + rhs.failed, skipped + rhs.skipped, running + rhs.running, cancelled + rhs.cancelled)
...
data class AndroidTestResultsTreeNode(val results: AndroidTestResults, val childResults: Sequence<AndroidTestResultsTreeNode>)
