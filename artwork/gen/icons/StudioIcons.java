...
public final class StudioIcons {
  ...
  public static final class Avd {
    ...
    /** 32x32 */ public static final @NotNull Icon DEVICE_AUTOMOTIVE_PLAYSTORE_LARGE = load("studio/icons/avd/device-automotive-playstore-large.svg", 3109357842785912974L, 2);
    /** 16x16 */ public static final @NotNull Icon DEVICE_AUTOMOTIVE_PLAYSTORE = load("studio/icons/avd/device-automotive-playstore.svg", 1505422635009722592L, 2);
    ...
    /** 16x16 */ public static final @NotNull Icon PAIR_OVER_WIFI = load("studio/icons/avd/pair-over-wifi.svg", 5482661563001941254L, 2);
  ...
  public static final class Common {
    ...
    /** 16x16 */ public static final @NotNull Icon ANDROID_HEAD = load("studio/icons/common/android-head.svg", 4677431826501727008L, 2);
    ...
    /** 10x10 */ public static final @NotNull Icon CIRCLE_GREEN = load("studio/icons/common/circle_green.svg", -1896963983728649644L, 0);
    /** 10x10 */ public static final @NotNull Icon CIRCLE_RED = load("studio/icons/common/circle_red.svg", -5492893465873412381L, 0);
    ...
    /** 16x16 */ public static final @NotNull Icon ERROR_DECORATOR = load("studio/icons/common/error-decorator.svg", 4822819672594230538L, 2);
  ...
  public static final class Compose {
    public static final class Editor {
      /** 16x16 */ public static final @NotNull Icon COMPOSABLE_FUNCTION = load("studio/icons/compose/editor/composable-function.svg", 7615144602337775099L, 2);
    }

    public static final class Toolbar {
      /** 16x16 */ public static final @NotNull Icon ANIMATION_INSPECTOR = load("studio/icons/compose/toolbar/animation-inspector.svg", -703659570293133138L, 2);
  ...
  public static final class DatabaseInspector {
    ...
    /** 16x16 */ public static final @NotNull Icon DATABASE_OFFLINE = load("studio/icons/database-inspector/database-offline.svg", -4382614060805576845L, 2);
  ...
  public static final class DeviceExplorer {
    /** 16x16 */ public static final @NotNull Icon DATABASE_FOLDER = load("studio/icons/device-explorer/database-folder.svg", 3685123561329701720L, 2);
    /** 16x16 */ public static final @NotNull Icon DEVICE_PAIRED = load("studio/icons/device-explorer/device-paired.svg", -9053821086633965270L, 2);
    ...
    /** 16x16 */ public static final @NotNull Icon PHYSICAL_DEVICE_THINGS = load("studio/icons/device-explorer/physical-device-things.svg", -8070164310266614586L, 2);
  ...
  public static final class Emulator {
    public static final class Snapshots {
      /** 16x16 */ public static final @NotNull Icon INVALID_SNAPSHOT_DECORATOR = load("studio/icons/emulator/snapshots/invalid-snapshot-decorator.svg", -2635235369742278842L, 2);
      /** 16x16 */ public static final @NotNull Icon LOAD_SNAPSHOT = load("studio/icons/emulator/snapshots/load-snapshot.svg", -5736255235049576411L, 2);
    }

    public static final class Toolbar {
      /** 16x16 */ public static final @NotNull Icon BACK = load("studio/icons/emulator/toolbar/back.svg", -1546466169780681495L, 2);
      /** 16x16 */ public static final @NotNull Icon FOLD = load("studio/icons/emulator/toolbar/fold.svg", -8355364446685659409L, 2);
      /** 16x16 */ public static final @NotNull Icon HOME = load("studio/icons/emulator/toolbar/home.svg", 288914013019377833L, 2);
      /** 16x16 */ public static final @NotNull Icon OVERVIEW = load("studio/icons/emulator/toolbar/overview.svg", -4157638281734804147L, 2);
      /** 16x16 */ public static final @NotNull Icon POWER = load("studio/icons/emulator/toolbar/power.svg", -8742035670854922281L, 2);
      /** 16x16 */ public static final @NotNull Icon ROTATE_LEFT = load("studio/icons/emulator/toolbar/rotate-left.svg", -1383391697496108089L, 2);
      /** 16x16 */ public static final @NotNull Icon ROTATE_RIGHT = load("studio/icons/emulator/toolbar/rotate-right.svg", -1360621185847988217L, 2);
      /** 16x16 */ public static final @NotNull Icon SCREENSHOT = load("studio/icons/emulator/toolbar/screenshot.svg", 7581640391500159634L, 2);
      /** 16x16 */ public static final @NotNull Icon SNAPSHOTS = load("studio/icons/emulator/toolbar/snapshots.svg", 1949197866079279313L, 2);
      /** 16x16 */ public static final @NotNull Icon VOLUME_DOWN = load("studio/icons/emulator/toolbar/volume-down.svg", 4261860009241430545L, 2);
      /** 16x16 */ public static final @NotNull Icon VOLUME_UP = load("studio/icons/emulator/toolbar/volume-up.svg", 3393021705709540698L, 2);
    }
  }
  ...
  public static final class LayoutEditor {
    ...
    public static final class Palette {
      ...
      /** 16x16 */ public static final @NotNull Icon COMPOSABLE_FUNCTION = load("studio/icons/layout-editor/palette/composable-function.svg", 7615144602337775099L, 2);
      ...
      /** 16x16 */ public static final @NotNull Icon DIALOG_POPUP = load("studio/icons/layout-editor/palette/dialog-popup.svg", -5491661010092779614L, 2);
    ...
    public static final class Toolbar {
      ...
      /** 16x16 */ public static final @NotNull Icon EMPTY_FLAG = load("studio/icons/layout-editor/toolbar/empty-flag.svg", -7340815490918833170L, 2);
  ...
  public static final class LayoutInspector {
    ...
    /** 16x16 */ public static final @NotNull Icon LIVE_UPDATES = load("studio/icons/layout-inspector/live-updates.svg", -7691160765331948812L, 2);
  ...
  public static final class Misc {
    ...
    /** 16x16 */ public static final @NotNull Icon PROJECT_SYSTEM_VARIANT = load("studio/icons/misc/project-system-variant.svg", 3635193356682108269L, 2);
    /** 16x16 */ public static final @NotNull Icon SIGNING_CONFIG = load("studio/icons/misc/signing-config.svg", 2003231780330543924L, 2);
    /** 18x18 */ public static final @NotNull Icon TUTORIAL_INDICATOR = load("studio/icons/misc/tutorial-indicator.svg", 471708359474195660L, 2);
  }
  ...
  public static final class Profiler {
    ...
    public static final class Toolbar {
      ...
      /** 16x16 */ public static final @NotNull Icon SELECT_ENTIRE_RANGE = load("studio/icons/profiler/toolbar/select-entire-range.svg", -6187775186102149304L, 2);
  ...
  public static final class Shell {
    public static final class Filetree {
      /** 16x16 */ public static final @NotNull Icon ACTIVITY = load("studio/icons/shell/filetree/activity.svg", 5999649296490584472L, 2);
    ...
    public static final class Menu {
      ...
      /** 16x16 */ public static final @NotNull Icon DATABASE_INSPECTOR = load("studio/icons/shell/menu/database-inspector.svg", -52625784925531744L, 2);
      ...
      /** 16x16 */ public static final @NotNull Icon NETWORK_INSPECTOR = load("studio/icons/shell/menu/network-inspector.svg", -3609915336927037789L, 2);
    ...
    public static final class StatusBar {
      ...
      /** 16x16 */ public static final @NotNull Icon LIVE_LITERALS = load("studio/icons/shell/status-bar/live-literals.svg", 3277949460175042901L, 2);
    ...
    public static final class ToolWindows {
      ...
      /** 13x13 */ public static final @NotNull Icon EMULATOR = load("studio/icons/shell/tool-windows/emulator.svg", -5865390581465827207L, 2);
      ...
      /** 13x13 */ public static final @NotNull Icon INSPECTION = load("studio/icons/shell/tool-windows/inspection.svg", -5327393429306584415L, 2);
  ...
  public static final class Test {
    /** 16x16 */ public static final @NotNull Icon FAILED_TEST_RETENTION = load("studio/icons/test/failed-test-retention.svg", -8639197392012137809L, 2);
  ...
  public static final class Wizards {
    public static final class Modules {
      /** 16x16 */ public static final @NotNull Icon ANDROID_LIBRARY = load("studio/icons/wizards/modules/android-library.svg", -5665278697568668546L, 2);
      /** 16x16 */ public static final @NotNull Icon ANDROID_THINGS = load("studio/icons/wizards/modules/android-things.svg", 642981647649336763L, 2);
      /** 16x16 */ public static final @NotNull Icon ANDROID_TV = load("studio/icons/wizards/modules/android-tv.svg", 3605345231400285869L, 2);
      /** 16x16 */ public static final @NotNull Icon AUTOMOTIVE = load("studio/icons/wizards/modules/automotive.svg", 2616653904199323433L, 2);
      /** 16x16 */ public static final @NotNull Icon BENCHMARK = load("studio/icons/wizards/modules/benchmark.svg", 3564092764330964613L, 2);
      /** 16x16 */ public static final @NotNull Icon DYNAMIC_FEATURE = load("studio/icons/wizards/modules/dynamic-feature.svg", 2867634493356069232L, 2);
      /** 16x16 */ public static final @NotNull Icon INSTANT_DYNAMIC_FEATURE = load("studio/icons/wizards/modules/instant-dynamic-feature.svg", -3832965702703417796L, 2);
      /** 16x16 */ public static final @NotNull Icon NATIVE = load("studio/icons/wizards/modules/native.svg", -969872873971867513L, 2);
      /** 16x16 */ public static final @NotNull Icon PHONE_TABLET = load("studio/icons/wizards/modules/phone-tablet.svg", 6408720014881559132L, 2);
      /** 16x16 */ public static final @NotNull Icon WEAR_OS = load("studio/icons/wizards/modules/wear-os.svg", 6749561139179379272L, 2);
    }
  }
}
