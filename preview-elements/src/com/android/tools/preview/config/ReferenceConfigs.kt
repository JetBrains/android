...
val ReferencePhoneConfig: DeviceConfig by lazy(LazyThreadSafetyMode.NONE) { getDeviceConfigFor(DEVICE_CLASS_PHONE_ID) }
...
val ReferenceTabletConfig: DeviceConfig by lazy(LazyThreadSafetyMode.NONE) { getDeviceConfigFor(DEVICE_CLASS_TABLET_ID) }

/** Default device configuration for Desktops */
val ReferenceDesktopConfig: DeviceConfig by lazy(LazyThreadSafetyMode.NONE) { getDeviceConfigFor(DEVICE_CLASS_DESKTOP_ID) }
