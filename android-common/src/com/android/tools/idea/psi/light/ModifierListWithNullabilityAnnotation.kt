...
/** [LightModifierList] with the ability to additionally prepend the correct nullability annotation to the list of modifiers. */
class ModifierListWithNullabilityAnnotation(private val wrapped: PsiModifierList, private val isNonNull: Boolean) :
