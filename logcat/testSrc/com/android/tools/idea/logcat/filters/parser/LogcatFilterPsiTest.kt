...
private fun PsiFile.toFilter(): Filter {
  ...
  return when {
    ...
    expressions.size == 1 -> expressions[0].toFilter()
      ...
      // treat consecutive top level values as concatenations rather than an 'and'. This isn't
      // really testing the parser code, rather it
      ...
      // Then, combine in an AndFilter while creating a single TopLevelFilter for consecutive
