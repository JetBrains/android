...
// Timeout when waiting for things to happen. 1 sec works too but when running stress test locally
// with --runs_per_test= it takes longer
...
internal fun MessageProcessor.onIdle(run: () -> Unit) {
  ...
  // This call depends on AndroidExecutors.workerThreadExecutor being replaced by a
  // ThreadPoolExecutor that allows operations that are
