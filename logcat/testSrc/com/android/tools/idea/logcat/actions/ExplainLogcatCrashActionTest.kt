...
class ExplainLogcatCrashActionTest {
  ...
  @get:Rule val rule1 = RuleChain(projectRule, logcatEditorRule, EdtRule())
  ...
  fun testExtractPlain() {
    assertThat(extractRelevant("Compat change id reported: 183155436; UID 10111; state: ENABLED\n"))
      .isEqualTo("Compat change id reported: 183155436; UID 10111; state: ENABLED")
  }
