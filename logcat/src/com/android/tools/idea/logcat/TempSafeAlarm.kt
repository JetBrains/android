 ...
 *
 * TODO(b/199731543): Remove this class when [LogcatReceiver] is made coroutine friendly.
 */
internal class TempSafeAlarm(threadToUse: ThreadToUse, parentDisposable: Disposable) : Disposable {
