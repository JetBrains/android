...
private val datetimeFormat = TimestampFormat(DATETIME)
 ...
 *
 * Generated by concatenating all the fields in the LogCatMessage in the order they appear in the display.
 */
internal fun LogCatMessage.formatMessageForFilter(zoneId: ZoneId): String {
  val (logLevel, pid, tid, appName, tag, timestamp) = header
  val datetime = datetimeFormat.format(timestamp, zoneId)
  return "$datetime$pid-$tid $tag $appName ${logLevel.priorityLetter} $message"
}
