...
class RssMemoryTooltip(val timeline: Timeline, val counterName: String, private val rssValues: RangedSeries<Long>) :
  TooltipModel, AspectModel<RssMemoryTooltip.Aspect>() {
  enum class Aspect {
