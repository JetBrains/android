...
class JavaKotlinAllocationsTaskArgs(override val isFromStartup: Boolean = false, private val artifact: AllocationSessionArtifact?) :
  AllocationsTaskArgs<AllocationSessionArtifact>() {
