...
public class LegacyRpcNetworkConnectionsModelTest {
  ...
  @Rule public FakeGrpcChannel myGrpcChannel = new FakeGrpcChannel("LegacyRpcNetworkConnectionsModelTest", myProfilerService,
