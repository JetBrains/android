...
class SystemTraceModelAdapterTest {
  ...
  fun `padding fills gaps`() {
    ...
    assertThat(paddedEvents)
      .isEqualTo(
        listOf(
          SeriesData(0, 0L to 1L),
          SeriesData(1, 1),
          SeriesData(2, 2),
          SeriesData(3, 3),
  ...
  fun `test aggregating counter data with overlapping timestamps, non-normalized start time`() {
    ...
    val aggregatedCounter = aggregatedCounters["foo"]!!
    val expectedCounter =
      listOf<SeriesData<Long>>(SeriesData(1L, 100), SeriesData(2L, 125), SeriesData(3L, 250), SeriesData(5L, 350), SeriesData(6L, 375))
  ...
  fun `test combining counter data with non-overlapping staggered timestamps, normalized start time`() {
    ...
    val expectedCounters =
      listOf<SeriesData<Long>>(SeriesData(2L, 125), SeriesData(3L, 225), SeriesData(4L, 250), SeriesData(5L, 350), SeriesData(6L, 375))
  ...
  fun `test transforming counter data to delta series`() {
    ...
    val expectedCounter =
      listOf<SeriesData<Long>>(SeriesData(2L, 25L), SeriesData(3L, 100L), SeriesData(4L, 25L), SeriesData(5L, 100L), SeriesData(6L, 25L))
