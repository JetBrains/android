...
class MainProcessSelectorTest {
  ...
  fun `id hint as 0 never matches`() {
    ...
    val newProcessList = listOf(ProcessModel(100, "process1", emptyMap(), emptyMap()), ProcessModel(0, "process0", emptyMap(), emptyMap()))
  ...
  fun `use process safe name for name hint when empty name`() {
    ...
    val newProcessList =
      listOf(
        ...
        ProcessModel(10, "", mapOf(10 to ThreadModel(10, 10, "process0", listOf(), listOf(), listOf())), emptyMap()),
      )
  ...
  fun `use process safe name for name hint when PID name`() {
    ...
    val newProcessList =
      listOf(
        ...
        ProcessModel(10, "<10>", mapOf(10 to ThreadModel(10, 10, "process0", listOf(), listOf(), listOf())), emptyMap()),
      )
