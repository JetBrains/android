...
public class FlameChartTest {
  ...
  public void changingTheSelectionTheNodeShouldBeRecalculated() {
    ...
    // should "B" 19..24
    assertEquals("B", root.getFirstChild().getData().getName());
