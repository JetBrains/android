...
@RunsInEdt
class AppCompileTimeRClassDefaultRefactoringProcessorTest : UpgradeGradleFileModelTestCase() {
  ...
  fun `Refactoring enabled for 9_0_0-alpha01`() {
    val project = projectRule.project
    val processor = AppCompileTimeRClassDefaultRefactoringProcessor(project, AgpVersion.parse("8.0.0"), AgpVersion.parse("9.0.0-alpha01"))
