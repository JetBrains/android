...
class ComputeGradlePluginUpgradeStateTest(val case: Case, val flags: Flags) {
  ...
  companion object {
    ...
    enum class Case(
      ...
      VERSION_AT_MIN("4.0.0", "7.0.0", agpVersions("4.0.0", "7.0.0"), STRONGLY_RECOMMEND.upgradeTo("7.0.0")),
      VERSION_AT_MIN_ALPHA("4.0.0-alpha01", "7.0.0", agpVersions("4.0.0", "7.0.0"), FORCE.upgradeTo("4.0.0")),
      VERSION_AT_MIN_BETA("4.0.0-beta02", "7.0.0", agpVersions("4.0.0", "7.0.0"), FORCE.upgradeTo("4.0.0")),
      VERSION_AT_MIN_RC("4.0.0-rc02", "7.0.0", agpVersions("4.0.0", "7.0.0"), STRONGLY_RECOMMEND.upgradeTo("7.0.0")),
      ...
      FORCED_UPGRADE_PREFERS_LATEST_WITHIN_SERIES("3.1.0", "7.0.0", agpVersions("4.0.0-alpha01", "4.0.0-beta02", "4.0.0", "4.0.1", "4.0.2", "4.1.0", "4.1.1"), FORCE.upgradeTo("4.0.2")),
      FORCED_UPGRADE_PREFERS_LATEST_WITHIN_SERIES_CAPPED("3.1.0", "4.0.1", agpVersions("4.0.0-alpha01", "4.0.0-beta02", "4.0.0", "4.0.1", "4.0.2", "4.1.0", "4.1.1"), FORCE.upgradeTo("4.0.1")),
      ...
      UNKNOWN_PUBLISHED_STATE_RECOMMENDS_LATEST_KNOWN_BOTH_DEPRECATED("4.0.0", "4.1.1", agpVersions(), RECOMMEND.upgradeTo("4.1.1")),
      UNKNOWN_PUBLISHED_STATE_RECOMMENDS_LATEST_KNOWN_FROM_DEPRECATED_1("4.0.0", "7.0.0", agpVersions(), STRONGLY_RECOMMEND.upgradeTo("7.0.0")),
      UNKNOWN_PUBLISHED_STATE_RECOMMENDS_LATEST_KNOWN_FROM_DEPRECATED_2("4.0.0", "7.1.1", agpVersions(), STRONGLY_RECOMMEND.upgradeTo("7.1.1")),
      UNKNOWN_PUBLISHED_STATE_RECOMMENDS_LATEST_KNOWN_FROM_DEPRECATED_3("4.0.0", "7.2.2", agpVersions(), STRONGLY_RECOMMEND.upgradeTo("7.2.2")),
      UNKNOWN_PUBLISHED_STATE_RECOMMENDS_LATEST_KNOWN_FROM_DEPRECATED_4("4.0.0", "8.0.3", agpVersions(), STRONGLY_RECOMMEND.upgradeTo("8.0.3")),
      UNKNOWN_PUBLISHED_STATE_RECOMMENDS_LATEST_KNOWN_FROM_DEPRECATED_5("4.0.0", "8.1.2", agpVersions(), STRONGLY_RECOMMEND.upgradeTo("8.1.2")),
      UNKNOWN_PUBLISHED_STATE_RECOMMENDS_LATEST_KNOWN_FROM_DEPRECATED_6("4.0.0", "8.2.1", agpVersions(), STRONGLY_RECOMMEND.upgradeTo("8.2.1")),
      UNKNOWN_PUBLISHED_STATE_RECOMMENDS_LATEST_KNOWN_FROM_DEPRECATED_7("4.0.0", "8.3.0", agpVersions(), STRONGLY_RECOMMEND.upgradeTo("8.3.0")),
      UNKNOWN_PUBLISHED_STATE_RECOMMENDS_LATEST_KNOWN_FROM_DEPRECATED_8("4.0.0", "9.0.0", agpVersions(), STRONGLY_RECOMMEND.upgradeTo("9.0.0")),
      ...
      UPGRADE_INCREMENTALLY_DEPRECATED_WITHIN_SERIES_EVEN_IN_NEWER_VERSION_3("4.0.0", "7.0.0", publishedVersions, STRONGLY_RECOMMEND.upgradeTo("4.2.2")),
      ...
      UPGRADE_INCREMENTALLY_DEPRECATED_WITHIN_SERIES_EVEN_IN_NEWER_VERSION_4("4.0.0", "7.3.0", publishedVersions, STRONGLY_RECOMMEND.upgradeTo("4.2.2")),
      ...
      UPGRADE_INCREMENTALLY_DEPRECATED_WITHIN_SERIES_EVEN_IN_NEWER_VERSION_5("4.0.0", "8.0.0", publishedVersions, STRONGLY_RECOMMEND.upgradeTo("4.2.2")),
