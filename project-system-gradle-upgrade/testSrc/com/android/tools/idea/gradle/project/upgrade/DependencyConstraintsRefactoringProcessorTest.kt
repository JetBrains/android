...
@RunsInEdt
class DependencyConstraintsRefactoringProcessorTest : UpgradeGradleFileModelTestCase() {
  override val projectRule = AndroidProjectRule.onDisk()
  private val propertyKey = "android.dependency.useConstraints"
  ...
  fun `Read More Url is correct`() {
    ...
    assertEquals("https://developer.android.com/r/tools/upgrade-assistant/dependency-constraints", processor.getReadMoreUrl())
  }
  ...
  fun `Refactoring enabled for 9_0_0-alpha01`() {
    val project = projectRule.project
    val processor = DependencyConstraintsRefactoringProcessor(project, AgpVersion.parse("8.0.0"), AgpVersion.parse("9.0.0-alpha02"))
