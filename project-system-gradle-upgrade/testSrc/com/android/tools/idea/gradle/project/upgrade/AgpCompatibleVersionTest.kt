...
import com.android.tools.idea.gradle.project.upgrade.GradleVersionRefactoringProcessor.Companion.getCompatibleGradleVersion
...
class AgpCompatibleVersionTest : LightPlatformTestCase() {
  ...
  fun testCompatibleVersions() {
    val data = mapOf(
      ...
      "7.0" to GradleVersion.parse(SdkConstants.GRADLE_LATEST_VERSION),
    )
