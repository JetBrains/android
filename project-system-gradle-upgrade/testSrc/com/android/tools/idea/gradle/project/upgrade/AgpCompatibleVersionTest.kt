  ...
  fun testCompatibleVersions() {
    val data =
      mapOf(
         ...
         * involve a careful look at the compatibility tables used by [getCompatibleGradleVersion] (which failing this test and reading this
         ...
         */
        "3.1" to GradleVersion.version("7.0.2"),
        "3.2" to GradleVersion.version("7.0.2"),
        "3.3" to GradleVersion.version("7.0.2"),
        "3.4" to GradleVersion.version("7.0.2"),
        "3.5" to GradleVersion.version("7.0.2"),
        "3.6" to GradleVersion.version("7.0.2"),
        "4.0" to GradleVersion.version("7.0.2"),
        "4.1" to GradleVersion.version("7.0.2"),
        "4.2" to GradleVersion.version("7.0.2"),
        ...
        "8.11" to GradleVersion.version("8.13"),
        "8.12" to GradleVersion.version("8.13"),
        "8.13" to GradleVersion.version("8.13"),
        "9.0" to GradleVersion.version("9.1.0"),
        "9.1" to GradleVersion.version("9.3.1"),
        "9.2" to GradleVersion.version(SdkConstants.GRADLE_LATEST_VERSION),
      )
    fun String.toBetaVersionString() =
      when (this) {
        "3.1" -> "$this.0-beta2"
        else -> "$this.0-beta02"
      }
