...
class BuiltInKotlinDefaultRefactoringProcessor : AbstractBooleanPropertyDefaultRefactoringProcessor {
  ...
  override val insertPropertyText = AgpUpgradeBundle.message("builtInKotlin.default.usageType")
  override val tooltip = AgpUpgradeBundle.message("builtInKotlin.default.usageType")
