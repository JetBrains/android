...
class DependencyConstraintsRefactoringProcessor: AbstractBooleanPropertyDefaultRefactoringProcessor {
  ...
  override val insertPropertyText = AgpUpgradeBundle.message("dependencyConstraintsDefaultRefactoringProcessor.tooltipText")
  override val tooltip = AgpUpgradeBundle.message("dependencyConstraintsDefaultRefactoringProcessor.usage")
  override val usageViewHeader = AgpUpgradeBundle.message("dependencyConstraintsDefaultRefactoringProcessor.usageView.header")
