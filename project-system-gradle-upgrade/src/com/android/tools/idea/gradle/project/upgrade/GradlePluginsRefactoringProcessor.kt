...
class GradlePluginsRefactoringProcessor : AgpUpgradeComponentRefactoringProcessor {
  ...
  override fun getCommandName(): String = AgpUpgradeBundle.message("gradlePluginsRefactoringProcessor.commandName")
  ...
  override fun createUsageViewDescriptor(usages: Array<out UsageInfo>): UsageViewDescriptor {
    return object : UsageViewDescriptorAdapter() {
      ...
      override fun getProcessedElementsHeader() = AgpUpgradeBundle.message("gradlePluginsRefactoringProcessor.usageView.header")
    }
  }
  ...
  companion object {
    ...
    fun `kotlin-gradle-plugin-compatibility-info`(compatibleGradleVersion: CompatibleGradleVersion): Version =
      when (compatibleGradleVersion) {
        ...
        VERSION_8_0 -> Version.parse("1.6.21")
        VERSION_8_2 -> Version.parse("1.6.21")
        VERSION_8_4 -> Version.parse("1.6.21")
        VERSION_8_6 -> Version.parse("1.6.21")
        VERSION_8_7 -> Version.parse("1.6.21")
        VERSION_8_9 -> Version.parse("1.6.21")
    ...
    fun `androidx-navigation-safeargs-gradle-plugin-compatibility-info`(compatibleGradleVersion: CompatibleGradleVersion): Version =
      when (compatibleGradleVersion) {
        ...
        VERSION_6_5,
        VERSION_6_7_1,
        VERSION_7_0_2 -> Version.parse("2.0.0")
    ...
    fun `de-mannodermaus-android-junit5-plugin-compatibility-info`(compatibleGradleVersion: CompatibleGradleVersion): Version =
      when (compatibleGradleVersion) {
        ...
        VERSION_4_6,
        VERSION_4_10_1,
        VERSION_5_1_1 -> Version.parse("1.3.1.0")
        VERSION_5_4_1,
        VERSION_5_6_4,
        VERSION_6_1_1 -> Version.parse("1.4.2.1")
        VERSION_6_5,
        VERSION_6_7_1,
        VERSION_7_0_2,
        VERSION_7_2,
    ...
    fun `com-google-firebase-crashlytics-plugin-compatibility-info`(compatibleGradleVersion: CompatibleGradleVersion): Version =
      when (compatibleGradleVersion) {
        ...
        VERSION_6_1_1,
        VERSION_6_5,
        VERSION_6_7_1 -> Version.parse("2.0.0")
        VERSION_7_0_2,
        VERSION_7_2,
        VERSION_7_3_3,
        VERSION_7_4,
    ...
    fun `com-google-firebase-appdistribution-plugin-compatibility-info`(compatibleGradleVersion: CompatibleGradleVersion): Version =
      when (compatibleGradleVersion) {
        VERSION_4_4,
        VERSION_4_6 -> Version.parse("1.0.0")
        VERSION_4_10_1,
        VERSION_5_1_1,
        VERSION_5_4_1,
        VERSION_5_6_4 -> Version.parse("1.1.0")
        VERSION_6_1_1,
        VERSION_6_5,
        VERSION_6_7_1 -> Version.parse("1.4.0")
        VERSION_7_0_2,
        VERSION_7_2,
        VERSION_7_3_3,
        VERSION_7_4,
    ...
    fun `com-google-firebase-perf-plugin-compatibility-info`(compatibleGradleVersion: CompatibleGradleVersion): Version =
      when (compatibleGradleVersion) {
        ...
        VERSION_6_5,
        VERSION_6_7_1,
        VERSION_7_0_2 -> Version.parse("1.2.1")
        VERSION_7_2,
        VERSION_7_3_3,
        VERSION_7_4,
        VERSION_7_5,
    ...
    fun `com-google-android-gms-oss-licenses-plugin-compatibility-info`(compatibleGradleVersion: CompatibleGradleVersion): Version =
      when (compatibleGradleVersion) {
        VERSION_4_4,
        VERSION_4_6,
        VERSION_4_10_1 -> Version.parse("0.9.3")
        VERSION_5_1_1,
        VERSION_5_4_1,
        VERSION_5_6_4,
        VERSION_6_1_1,
        VERSION_6_5,
        VERSION_6_7_1 -> Version.parse("0.10.1")
        VERSION_7_0_2,
        VERSION_7_2,
        VERSION_7_3_3,
        VERSION_7_4,
    ...
    fun `com-google-gms-google-services-plugin-compatibility-info`(compatibleGradleVersion: CompatibleGradleVersion): Version =
      when (compatibleGradleVersion) {
        ...
        VERSION_6_5,
        VERSION_6_7_1,
        VERSION_7_0_2 -> Version.parse("4.0.1")
        VERSION_7_2,
        VERSION_7_3_3,
        VERSION_7_4,
        VERSION_7_5,
    ...
    fun `com-google-dagger-hilt-android-gradle-plugin-compatibility-info`(compatibleGradleVersion: CompatibleGradleVersion): Version =
      when (compatibleGradleVersion) {
        ...
        VERSION_7_0_2,
        VERSION_7_2 -> Version.parse("2.38")
        VERSION_7_3_3,
        VERSION_7_4,
        VERSION_7_5,
        VERSION_8_0,
    ...
    fun `com-google-protobuf-protobuf-gradle-plugin-compatibility-info`(compatibleGradleVersion: CompatibleGradleVersion): Version =
      when (compatibleGradleVersion) {
        ...
        VERSION_4_10_1,
        VERSION_5_1_1,
        VERSION_5_4_1 -> Version.parse("0.8.8")
        VERSION_5_6_4 -> Version.parse("0.8.11")
        VERSION_6_1_1,
        VERSION_6_5 -> Version.parse("0.8.12")
        VERSION_6_7_1 -> Version.parse("0.8.13")
        VERSION_7_0_2,
        VERSION_7_2,
        VERSION_7_3_3,
        VERSION_7_4,
        VERSION_7_5 -> Version.parse("0.8.16")
        VERSION_8_0,
        VERSION_8_2,
        VERSION_8_4,
        VERSION_8_6,
    ...
    fun `androidx-baselineprofile-gradle-plugin-compatibility-info`(compatibleGradleVersion: CompatibleGradleVersion): Version =
      when (compatibleGradleVersion) {
        ...
        VERSION_7_5,
        VERSION_8_0,
        VERSION_8_2 -> Version.parse("1.2.0")
        VERSION_8_4,
        VERSION_8_6,
        VERSION_8_7,
        VERSION_8_9,
    ...
    /**
     * This table contains both the artifact names and the plugin names of the well known plugins, as each of them can be used to declare
     * that a project uses a given plugin or set of plugins (one through a `classpath` configuration, the other through the plugins Dsl).
     */
    val WELL_KNOWN_GRADLE_PLUGIN_TABLE =
      mapOf(
        ...
        "androidx.room" to ::`androidx-room-plugin-compatibility-info`,
        "androidx.room:androidx.room.gradle.plugin" to ::`androidx-room-plugin-compatibility-info`,
      )
