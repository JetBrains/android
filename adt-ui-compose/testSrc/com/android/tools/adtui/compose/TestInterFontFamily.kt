...
private val InterFontFamily =
  FontFamily(
    ...
    Font(
      resource = "test-fonts/inter/Inter-ThinItalic.ttf",
    ...
    Font(
      resource = "test-fonts/inter/Inter-LightItalic.ttf",
      weight = FontWeight.Light,
      style = FontStyle.Italic,
    ),
    Font(resource = "test-fonts/inter/Inter-Regular.ttf", weight = FontWeight.Normal),
    Font(
      resource = "test-fonts/inter/Inter-Italic.ttf",
    ...
    Font(
      resource = "test-fonts/inter/Inter-BoldItalic.ttf",
    ...
    Font(
      resource = "test-fonts/inter/Inter-BlackItalic.ttf",
