...
private val InterFontFamily =
  FontFamily(
    ...
    Font(resource = "test-fonts/inter/Inter-ExtraLightItalic.ttf", weight = FontWeight.ExtraLight, style = FontStyle.Italic),
    ...
    Font(resource = "test-fonts/inter/Inter-SemiBoldItalic.ttf", weight = FontWeight.SemiBold, style = FontStyle.Italic),
    ...
    Font(resource = "test-fonts/inter/Inter-ExtraBoldItalic.ttf", weight = FontWeight.ExtraBold, style = FontStyle.Italic),
