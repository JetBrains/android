...
private val JetBrainsMonoFontFamily =
  FontFamily(
    ...
    Font(resource = "test-fonts/jetbrains-mono/JetBrainsMono-SemiBoldItalic.ttf", weight = FontWeight.SemiBold, style = FontStyle.Italic),
    ...
    Font(resource = "test-fonts/jetbrains-mono/JetBrainsMono-ExtraBoldItalic.ttf", weight = FontWeight.ExtraBold, style = FontStyle.Italic),
