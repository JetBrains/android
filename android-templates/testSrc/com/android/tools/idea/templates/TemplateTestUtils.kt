 ...
 */
internal fun verifyLastLoggedUsage(usageTracker: TestUsageTracker, templateRenderer: TemplateRenderer, moduleState: ModuleTemplateData) {
  val usage = usageTracker.usages.last()!!
  assertEquals(EventKind.TEMPLATE_RENDER, usage.studioEvent.kind)
  // TODO(qumeric): remove this after fixing b/115604184
  if (templateRenderer.toString() != "BLANK_ACTIVITY") {
