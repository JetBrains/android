...
public class RoomDetachStmtImpl extends RoomStmtImpl implements RoomDetachStmt {

  public RoomDetachStmtImpl(ASTNode node) {
    super(node);
  }
  ...
  public RoomDatabaseName getDatabaseName() {
    return findNotNullChildByClass(RoomDatabaseName.class);
  }
