...
public class RoomRollbackStmtImpl extends RoomStmtImpl implements RoomRollbackStmt {

  public RoomRollbackStmtImpl(ASTNode node) {
    super(node);
  }
  ...
  public RoomSavepointName getSavepointName() {
    return findChildByClass(RoomSavepointName.class);
  }
