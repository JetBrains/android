...
public interface RoomSelectCoreSelect extends PsiElement {

  @Nullable
  RoomFromClause getFromClause();

  @Nullable
  RoomGroupByClause getGroupByClause();

  @NotNull
  RoomResultColumns getResultColumns();
