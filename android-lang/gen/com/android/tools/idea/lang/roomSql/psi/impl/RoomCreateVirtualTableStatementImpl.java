...
public class RoomCreateVirtualTableStatementImpl extends RoomStatementImpl implements RoomCreateVirtualTableStatement {
  ...
  @Override
  @NotNull
  public List<RoomModuleArgument> getModuleArgumentList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, RoomModuleArgument.class);
  }

  @Override
  @NotNull
  public RoomModuleName getModuleName() {
    return findNotNullChildByClass(RoomModuleName.class);
  }
