...
public class RoomAnalyzeStatementImpl extends ASTWrapperPsiElement implements RoomAnalyzeStatement {

  public RoomAnalyzeStatementImpl(@NotNull ASTNode node) {
    super(node);
  }
