...
public class RoomSelectCoreSelectImpl extends ASTWrapperPsiElement implements RoomSelectCoreSelect {

  public RoomSelectCoreSelectImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @Nullable
  public RoomFromClause getFromClause() {
    return findChildByClass(RoomFromClause.class);
  }

  @Override
  @Nullable
  public RoomGroupByClause getGroupByClause() {
    return findChildByClass(RoomGroupByClause.class);
  }

  @Override
  @NotNull
  public RoomResultColumns getResultColumns() {
    return findNotNullChildByClass(RoomResultColumns.class);
  }
