...
public class RoomEquivalenceExprImpl extends RoomExprImpl implements RoomEquivalenceExpr {

  public RoomEquivalenceExprImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull RoomVisitor visitor) {
    visitor.visitEquivalenceExpr(this);
  }
