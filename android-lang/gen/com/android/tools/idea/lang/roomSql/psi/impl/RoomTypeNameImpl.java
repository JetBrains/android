...
public class RoomTypeNameImpl extends AbstractRoomNameElement implements RoomTypeName {

  public RoomTypeNameImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<RoomSignedNumber> getSignedNumberList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, RoomSignedNumber.class);
  }
