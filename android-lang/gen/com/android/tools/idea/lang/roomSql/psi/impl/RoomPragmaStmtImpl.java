...
public class RoomPragmaStmtImpl extends RoomStmtImpl implements RoomPragmaStmt {

  public RoomPragmaStmtImpl(ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public RoomPragmaName getPragmaName() {
    return findNotNullChildByClass(RoomPragmaName.class);
  }

  @Override
  @Nullable
  public RoomPragmaValue getPragmaValue() {
    return findChildByClass(RoomPragmaValue.class);
  }
