...
public class RoomColumnRefExprImpl extends RoomExprImpl implements RoomColumnRefExpr {

  public RoomColumnRefExprImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull RoomVisitor visitor) {
    visitor.visitColumnRefExpr(this);
  }
