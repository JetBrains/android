...
public class ProguardR8ClassSpecificationBodyImpl extends ASTWrapperPsiElement implements ProguardR8ClassSpecificationBody {

  public ProguardR8ClassSpecificationBodyImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull ProguardR8Visitor visitor) {
    visitor.visitClassSpecificationBody(this);
  }
  ...
  @Override
  @NotNull
  public List<ProguardR8JavaRule> getJavaRuleList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, ProguardR8JavaRule.class);
  }
