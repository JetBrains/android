...
public class ProguardR8FileFilterImpl extends ASTWrapperPsiElement implements ProguardR8FileFilter {

  public ProguardR8FileFilterImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull ProguardR8Visitor visitor) {
    visitor.visitFileFilter(this);
  }
