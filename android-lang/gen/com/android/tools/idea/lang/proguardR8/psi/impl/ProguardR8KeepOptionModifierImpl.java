...
public class ProguardR8KeepOptionModifierImpl extends ASTWrapperPsiElement implements ProguardR8KeepOptionModifier {

  public ProguardR8KeepOptionModifierImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull ProguardR8Visitor visitor) {
    visitor.visitKeepOptionModifier(this);
  }
