...
public class ProguardR8IncludeFileImpl extends ASTWrapperPsiElement implements ProguardR8IncludeFile {

  public ProguardR8IncludeFileImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @Nullable
  public ProguardR8File getFile() {
    return findChildByClass(ProguardR8File.class);
  }
