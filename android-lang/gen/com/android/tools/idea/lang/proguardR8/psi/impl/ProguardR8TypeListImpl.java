...
public class ProguardR8TypeListImpl extends ASTWrapperPsiElement implements ProguardR8TypeList {

  public ProguardR8TypeListImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<ProguardR8Type> getTypeList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, ProguardR8Type.class);
  }
