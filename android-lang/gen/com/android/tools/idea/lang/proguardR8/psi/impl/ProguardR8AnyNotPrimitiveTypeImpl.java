...
public class ProguardR8AnyNotPrimitiveTypeImpl extends ASTWrapperPsiElement implements ProguardR8AnyNotPrimitiveType {

  public ProguardR8AnyNotPrimitiveTypeImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull ProguardR8Visitor visitor) {
    visitor.visitAnyNotPrimitiveType(this);
  }
