...
public class AidlEnumeratorDeclarationImpl extends AbstractAidlDeclarationImpl implements AidlEnumeratorDeclaration {

  public AidlEnumeratorDeclarationImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull AidlVisitor visitor) {
    visitor.visitEnumeratorDeclaration(this);
  }
