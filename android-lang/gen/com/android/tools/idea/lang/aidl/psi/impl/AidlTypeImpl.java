...
public class AidlTypeImpl extends AidlPsiCompositeElementImpl implements AidlType {

  public AidlTypeImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  public AidlType getType() {
    return findChildByClass(AidlType.class);
  }
