...
public interface AndroidSqlCreateTableStatement extends PsiElement {

  @NotNull
  List<AndroidSqlColumnDefinition> getColumnDefinitionList();
  ...
  @NotNull
  List<AndroidSqlTableConstraint> getTableConstraintList();
