...
public class AndroidSqlForeignTableImpl extends ASTWrapperPsiElement implements AndroidSqlForeignTable {

  public AndroidSqlForeignTableImpl(@NotNull ASTNode node) {
    super(node);
  }
