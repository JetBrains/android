...
public class AndroidSqlCollateExpressionImpl extends AndroidSqlExpressionImpl implements AndroidSqlCollateExpression {

  public AndroidSqlCollateExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  public AndroidSqlCollationName getCollationName() {
    return findNotNullChildByClass(AndroidSqlCollationName.class);
  }
