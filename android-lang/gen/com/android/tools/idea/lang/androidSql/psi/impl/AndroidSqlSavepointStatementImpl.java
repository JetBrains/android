...
public class AndroidSqlSavepointStatementImpl extends ASTWrapperPsiElement implements AndroidSqlSavepointStatement {

  public AndroidSqlSavepointStatementImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull AndroidSqlVisitor visitor) {
    visitor.visitSavepointStatement(this);
  }
  ...
  @Override
  @NotNull
  public AndroidSqlSavepointName getSavepointName() {
    return findNotNullChildByClass(AndroidSqlSavepointName.class);
  }
