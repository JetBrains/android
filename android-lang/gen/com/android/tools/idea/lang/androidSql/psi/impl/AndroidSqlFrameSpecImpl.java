...
public class AndroidSqlFrameSpecImpl extends ASTWrapperPsiElement implements AndroidSqlFrameSpec {

  public AndroidSqlFrameSpecImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull AndroidSqlVisitor visitor) {
    visitor.visitFrameSpec(this);
  }
  ...
  @Override
  @NotNull
  public AndroidSqlFrameClause getFrameClause() {
    return findNotNullChildByClass(AndroidSqlFrameClause.class);
  }
