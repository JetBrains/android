...
public class AndroidSqlWithClauseTableImpl extends ASTWrapperPsiElement implements AndroidSqlWithClauseTable {

  public AndroidSqlWithClauseTableImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull AndroidSqlVisitor visitor) {
    visitor.visitWithClauseTable(this);
  }
  ...
  @Override
  @Nullable
  public AndroidSqlWithClauseSelectStatement getWithClauseSelectStatement() {
    return findChildByClass(AndroidSqlWithClauseSelectStatement.class);
  }

  @Override
  @NotNull
  public AndroidSqlWithClauseTableDef getWithClauseTableDef() {
    return findNotNullChildByClass(AndroidSqlWithClauseTableDef.class);
  }
