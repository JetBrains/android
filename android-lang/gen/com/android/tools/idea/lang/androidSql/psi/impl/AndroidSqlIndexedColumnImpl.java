...
public class AndroidSqlIndexedColumnImpl extends ASTWrapperPsiElement implements AndroidSqlIndexedColumn {

  public AndroidSqlIndexedColumnImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  public AndroidSqlColumnName getColumnName() {
    return findNotNullChildByClass(AndroidSqlColumnName.class);
  }
