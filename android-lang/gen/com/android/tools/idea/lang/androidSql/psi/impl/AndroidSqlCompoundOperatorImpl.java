...
public class AndroidSqlCompoundOperatorImpl extends ASTWrapperPsiElement implements AndroidSqlCompoundOperator {

  public AndroidSqlCompoundOperatorImpl(@NotNull ASTNode node) {
    super(node);
  }
