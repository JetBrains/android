...
public class AndroidSqlTypeNameImpl extends AbstractAndroidSqlNameElement implements AndroidSqlTypeName {

  public AndroidSqlTypeNameImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<AndroidSqlSignedNumber> getSignedNumberList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, AndroidSqlSignedNumber.class);
  }
