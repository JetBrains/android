...
public interface AndroidSqlTableConstraint extends PsiElement {

  @NotNull
  List<AndroidSqlColumnName> getColumnNameList();

  @Nullable
  AndroidSqlConflictClause getConflictClause();

  @Nullable
  AndroidSqlExpression getExpression();

  @Nullable
  AndroidSqlForeignKeyClause getForeignKeyClause();
