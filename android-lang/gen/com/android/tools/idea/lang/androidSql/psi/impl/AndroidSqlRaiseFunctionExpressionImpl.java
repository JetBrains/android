...
public class AndroidSqlRaiseFunctionExpressionImpl extends AndroidSqlExpressionImpl implements AndroidSqlRaiseFunctionExpression {

  public AndroidSqlRaiseFunctionExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull AndroidSqlVisitor visitor) {
    visitor.visitRaiseFunctionExpression(this);
  }
  ...
  @Override
  @Nullable
  public AndroidSqlErrorMessage getErrorMessage() {
    return findChildByClass(AndroidSqlErrorMessage.class);
  }
