...
public class AndroidSqlWithClauseSelectStatementImpl extends ASTWrapperPsiElement implements AndroidSqlWithClauseSelectStatement {

  public AndroidSqlWithClauseSelectStatementImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  public AndroidSqlSelectStatement getSelectStatement() {
    return findNotNullChildByClass(AndroidSqlSelectStatement.class);
  }
