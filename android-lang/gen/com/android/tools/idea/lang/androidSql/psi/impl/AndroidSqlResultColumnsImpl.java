...
public class AndroidSqlResultColumnsImpl extends ASTWrapperPsiElement implements AndroidSqlResultColumns {

  public AndroidSqlResultColumnsImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<AndroidSqlResultColumn> getResultColumnList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, AndroidSqlResultColumn.class);
  }
