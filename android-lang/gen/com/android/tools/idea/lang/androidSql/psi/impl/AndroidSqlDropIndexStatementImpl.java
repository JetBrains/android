...
public class AndroidSqlDropIndexStatementImpl extends ASTWrapperPsiElement implements AndroidSqlDropIndexStatement {

  public AndroidSqlDropIndexStatementImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull AndroidSqlVisitor visitor) {
    visitor.visitDropIndexStatement(this);
  }
