...
public class AndroidSqlCreateViewStatementImpl extends ASTWrapperPsiElement implements AndroidSqlCreateViewStatement {

  public AndroidSqlCreateViewStatementImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public AndroidSqlViewName getViewName() {
    return findNotNullChildByClass(AndroidSqlViewName.class);
  }
