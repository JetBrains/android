...
public class AndroidSqlErrorMessageImpl extends ASTWrapperPsiElement implements AndroidSqlErrorMessage {

  public AndroidSqlErrorMessageImpl(@NotNull ASTNode node) {
    super(node);
  }
