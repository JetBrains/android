...
public class AndroidSqlInsertStatementImpl extends ASTWrapperPsiElement implements AndroidSqlInsertStatement {

  public AndroidSqlInsertStatementImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @Nullable
  public AndroidSqlInsertColumns getInsertColumns() {
    return findChildByClass(AndroidSqlInsertColumns.class);
  }
