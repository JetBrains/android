...
public interface AndroidSqlSelectCoreSelect extends PsiElement {

  @Nullable
  AndroidSqlFromClause getFromClause();

  @Nullable
  AndroidSqlGroupByClause getGroupByClause();

  @NotNull
  AndroidSqlResultColumns getResultColumns();
