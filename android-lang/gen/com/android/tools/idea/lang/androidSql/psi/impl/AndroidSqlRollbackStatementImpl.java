...
public class AndroidSqlRollbackStatementImpl extends ASTWrapperPsiElement implements AndroidSqlRollbackStatement {

  public AndroidSqlRollbackStatementImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  public AndroidSqlSavepointName getSavepointName() {
    return findChildByClass(AndroidSqlSavepointName.class);
  }
