...
public class AndroidSqlDetachStatementImpl extends ASTWrapperPsiElement implements AndroidSqlDetachStatement {

  public AndroidSqlDetachStatementImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  public AndroidSqlDatabaseName getDatabaseName() {
    return findNotNullChildByClass(AndroidSqlDatabaseName.class);
  }
