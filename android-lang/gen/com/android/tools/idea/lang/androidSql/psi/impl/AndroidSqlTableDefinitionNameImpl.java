...
import com.android.tools.idea.lang.androidSql.psi.AbstractAndroidSqlNameElement;
import com.android.tools.idea.lang.androidSql.psi.*;

public class AndroidSqlTableDefinitionNameImpl extends AbstractAndroidSqlNameElement implements AndroidSqlTableDefinitionName {

  public AndroidSqlTableDefinitionNameImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  public @NotNull AndroidSqlTableDefinitionName setName(@NotNull String newName) {
