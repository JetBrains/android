...
public class AndroidSqlOrderClauseImpl extends ASTWrapperPsiElement implements AndroidSqlOrderClause {

  public AndroidSqlOrderClauseImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<AndroidSqlOrderingTerm> getOrderingTermList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, AndroidSqlOrderingTerm.class);
  }
