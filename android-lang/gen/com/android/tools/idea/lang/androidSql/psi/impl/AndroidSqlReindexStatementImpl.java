...
public class AndroidSqlReindexStatementImpl extends ASTWrapperPsiElement implements AndroidSqlReindexStatement {

  public AndroidSqlReindexStatementImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull AndroidSqlVisitor visitor) {
    visitor.visitReindexStatement(this);
  }
  ...
  public AndroidSqlDefinedTableName getDefinedTableName() {
    return findChildByClass(AndroidSqlDefinedTableName.class);
  }
