...
public class AndroidSqlCreateTableStatementImpl extends ASTWrapperPsiElement implements AndroidSqlCreateTableStatement {

  public AndroidSqlCreateTableStatementImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<AndroidSqlColumnDefinition> getColumnDefinitionList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, AndroidSqlColumnDefinition.class);
  }
  ...
  @Override
  @NotNull
  public List<AndroidSqlTableConstraint> getTableConstraintList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, AndroidSqlTableConstraint.class);
  }
