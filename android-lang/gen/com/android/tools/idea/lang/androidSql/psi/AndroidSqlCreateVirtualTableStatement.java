...
public interface AndroidSqlCreateVirtualTableStatement extends PsiElement {

  @Nullable
  AndroidSqlDatabaseName getDatabaseName();

  @NotNull
  List<AndroidSqlModuleArgument> getModuleArgumentList();

  @NotNull
  AndroidSqlModuleName getModuleName();
