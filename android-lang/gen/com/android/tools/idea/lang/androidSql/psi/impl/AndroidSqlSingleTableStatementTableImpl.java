...
public class AndroidSqlSingleTableStatementTableImpl extends ASTWrapperPsiElement implements AndroidSqlSingleTableStatementTable {

  public AndroidSqlSingleTableStatementTableImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull AndroidSqlVisitor visitor) {
    visitor.visitSingleTableStatementTable(this);
  }
