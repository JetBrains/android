...
public class AndroidSqlColumnDefinitionNameImpl extends AbstractAndroidSqlNameElement implements AndroidSqlColumnDefinitionName {

  public AndroidSqlColumnDefinitionNameImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  public @NotNull AndroidSqlColumnDefinitionName setName(@NotNull String newName) {
