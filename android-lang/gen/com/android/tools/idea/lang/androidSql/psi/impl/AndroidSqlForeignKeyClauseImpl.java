...
public class AndroidSqlForeignKeyClauseImpl extends ASTWrapperPsiElement implements AndroidSqlForeignKeyClause {

  public AndroidSqlForeignKeyClauseImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public AndroidSqlForeignTable getForeignTable() {
    return findNotNullChildByClass(AndroidSqlForeignTable.class);
  }
