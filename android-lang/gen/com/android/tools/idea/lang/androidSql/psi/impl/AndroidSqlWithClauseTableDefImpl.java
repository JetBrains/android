...
public class AndroidSqlWithClauseTableDefImpl extends ASTWrapperPsiElement implements AndroidSqlWithClauseTableDef {

  public AndroidSqlWithClauseTableDefImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<AndroidSqlColumnDefinitionName> getColumnDefinitionNameList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, AndroidSqlColumnDefinitionName.class);
  }
