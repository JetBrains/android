...
public class AndroidSqlWithClauseImpl extends ASTWrapperPsiElement implements AndroidSqlWithClause {

  public AndroidSqlWithClauseImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<AndroidSqlWithClauseTable> getWithClauseTableList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, AndroidSqlWithClauseTable.class);
  }
