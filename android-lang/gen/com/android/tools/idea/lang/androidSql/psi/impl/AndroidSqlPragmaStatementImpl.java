...
public class AndroidSqlPragmaStatementImpl extends ASTWrapperPsiElement implements AndroidSqlPragmaStatement {

  public AndroidSqlPragmaStatementImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public AndroidSqlPragmaName getPragmaName() {
    return findNotNullChildByClass(AndroidSqlPragmaName.class);
  }

  @Override
  @Nullable
  public AndroidSqlPragmaValue getPragmaValue() {
    return findChildByClass(AndroidSqlPragmaValue.class);
  }
