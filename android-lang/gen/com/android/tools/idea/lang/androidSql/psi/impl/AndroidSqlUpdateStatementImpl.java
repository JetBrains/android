...
public class AndroidSqlUpdateStatementImpl extends ASTWrapperPsiElement implements AndroidSqlUpdateStatement {

  public AndroidSqlUpdateStatementImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  public AndroidSqlSingleTableStatementTable getSingleTableStatementTable() {
    return findChildByClass(AndroidSqlSingleTableStatementTable.class);
  }
