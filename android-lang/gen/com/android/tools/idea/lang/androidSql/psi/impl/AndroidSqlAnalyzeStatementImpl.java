...
public class AndroidSqlAnalyzeStatementImpl extends ASTWrapperPsiElement implements AndroidSqlAnalyzeStatement {

  public AndroidSqlAnalyzeStatementImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @Nullable
  public AndroidSqlTableOrIndexName getTableOrIndexName() {
    return findChildByClass(AndroidSqlTableOrIndexName.class);
  }
