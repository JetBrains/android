...
class AgslCommenter : CodeDocumentationAwareCommenterEx {
  override fun getLineCommentPrefix(): String = "//"
  override fun getBlockCommentPrefix(): String = "/*"
  override fun getBlockCommentSuffix(): String = "*/"
  override fun getCommentedBlockCommentPrefix(): String? = null
  override fun getCommentedBlockCommentSuffix(): String? = null
  override fun getLineCommentTokenType(): IElementType? = AgslTokenTypes.COMMENT
  override fun getBlockCommentTokenType(): IElementType? = AgslTokenTypes.BLOCK_COMMENT
