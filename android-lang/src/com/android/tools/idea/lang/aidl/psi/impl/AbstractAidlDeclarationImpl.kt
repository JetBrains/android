...
abstract class AbstractAidlDeclarationImpl(node: ASTNode) : AidlPsiCompositeElementImpl(node), AidlDeclaration {
  ...
  override fun getGeneratedPsiElements(): Array<out PsiElement> {
    ...
    } else if (this is AidlEnumeratorDeclaration || this is AidlVariableDeclaration || this is AidlConstantDeclaration) {
