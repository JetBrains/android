...
class KeepRulesR8FileTypeTest : BasePlatformTestCase() {
  fun test() {
    var file = myFixture.configureByText("proguard.keep", "")
    assertThat(file.fileType).isEqualTo(KeepRulesR8FileType.INSTANCE)
