...
class MetaParserTest {
  @Test
  fun checkVersionNew() {
    val meta: SketchMeta = SketchTestUtils.parseMeta(AndroidTestBase.getTestDataPath() + "/sketch/meta51.json")
  ...
  @Test
  fun checkVersionOld() {
    val meta: SketchMeta = SketchTestUtils.parseMeta(AndroidTestBase.getTestDataPath() + "/sketch/meta43.json")
