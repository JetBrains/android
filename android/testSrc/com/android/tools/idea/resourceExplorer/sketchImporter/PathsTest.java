...
public class PathsTest {
  ...
  public void shapeDifferenceTest() {
    ...
    assertEquals(
      "M268.5,34 C227.23,34 194.76,66.3 194.5,107.5 L268,107.5 L268,182 L268,182 C226.8,181.73 194.5,147.8 194.5,108 C194.5,107.83 194.5,107.67 194.5,107.5 L50,107.5 L50,325.5 L226.5,325.5 C226.76,302.39 244.88,284.26 268,284 L268,284 L268,325.5 L226.5,325.5 C226.5,325.67 226.5,325.83 226.5,326 C226.5,348.68 244.98,368 268.5,368 C291.18,368 310.5,348.68 310.5,326 C310.5,302.48 291.18,284 268.5,284 C268.33,284 268.17,284 268,284 L268,284 L268,182 L268,182 C268.17,182 268.33,182 268.5,182 C308.46,182 342.5,147.96 342.5,108 C342.5,66.56 308.46,34 268.5,34 z",
      artboardPaths.get(0));
  }
  ...
  public void combinationsMultipleArtboardsTest() {
    ...
    List<DrawableModel> firstArtboardShapes = createAllDrawableShapes(artboards.get(0));
    ...
    List<DrawableModel> secondArtboardPaths = createAllDrawableShapes(artboards.get(0));
  ...
  public List<String> getFirstArtboardPaths(SketchPage sketchPage) {
    ...
    if (!artboards.isEmpty()) {
      return createAllDrawableShapes(artboards.get(0))
                      .stream()
