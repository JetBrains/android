...
public class PathsTest {
  ...
  public void rectanglePathTest() {
    ...
    assertEquals("M26,1 L103,1 L103,21 L26,21 z", artboardPaths.get(0));
  }
  ...
  public void shapeUnionTest() {
    ...
    assertEquals(
      "M268.5,34 C227.23,34 194.76,66.3 194.5,107.5 L50,107.5 L50,325.5 L226.5,325.5 C226.5,325.67 226.5,325.83 226.5,326 C226.5,348.68 244.98,368 268.5,368 C291.18,368 310.5,348.68 310.5,326 C310.5,302.48 291.18,284 268.5,284 C268.33,284 268.17,284 268,284 L268,284 L268,182 L268,182 C268.17,182 268.33,182 268.5,182 C308.46,182 342.5,147.96 342.5,108 C342.5,66.56 308.46,34 268.5,34 z",
      artboardPaths.get(0));
  }
  ...
  public void shapeSubtractionTest() {
    ...
    assertEquals(
      "M50,107.5 L50,325.5 L226.5,325.5 C226.76,302.39 244.88,284.26 268,284 L268,284 L268,182 L268,182 C226.8,181.73 194.5,147.8 194.5,108 C194.5,107.83 194.5,107.67 194.5,107.5 z",
  ...
  public void shapeDifferenceTest() {
    ...
    assertEquals(
      "M268.5,34 C227.23,34 194.76,66.3 194.5,107.5 L268,107.5 L268,182 L268,182 C226.8,181.73 194.5,147.8 194.5,108 C194.5,107.83 194.5,107.67 194.5,107.5 L50,107.5 L50,325.5 L226.5,325.5 C226.76,302.39 244.88,284.26 268,284 L268,284 L268,182 L268,182 C268.17,182 268.33,182 268.5,182 C308.46,182 342.5,147.96 342.5,108 C342.5,66.56 308.46,34 268.5,34 zM268.5,284 C268.33,284 268.17,284 268,284 L268,284 L268,325.5 L226.5,325.5 C226.5,325.67 226.5,325.83 226.5,326 C226.5,348.68 244.98,368 268.5,368 C291.18,368 310.5,348.68 310.5,326 C310.5,302.48 291.18,284 268.5,284 z",
      artboardPaths.get(0));
  }
  ...
  public void shapeIntersectTest() {
    ...
    assertEquals(
      "M194.5,107.5 L194.5,107.5 C194.5,107.67 194.5,107.83 194.5,108 C194.5,147.8 226.8,181.73 268,182 L268,182 L268,107.5 z",
      artboardPaths.get(0));
  }
  ...
  public void combinationsSingleArtboardTest() {
    ...
    assertEquals(
      "M71,180 C94.2,180 113,198.8 113,222 C113,245.2 94.2,264 71,264 C47.8,264 29,245.2 29,222 C29,198.8 47.8,180 71,180 zM292,225 C290.54,225 289.09,225.07 287.67,225.22 L287.67,225.22 C296.68,237.48 302,252.62 302,269 C302,283.72 297.7,297.44 290.29,308.97 L290.29,308.97 C290.86,308.99 291.43,309 292,309 C315.2,309 334,290.2 334,267 C334,243.8 315.2,225 292,225 zM10,164 L10,382.47 L77,382.47 C77,382.32 77,382.16 77,382 C77,358.8 95.8,340 119,340 C142.2,340 161,358.8 161,382 C161,382.16 161,382.32 161,382.47 L228.47,382.47 L228.47,343 L228.47,343 C254.42,342.84 277.21,329.32 290.29,308.97 L290.29,308.97 C267.89,308.07 250,289.62 250,267 C250,245.27 266.51,227.39 287.67,225.22 L287.67,225.22 C274.28,207.01 252.77,195.15 228.47,195 L228.47,195 L228.47,164 z",
      artboardPaths.get(0)); 
    assertEquals(
