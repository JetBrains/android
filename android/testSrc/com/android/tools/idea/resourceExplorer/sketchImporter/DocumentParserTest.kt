...
class DocumentParserTest {
  ...
  fun checkForeignSymbols() {
    ...
    assertTrue(originalRectangle is SketchShapePath)
    ...
    assertTrue(shapeGroup is SketchShapeGroup)

    val rectangle = (shapeGroup as SketchShapeGroup).layers[0]
    assertTrue(rectangle is SketchShapePath)
