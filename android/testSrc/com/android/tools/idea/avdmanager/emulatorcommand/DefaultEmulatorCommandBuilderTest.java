...
public final class DefaultEmulatorCommandBuilderTest {
  ...
  public void build() {
    // Arrange
    EmulatorCommandBuilder builder = new DefaultEmulatorCommandBuilder(myEmulator, myAvd);
  ...
  public void buildOnWindows() {
    ...
    EmulatorCommandBuilder builder = new DefaultEmulatorCommandBuilder(emulator, myAvd);
