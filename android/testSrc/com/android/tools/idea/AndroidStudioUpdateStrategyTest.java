...
public final class AndroidStudioUpdateStrategyTest extends PlatformTestCase {
  ...
  public void testUpdateStrategyDoesNotPreferSamePlatformVersion() throws Exception {
    ...
    assertThat(new UpdateStrategy(BuildNumber.fromString("AI-182.4505.22.34.5070326"), UpdateData.parseUpdateData(JDOMUtil.load(updatesXml), "AI"), settings)
  ...
  public void testUpdateStrategyIgnoresLowerAndroidStudioVersion() throws Exception {
    ...
    assertThat(new UpdateStrategy(BuildNumber.fromString("AI-191.7479.19.36.5721125"), UpdateData.parseUpdateData(JDOMUtil.load(updatesXml), "AI"), settings)
  ...
  public void testUpdateStrategyPrefersSameAndroidStudioVersion() throws Exception {
    ...
    assertThat(new UpdateStrategy(BuildNumber.fromString("AI-191.7479.19.35.5717577"), UpdateData.parseUpdateData(JDOMUtil.load(updatesXml), "AI"), settings)
      .checkForUpdates().getNewBuild().getNumber().asString())
