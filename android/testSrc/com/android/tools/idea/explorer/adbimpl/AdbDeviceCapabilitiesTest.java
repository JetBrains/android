...
public final class AdbDeviceCapabilitiesTest {
  ...
  public void logcatSupportsEpochFormatModifier() throws Exception {
    ...
    assertTrue(new AdbDeviceCapabilities(myCommands.createMockDevice()).hasLogcatThatSupportsEpochFormatModifier());
  }
  ...
  public void logcatDoesntSupportEpochFormatModifier() throws Exception {
    ...
    assertFalse(new AdbDeviceCapabilities(myCommands.createMockDevice()).hasLogcatThatSupportsEpochFormatModifier());
  }
}
