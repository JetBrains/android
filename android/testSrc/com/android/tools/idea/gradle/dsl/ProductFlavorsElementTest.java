...
/**
 * Tests for {@link ProductFlavorsElement}.
 *
 ...
 * {@link ProductFlavorElement} is tested in great deal to cover all combinations in {@link ProductFlavorElementTest} using the
 * {@code android.defaultConfig {}} block.
 */
public class ProductFlavorsElementTest extends GradleBuildModelParserTestCase {
  public void testProductFlavorsWithApplicationStatements() throws Exception {
    ...
    Collection<ProductFlavorElement> productFlavors = android.productFlavors();
    ...
    for (ProductFlavorElement flavor : productFlavors) {
