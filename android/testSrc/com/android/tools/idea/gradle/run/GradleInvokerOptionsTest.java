...
public class GradleInvokerOptionsTest {
  ...
  public void userGoalsHaveNoInstantRunOptions() throws Exception {
    GradleInvokerOptions options =
      GradleInvokerOptions.create(GradleInvoker.TestCompileType.NONE, null, myTasksProvider, "foo", null);
  ...
  public void unitTestsHaveNoInstantRunOptions() throws Exception {
    ...
    GradleInvokerOptions options =
      GradleInvokerOptions.create(GradleInvoker.TestCompileType.JAVA_TESTS, null, myTasksProvider, null, null);
  ...
  public void cleanBuild() throws Exception {
    ...
    GradleInvokerOptions options =
      GradleInvokerOptions.create(GradleInvoker.TestCompileType.NONE, instantRunOptions, myTasksProvider, null, null);
