...
public class GradleTaskRunnerTest extends AndroidGradleTestCase {
  ...
  public void testExecuteTask() throws InterruptedException {
    ...
    int completed = buildInvoker.complete(new GradleInvocationResult(new File(""), Collections.emptyList(), null));
    ...
    completed = buildInvoker.complete(new GradleInvocationResult(new File(""), Collections.emptyList(), null));
