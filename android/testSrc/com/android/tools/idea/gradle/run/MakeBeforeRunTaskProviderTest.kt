...
class MakeBeforeRunTaskProviderTest : PlatformTestCase() {
  ...
  fun testDeviceArgumentsForBundleConfigurationWithEnabledDynamicFeatures() {
    ...
    setUpTestProject(
      ":" to createAndroidProjectBuilder(dynamicFeatures = { listOf(":feature1", ":feature2") }),
      ":feature1" to createAndroidProjectBuilder(projectType = { AndroidProjectTypes.PROJECT_TYPE_DYNAMIC_FEATURE }),
      ":feature2" to createAndroidProjectBuilder(projectType = { AndroidProjectTypes.PROJECT_TYPE_DYNAMIC_FEATURE })
    )
