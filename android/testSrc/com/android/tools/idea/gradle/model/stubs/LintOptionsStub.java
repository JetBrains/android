...
public class LintOptionsStub extends BaseStub implements LintOptions {
    @NonNull private final Set<String> myDisable;
    @NonNull private final Set<String> myEnable;
    ...
    public LintOptionsStub() {
        this(
                Sets.newHashSet("disable"),
                Sets.newHashSet("enable"),
                Sets.newHashSet("check"),
                new File("lintConfig"),
                new File("textOutput"),
                new File("htmlOutput"),
                new File("xmlOutput"),
