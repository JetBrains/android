...
public class ProductFlavorStub extends BaseConfigStub implements ProductFlavor {
    ...
    @NonNull private final VectorDrawablesOptions myVectorDrawables;
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(getName(), that.getName())
                ...
                && Objects.equals(
                        ...
                        that.getTestInstrumentationRunnerArguments())
    ...
    public String toString() {
        return "ProductFlavorStub{"
                ...
                + ", myMaxSdkVersion="
                + myMaxSdkVersion
                + ", myRenderscriptTargetApi="
                + myRenderscriptTargetApi
                + ", myRenderscriptSupportModeEnabled="
                + myRenderscriptSupportModeEnabled
                + ", myRenderscriptSupportModeBlasEnabled="
                + myRenderscriptSupportModeBlasEnabled
                + ", myRenderscriptNdkModeEnabled="
                + myRenderscriptNdkModeEnabled
                + ", myTestApplicationId='"
                + myTestApplicationId
                + '\''
