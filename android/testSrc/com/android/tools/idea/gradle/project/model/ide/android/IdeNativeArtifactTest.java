...
public class IdeNativeArtifactTest {
  ...
  public void constructor() throws Throwable {
    ...
    assertEqualsOrSimilar(original, new IdeNativeArtifact(original, myModelCache));
  }

  @Test
  public void equalsAndHashCode() {
    // @formatter:off
    EqualsVerifier.forClass(IdeNativeArtifact.class).withCachedHashCode("myHashCode", "calculateHashCode", null)
