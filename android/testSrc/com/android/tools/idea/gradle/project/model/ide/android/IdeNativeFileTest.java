...
import com.android.tools.idea.gradle.project.model.ide.android.stubs.NativeFileStub;
...
public class IdeNativeFileTest {
  ...
  public void serialization() throws Exception {
    ...
    byte[] bytes = serialize(nativeFile);
  ...
  public void constructor() throws Throwable {
    ...
    assertEqualsOrSimilar(original, new IdeNativeFile(original, myModelCache));
  }

  @Test
  public void equalsAndHashCode() {
    // @formatter:off
    EqualsVerifier.forClass(IdeNativeFile.class).withCachedHashCode("myHashCode", "calculateHashCode", null)
