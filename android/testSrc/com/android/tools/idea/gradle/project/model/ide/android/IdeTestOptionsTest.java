...
import com.android.tools.idea.gradle.project.model.ide.android.stubs.TestOptionsStub;
...
public class IdeTestOptionsTest {
  ...
  public void serialization() throws Exception {
    IdeTestOptions testOptions = new IdeTestOptions(new TestOptionsStub(), myModelCache);
    byte[] bytes = serialize(testOptions);
  ...
  public void constructor() throws Throwable {
    ...
    IdeTestOptions copy = new IdeTestOptions(original, myModelCache);
