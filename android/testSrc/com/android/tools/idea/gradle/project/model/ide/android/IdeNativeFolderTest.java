...
import com.android.tools.idea.gradle.project.model.ide.android.stubs.NativeFolderStub;
...
public class IdeNativeFolderTest {
  ...
  public void serialization() throws Exception {
    ...
    byte[] bytes = serialize(nativeFolder);
  ...
  public void constructor() throws Throwable {
    ...
    assertEqualsOrSimilar(original, new IdeNativeFolder(original, myModelCache));
  }

  @Test
  public void equalsAndHashCode() {
    // @formatter:off
    EqualsVerifier.forClass(IdeNativeFolder.class).withCachedHashCode("myHashCode", "calculateHashCode", null)
