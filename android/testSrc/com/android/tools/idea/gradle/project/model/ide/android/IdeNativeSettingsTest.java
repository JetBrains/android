...
import com.android.tools.idea.gradle.project.model.ide.android.stubs.NativeSettingsStub;
...
public class IdeNativeSettingsTest {
  ...
  public void serialization() throws Exception {
    IdeNativeSettings nativeSettings = new IdeNativeSettings(new NativeSettingsStub(), myModelCache);
    byte[] bytes = serialize(nativeSettings);
  ...
  public void constructor() throws Throwable {
    ...
    assertEqualsOrSimilar(original, new IdeNativeSettings(original, myModelCache));
  }

  @Test
  public void equalsAndHashCode() {
    // @formatter:off
    EqualsVerifier.forClass(IdeNativeSettings.class).withCachedHashCode("myHashCode", "calculateHashCode", null)
