...
class AndroidTestResultsXmlFormatterTest {
  ...
  fun formatSingleDeviceTest() {
    ...
    val xml = format(rootResultsNode, listOf(device), runConfig)
  ...
  fun formatMultiDeviceTest() {
    ...
    val xml = format(rootResultsNode, listOf(device1, device2), runConfig)
  ...
  private fun format(rootResultsNode: AndroidTestResultsTreeNode,
    ...
    AndroidTestResultsXmlFormatter(
      rootResultsNode, devices, runConfiguration, resultHandler,
