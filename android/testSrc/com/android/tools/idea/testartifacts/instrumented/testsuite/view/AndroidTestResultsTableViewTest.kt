...
class AndroidTestResultsTableViewTest {
  ...
  @Mock lateinit var mockAndroidModuleSystem: AndroidModuleSystem
  ...
  @Test
  fun initialTable() {
    val table = AndroidTestResultsTableView(mockListener, mockJavaPsiFacade, mockAndroidModuleSystem, mockLogger, mockAndroidTestResultsUserPreferencesManager)
  ...
  fun tableShouldUpdateColumnsWidthsAfterResize() {
    ...
    val table = AndroidTestResultsTableView(mockListener, mockJavaPsiFacade, mockAndroidModuleSystem, mockLogger, androidTestResultsUserPreferencesManager)
    val device1 = device("deviceId1", "deviceName1")
    table.addDevice(device1)
  ...
  fun tableShouldImplementDataProviderAndProvideJavaPsiElementForSelectedRow() {
    ...
    `when`(mockAndroidModuleSystem.getTestArtifactSearchScopes()).thenReturn(mockTestArtifactSearchScopes)
