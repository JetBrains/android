 ...
 */
public class TestIdiomRecognition extends AndroidGradleTestCase {
  ...
  public void setUp() throws Exception {
    ...
    loadProject("projects/navigationEditor/transitionDerivation");
  ...
  private void assertTransitionDerivationCounts(String deviceQualifier, int expectedStateCount, int expectedTransitionCount) {
  ...
  public void testTransitionDerivationForDefaultDevice() throws Exception {
    assertTransitionDerivationCounts("raw", 5, 4);
  }
}
