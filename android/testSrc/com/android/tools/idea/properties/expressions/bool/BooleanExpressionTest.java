...
import static com.android.tools.idea.properties.expressions.bool.BooleanExpressions.any;
import static com.android.tools.idea.properties.expressions.bool.BooleanExpressions.not;
...
public final class BooleanExpressionTest {
  ...
  public void testInvariants() throws Exception {
    assertThat(BooleanExpressions.TRUE.get()).isTrue();
    assertThat(BooleanExpressions.FALSE.get()).isFalse();
  }
  ...
  public void testNotExpression() throws Exception {
    ...
    bindings.bind(destValue, not(srcValue));
  ...
  public void testAnyExpression() throws Exception {
    ...
    bindings.bind(destValue, any(srcValue1, srcValue2, srcValue3));
