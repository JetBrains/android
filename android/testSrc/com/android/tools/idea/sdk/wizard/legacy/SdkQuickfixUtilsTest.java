...
public class SdkQuickfixUtilsTest extends AndroidGradleTestCase {
  ...
  public void testCreateDialogForPathsNoOpMessageNull() {
    ...
    dialog = SdkQuickfixUtils.createDialogForPaths(getProject(), Collections.emptyList(), null);
  ...
  public void testCreateDialogForPathsNoOpMessage() {
    ...
    try {
      ModelWizardDialog dialog = SdkQuickfixUtils.createDialogForPaths(getProject(), Collections.emptyList(), errorMessage);
    }
