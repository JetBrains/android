...
public class AndroidModularizeHandlerKotlinTest extends AndroidTestCase {
  ...
  protected void setUp() throws Exception {
    ...
    KtClass ktTargetClass = (KtClass) ((KtLightClass) myFixture.getJavaFacade().findClass("google.MainActivity")).getKotlinOrigin();

    myProcessor = new AndroidModularizeHandler()
      .createProcessor(getProject(), new PsiElement[] { ktTargetClass });
  }
  ...
  public void testPullUpDependency() {
    ...
    assertTrue("Util class is referenced from Other",
               graph.getReferencedOutsideScope().contains(((KtLightClass) myFixture.getJavaFacade().findClass("google.Util")).getKotlinOrigin()));
