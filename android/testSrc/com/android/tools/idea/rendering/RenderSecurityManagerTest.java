...
public class RenderSecurityManagerTest extends TestCase {
    ...
    public void testThread() throws Exception {
        ...
        Thread otherThread = new Thread("other") {
            ...
            public void run() {
                try {
                    TestCase.assertNull(RenderSecurityManager.getCurrent());
                    System.getProperties();
                    ...
                    Thread thread4 = new Thread() {
                        ...
                        public void run() {
                            try {
                                ...
                                try {
                                    System.getProperties();
                                    TestCase.fail("Should have thrown security exception");
                                } catch (SecurityException e) {
                                    // pass
                                }
                                ...
                                barrier5.await();
                                TestCase.assertNull(RenderSecurityManager.getCurrent());
                                TestCase.assertNull(System.getSecurityManager());
                                barrier6.await();
            ...
            public void run() {
                try {
                    ...
                    try {
                        ...
                        TestCase.fail("Should not have been affected by security manager");
                    }
        ...
        Thread thread = new Thread() {
            ...
            public void run() {
                try {
                    ...
                    TestCase.assertNull(RenderSecurityManager.getCurrent());
                    TestCase.assertNotNull(System.getSecurityManager());
                    TestCase.assertEquals("MyTestSecurityManager", System.getSecurityManager().toString());
                } catch (InterruptedException e) {
                    TestCase.fail(e.toString());
                } catch (BrokenBarrierException e) {
                    TestCase.fail(e.toString());
            ...
            Thread thread = new Thread() {
                ...
                public void run() {
                    try {
                        ...
                        TestCase.assertNull(ImageIO.getCacheDirectory());
                    } catch (Throwable t) {
                        t.printStackTrace();
