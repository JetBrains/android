...
import static com.android.tools.idea.rendering.parsers.XmlTagMockBuilder.newBuilder;
...
public class TagSnapshotTest extends TestCase {
  ...
  public void testAaptAttr() {
    ...
    assertEquals("TagSnapshot{ImageView, attributes=[AttributeSnapshot{layout_width=\"wrap_content\"}, AttributeSnapshot{layout_height=\"wrap_content\"}, AttributeSnapshot{src=\"@aapt:_aapt/aapt" + expectedId + "\"}], children=\n" +
                 "[]\n" +
                 "}",
                 root.toString());
  }
