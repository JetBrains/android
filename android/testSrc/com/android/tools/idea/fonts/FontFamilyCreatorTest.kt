...
class FontFamilyCreatorTest {
  @get:Rule val annotationRule = AnnotationRule()
  ...
  fun testCreateFontUsingAppCompat() {
    ...
    assertThat(getFontFileContent("roboto.xml"))
      .isEqualTo(
        String.format(
    ...
    assertThat(Manifest.getMainManifest(facet)!!.getXmlTag()!!.getText())
      .isEqualTo(
  ...
  fun testCreateFontUsingFrameworkFonts() {
    ...
    assertThat(getFontFileContent("alegreya_sans_sc.xml"))
      .isEqualTo(
        String.format(
          "<?xml version=\"1.0\" encoding=\"utf-8\"?>%n" +
  ...
  fun testCreateMultipleFiles() {
    ...
    assertThat(getFontFileContent("aladin.xml"))
      .isEqualTo(
        String.format(
          "<?xml version=\"1.0\" encoding=\"utf-8\"?>%n" +
            "<font-family xmlns:android=\"http://schemas.android.com/apk/res/android\"%n" +
  ...
  private fun addFontFileToFontCache(fontFolder: String, versionFolder: String, fontFileName: String) {
    ...
    FileOutputStream(file).use { outputStream -> FileUtil.copy(inputStream, outputStream) }
  }
