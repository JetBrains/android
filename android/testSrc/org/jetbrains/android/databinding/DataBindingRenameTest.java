...
public class DataBindingRenameTest extends AndroidGradleTestCase {
  ...
  public void testRenameFieldDerivedFromResource() throws Exception {
    assertRenameFieldDerivedFromResource(false);
  }

  public void testRenameFieldDerivedFromResourceAndroidX() throws Exception {
    assertRenameFieldDerivedFromResource(true);
  }
   ...
   */
  private void assertRenameFieldDerivedFromResource(boolean useAndroidX) throws Exception {
    if (useAndroidX) {
    ...
    assertEquals(ModuleDataBinding.getInstance(myAndroidFacet).getDataBindingMode(),
                 useAndroidX ? DataBindingMode.ANDROIDX : DataBindingMode.SUPPORT);
