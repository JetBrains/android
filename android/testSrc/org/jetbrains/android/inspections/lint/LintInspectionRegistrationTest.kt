  ...
  companion object {
    ...
    private fun insertMissingMessages(sb: StringBuilder,
      ...
      val suffix = if (androidSpecific)
        "tools/adt/idea/android/resources/messages/AndroidBundle.properties"
      else
    ...
    private fun writeMissingInspectionClasses(sb: StringBuilder,
                                              ...
                                              androidSpecific: Boolean) {
      val suffix = if (androidSpecific)
        "tools/adt/idea/android/src/com/android/tools/idea/lint"
      else
 ...
 * limitations under the License.
 */
package com.android.tools.idea.lint${if (androidSpecific) "" else ".common"}
${if (androidSpecific)
          """
import com.android.tools.idea.lint.common.AndroidLintInspectionBase
...
""".trim()
    ...
    private fun insertMissingRegistrations(missing: List<Issue>,
                                           ...
                                           androidSpecific: Boolean) {
      val suffix = if (androidSpecific)
        "tools/adt/idea/android/src/com/android/tools/idea/lint/android-lint.xml"
      else
      ...
      for (issue in missing) {
        ...
        val bundle = if (androidSpecific) "AndroidBundle" else "LintBundle"
    ...
    private fun findInspectionClass(issue: Issue): Class<*>? {
      val className = "com.android.tools.idea.lint.${if (issue.isAndroidSpecific()) "" else "common."}$LINT_INSPECTION_PREFIX${issue.id}Inspection"
      try {
