...
public final class GradleSyncUtil {
  private GradleSyncUtil() {
  }

  @NotNull
  public static MessageDialogFixture findGradleSyncMessageDialog(@NotNull Robot robot) {
    return findByTitle(robot, "Gradle Sync");
  }
}
