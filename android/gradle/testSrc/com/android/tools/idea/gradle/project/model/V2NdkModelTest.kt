...
class V2NdkModelTest {
      ...
      override val variants: List<NativeVariant> =
        listOf(
          object : NativeVariant {
            ...
            override val abis: List<NativeAbi> =
              listOf(
                object : NativeAbi {
                  ...
                  override val additionalProjectFilesIndexFile: File =
                    tempDir.resolve("some-build-dir/debug/x86/additional_project_files.txt")
                },
                object : NativeAbi {
                  ...
                  override val additionalProjectFilesIndexFile: File =
                    tempDir.resolve("some-build-dir/debug/arm64-v8a/additional_project_files.txt")
                },
              )
          },
          object : NativeVariant {
            ...
            override val abis: List<NativeAbi> =
              listOf(
                object : NativeAbi {
                  ...
                  override val additionalProjectFilesIndexFile: File =
                    tempDir.resolve("some-build-dir/release/x86/additional_project_files.txt")
                },
                object : NativeAbi {
                  override val name: String = "arm64-v8a"
                  ...
                  override val additionalProjectFilesIndexFile: File =
                    tempDir.resolve("some-build-dir/release/arm64-v8a/additional_project_files.txt")
                },
              )
          },
        )
  ...
  fun `test accessors with no build information files`() {
    ...
    Truth.assertThat(v2NdkModel.allVariantAbis)
      .containsExactly(
    ...
    Truth.assertThat(v2NdkModel.symbolFolders)
      .containsExactly(
        VariantAbi("debug", "arm64-v8a"),
        emptySet<File>(),
        VariantAbi("debug", "x86"),
  ...
  fun `test accessors with build information files`() {
    ...
    tempDir
      .resolve("some-build-dir/debug/x86/symbol_folder_index.txt")
      .mkdirAndWriteText(
        """
    ...
    tempDir
      .resolve("some-build-dir/debug/x86/build_file_index.txt")
      .mkdirAndWriteText(
        """
        /path/to/build_file1
        /path/to/build_file2
    ...
    Truth.assertThat(v2NdkModel.symbolFolders)
      .containsExactly(
        ...
        emptySet<File>(),
        VariantAbi("debug", "x86"),
        setOf(File("/path/to/symbol_folder1"), File("/path/to/symbol_folder2")),
        VariantAbi("release", "arm64-v8a"),
        emptySet<File>(),
        VariantAbi("release", "x86"),
        emptySet<File>(),
