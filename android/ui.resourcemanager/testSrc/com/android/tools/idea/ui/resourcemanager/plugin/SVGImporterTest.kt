...
class SVGImporterTest {
  ...
  fun processFiles() {
    ...
    val file1 = File.createTempFile("test1", "svg").also { it.outputStream().write(svg1.toByteArray()) }
    val file2 = File.createTempFile("test2", "svg").also { it.outputStream().write(svg2.toByteArray()) }
