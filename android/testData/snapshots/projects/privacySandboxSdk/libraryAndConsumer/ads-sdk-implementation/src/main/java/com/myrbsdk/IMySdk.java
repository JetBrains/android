...
public interface IMySdk extends android.os.IInterface {
    ...
    public static class Default implements IMySdk {
        @Override
        public void doMath(int x, int y, IIntTransactionCallback transactionCallback)
    ...
    public abstract static class Stub extends android.os.Binder implements IMySdk {
        /** Construct the stub at attach it to the interface. */
        public Stub() {
            this.attachInterface(this, DESCRIPTOR);
        }
        /**
         * Cast an IBinder object into a com.myrbsdk.IMySdk interface, generating a proxy if needed.
         */
