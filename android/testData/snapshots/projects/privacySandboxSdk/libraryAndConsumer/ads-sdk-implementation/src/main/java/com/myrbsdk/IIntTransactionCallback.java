...
public interface IIntTransactionCallback extends android.os.IInterface {
    ...
    public static class Default implements IIntTransactionCallback {
        @Override
        public void onCancellable(ICancellationSignal cancellationSignal)
    ...
    public abstract static class Stub extends android.os.Binder implements IIntTransactionCallback {
        /** Construct the stub at attach it to the interface. */
        public Stub() {
            this.attachInterface(this, DESCRIPTOR);
        }
        /**
         * Cast an IBinder object into a com.myrbsdk.IIntTransactionCallback interface, generating a
         * proxy if needed.
         */
        ...
        private static class Proxy implements IIntTransactionCallback {
            ...
            public void onCancellable(ICancellationSignal cancellationSignal)
                ...
                try {
                    ...
                    boolean _status =
                            mRemote.transact(
                                    Stub.TRANSACTION_onCancellable,
                                    _data,
                                    null,
        ...
        static final int TRANSACTION_onCancellable =
