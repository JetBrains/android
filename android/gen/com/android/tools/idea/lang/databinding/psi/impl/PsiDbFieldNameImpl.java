...
public class PsiDbFieldNameImpl extends DataBindingPsiElement implements PsiDbFieldName {

  public PsiDbFieldNameImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof PsiDbVisitor) ((PsiDbVisitor)visitor).visitFieldName(this);
