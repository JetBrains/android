...
public class RoomColumnConstraintImpl extends ASTWrapperPsiElement implements RoomColumnConstraint {

  public RoomColumnConstraintImpl(ASTNode node) {
    super(node);
  }
  ...
  @Override
  @Nullable
  public RoomCollationName getCollationName() {
    return findChildByClass(RoomCollationName.class);
  }

  @Override
  @Nullable
  public RoomConflictClause getConflictClause() {
    return findChildByClass(RoomConflictClause.class);
  }
  ...
  @Override
  @Nullable
  public RoomSignedNumber getSignedNumber() {
    return findChildByClass(RoomSignedNumber.class);
  }
