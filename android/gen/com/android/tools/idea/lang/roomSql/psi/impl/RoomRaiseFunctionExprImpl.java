...
public class RoomRaiseFunctionExprImpl extends RoomExprImpl implements RoomRaiseFunctionExpr {

  public RoomRaiseFunctionExprImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull RoomVisitor visitor) {
    visitor.visitRaiseFunctionExpr(this);
  }
