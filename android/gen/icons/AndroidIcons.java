...
public class AndroidIcons {
  ...
  public static final Icon PushFileToDevice = load("/icons/fd.png"); // 16x16 // Based on AllIcons.Nodes.Deploy
  ...
  public static final Icon RenderMonitor = load("/icons/render_monitor.png"); // 16x16
