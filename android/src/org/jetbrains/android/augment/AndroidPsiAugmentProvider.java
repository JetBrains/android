...
public class AndroidPsiAugmentProvider extends PsiAugmentProvider {
  ...
  public <Psi extends PsiElement> List<Psi> getAugments(@NotNull PsiElement element, @NotNull Class<Psi> type) {
      ...
      if (AndroidUtils.R_CLASS_NAME.equals(className) &&
        ...
        for (ResourceType resType : types) {
          ...
          if (!existingInnerClasses.contains(resType.getName())) {
            final AndroidLightInnerClassBase resClass = new ResourceTypeClass(facet, resType.getName(), aClass);
    ...
    else if (type == PsiField.class && !(aClass instanceof AndroidLightInnerClassBase)) {
