...
public class InterpolatorDomFileDescription extends AbstractMultiRootFileDescription<InterpolatorElement> {
   ...
   * If key maps to {@link Optional#absent()} it means that such tag exists but doesn't have any attributes.
   */
  public static final ImmutableMap<String, Optional<String>> STYLEABLE_BY_TAG =
    ImmutableMap.<String, Optional<String>>builder()
      .put("linearInterpolator", Optional.<String>absent())
      ...
      .put("accelerateDecelerateInterpolator", Optional.<String>absent())
      ...
      .put("bounceInterpolator", Optional.<String>absent())
