...
public class AndroidDomElementDescriptorProvider implements XmlElementDescriptorProvider {
  ...
  private static Map<String, Icon> getInitialViewTagName2IconMap() {
    ...
    map.put("ImageFilterView", StudioIcons.LayoutEditor.Palette.VIEW);
    map.put("ImageFilterButton", StudioIcons.LayoutEditor.Palette.VIEW);
    map.put("MockView", StudioIcons.LayoutEditor.Palette.VIEW);
    return map;
  }
}
