...
import static com.android.SdkConstants.PREFIX_BINDING_EXPRN;
...
public class ResourceValue {
  ...
  public static ResourceValue parse(@Nullable String s, boolean withLiterals, boolean withPrefix, boolean requireValid) {
    ...
    if ((s.startsWith(PREFIX_RESOURCE_REF) || s.startsWith(PREFIX_THEME_REF)) && !s.startsWith(PREFIX_BINDING_EXPRN)) {
