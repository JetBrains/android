...
public class ProviderPresentationProvider extends PresentationProvider<Provider> {
  @Nullable
  @Override
  public String getName(Provider provider) {
    final PsiClass aClass = provider.getProviderClass().getValue();
    return aClass == null ? null : aClass.getName();
  }

  @Nullable
  @Override
  public String getTypeName(Provider provider) {
    return "Provider";
  }
}
