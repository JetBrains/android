...
private fun lastModifiedTimeFromDisk(vFile: VirtualFile): Long =
  try {
...
class ClassModificationTimestamp(
  private val vFileTimestamp: Long,
  ...
  fun isUpToDate(vFile: VirtualFile): Boolean {
    ...
    if (
      !vFile.isValid ||
        ...
        diskTimeStampProvider(vFile) != fileTimestamp
    )
      return false
    return true
  }
