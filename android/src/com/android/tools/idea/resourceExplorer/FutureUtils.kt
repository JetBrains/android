 ...
 */
fun <I, O> ListenableFuture<I>.transform(executor: Executor = MoreExecutors.directExecutor(), func: (I?) -> O): ListenableFuture<O> {
  return transform(this, Function<I, O> { i -> func(i) }, executor)
}