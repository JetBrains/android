...
/**
 * For a given [packageName] it finds the R class (and other resource type classes) and returns [RClassResources] with information about
 * resource IDs.
 */
...
class RClassResources(private val resources: Map<ResourceType, Map<String, Int>>) {
  ...
  /**
   * Returns all resources of the specified [resourceType]. Map has resource names as keys and IDs are values. Only [Int] constants are in
   * the returned map.
   */
