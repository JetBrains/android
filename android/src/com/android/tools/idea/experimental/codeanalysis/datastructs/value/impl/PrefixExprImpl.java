 ...
 */
public class PrefixExprImpl extends UnaryExprImpl {
  public PrefixExprImpl(PsiElement psiRef,
  ...
  public String getSimpleName() {
    return String.format("%s %s", this.mOperator.toString(), this.mVal.getSimpleName());
  }
}
