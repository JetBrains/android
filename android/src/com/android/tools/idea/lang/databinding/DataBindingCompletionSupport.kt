...
/** Calls the first plugin's [DataBindingCompletionSupport.addCompletions]. No-op if no extension point implementation is found. */
fun addCompletions(params: CompletionParameters, resultSet: CompletionResultSet) {
  val extensionPoint: ExtensionPointName<DataBindingCompletionSupport> =
    ExtensionPointName("com.android.tools.idea.lang.databinding.dataBindingCompletionSupport")
