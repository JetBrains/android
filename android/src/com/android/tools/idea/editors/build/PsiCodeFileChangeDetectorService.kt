...
class PsiCodeFileChangeDetectorService private constructor(psiManager: PsiManager) :
  Disposable, PsiCodeFileOutOfDateStatusReporter, PsiCodeFileUpToDateStatusRecorder {
  ...
  @Suppress("unused") constructor(project: Project) : this(PsiManager.getInstance(project))
