...
public final class FmtFloat16 extends Format implements BinaryObject {
  ...
  public FmtFloat16 setOrder(VectorElement[] v) {
    myOrder = v;
    return this;
  }
  ...
  private static final Entity ENTITY = new Entity("vertex", "FmtFloat16", "", "");
