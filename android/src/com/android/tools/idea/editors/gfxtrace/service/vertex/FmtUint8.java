...
public final class FmtUint8 extends Format implements BinaryObject {
  //<<<Start:Java.ClassBody:1>>>
  private VectorElement[] myOrder;
  private boolean myNormalized;

  // Constructs a default-initialized {@link FmtUint8}.
  public FmtUint8() {}
  ...
  public FmtUint8 setOrder(VectorElement[] v) {
    myOrder = v;
    return this;
  }
  ...
  public FmtUint8 setNormalized(boolean v) {
    myNormalized = v;
    return this;
  }
  ...
  private static final Entity ENTITY = new Entity("vertex", "FmtUint8", "", "");
  ...
  public enum Klass implements BinaryClass {
    ...
    @Override @NotNull
    public BinaryObject create() { return new FmtUint8(); }

    @Override
    public void encode(@NotNull Encoder e, BinaryObject obj) throws IOException {
      FmtUint8 o = (FmtUint8)obj;
