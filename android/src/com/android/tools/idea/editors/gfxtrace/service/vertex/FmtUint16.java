...
public final class FmtUint16 extends Format implements BinaryObject {
  //<<<Start:Java.ClassBody:1>>>
  private VectorElement[] myOrder;
  private boolean myNormalized;

  // Constructs a default-initialized {@link FmtUint16}.
  public FmtUint16() {}
  ...
  public FmtUint16 setOrder(VectorElement[] v) {
    myOrder = v;
    return this;
  }
  ...
  public FmtUint16 setNormalized(boolean v) {
    myNormalized = v;
    return this;
  }
  ...
  private static final Entity ENTITY = new Entity("vertex", "FmtUint16", "", "");
  ...
  public enum Klass implements BinaryClass {
    ...
    @Override @NotNull
    public BinaryObject create() { return new FmtUint16(); }

    @Override
    public void encode(@NotNull Encoder e, BinaryObject obj) throws IOException {
      FmtUint16 o = (FmtUint16)obj;
