...
public final class FmtInt32 extends Format implements BinaryObject {
  //<<<Start:Java.ClassBody:1>>>
  private VectorElement[] myOrder;
  private boolean myNormalized;

  // Constructs a default-initialized {@link FmtInt32}.
  public FmtInt32() {}
  ...
  public FmtInt32 setOrder(VectorElement[] v) {
    myOrder = v;
    return this;
  }
  ...
  public FmtInt32 setNormalized(boolean v) {
    myNormalized = v;
    return this;
  }
  ...
  private static final Entity ENTITY = new Entity("vertex", "FmtInt32", "", "");
  ...
  public enum Klass implements BinaryClass {
    ...
    @Override @NotNull
    public BinaryObject create() { return new FmtInt32(); }

    @Override
    public void encode(@NotNull Encoder e, BinaryObject obj) throws IOException {
      FmtInt32 o = (FmtInt32)obj;
