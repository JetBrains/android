...
public class ParameterInfo implements BinaryObject {
  ...
  // Constructs and decodes a {@link ParameterInfo} from the {@link Decoder} d.
  public ParameterInfo(Decoder d) throws IOException {
    decode(d);
  }
  ...
  public ObjectTypeID type() {
    return ObjectFactory.ParameterInfoID;
  }
}