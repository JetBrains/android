...
public final class Link extends Node implements BinaryObject {
  ...
  // Constructs a default-initialized {@link Link}.
  public Link() {}
  ...
  private static final Entity ENTITY = new Entity("stringtable", "Link", "", "");

  static {
    ENTITY.setFields(new Field[]{
      new Field("Body", new Interface("Node")),
      new Field("Target", new Interface("Node")),
    });
  ...
  public enum Klass implements BinaryClass {
    ...
    @Override @NotNull
    public BinaryObject create() { return new Link(); }

    @Override
    public void encode(@NotNull Encoder e, BinaryObject obj) throws IOException {
      Link o = (Link)obj;
      e.object(o.myBody == null ? null : o.myBody.unwrap());
      e.object(o.myTarget == null ? null : o.myTarget.unwrap());
    }
