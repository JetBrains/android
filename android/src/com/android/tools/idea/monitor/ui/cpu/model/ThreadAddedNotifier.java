...
public interface ThreadAddedNotifier {
  void threadAdded(ThreadStatesDataModel threadStatesDataModel);

  default void threadsAdded(ThreadStatesDataModel[] threadStatesDataModelList) {
    for(ThreadStatesDataModel model : threadStatesDataModelList) {
      threadAdded(model);
    }
  }
}
