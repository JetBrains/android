...
public interface NetworkCaptureModel {
  /**
   * This method will be invoked in each animation cycle of {@link NetworkCaptureSegment}.
   * @param timeCurrentRangeUs, the current visible range in {NetworkCaptureSegment}
