...
class ExperimentalUISettings : PersistentStateComponent<ExperimentalUISettings> {
  ...
  override fun loadState(state: ExperimentalUISettings) {
    XmlSerializerUtil.copyBean(state, this)
  }

  companion object {
    @JvmStatic
    fun getInstance(): ExperimentalUISettings {
      return ApplicationManager.getApplication().getService(ExperimentalUISettings::class.java)
    }
  }
}
