...
import com.google.wireless.android.sdk.stats.TypingLatencyStats.FileType.GROOVY
import com.google.wireless.android.sdk.stats.TypingLatencyStats.FileType.JAVA
import com.google.wireless.android.sdk.stats.TypingLatencyStats.FileType.JSON
import com.google.wireless.android.sdk.stats.TypingLatencyStats.FileType.KOTLIN
import com.google.wireless.android.sdk.stats.TypingLatencyStats.FileType.KOTLIN_SCRIPT
import com.google.wireless.android.sdk.stats.TypingLatencyStats.FileType.NATIVE
import com.google.wireless.android.sdk.stats.TypingLatencyStats.FileType.PROPERTIES
import com.google.wireless.android.sdk.stats.TypingLatencyStats.FileType.UNKNOWN
import com.google.wireless.android.sdk.stats.TypingLatencyStats.FileType.XML
...
object TypingLatencyTracker : LatencyListener {
   ...
   */
  private val latencyRecorders = ConcurrentHashMap<TypingLatencyStats.FileType, SingleWriterRecorder>()
  ...
  private fun convertFileType(file: VirtualFile): TypingLatencyStats.FileType = when (file.fileType.name) {
