...
interface AvdLaunchListener {
   ...
   */
  fun avdLaunched(avd: AvdInfo, commandLine: GeneralCommandLine, project: Project?)

  companion object {
    @JvmField
    val TOPIC = Topic("AVD launch events", AvdLaunchListener::class.java)
  }
}