...
public class ShadowPainter {
  ...
  // Normal Drop Shadow
  private static final Image ShadowBottom = load("/icons/shadow-b.png");
  private static final Image ShadowBottomLeft = load("/icons/shadow-bl.png");
  private static final Image ShadowBottomRight = load("/icons/shadow-br.png");
  private static final Image ShadowRight = load("/icons/shadow-r.png");
  private static final Image ShadowTopRight = load("/icons/shadow-tr.png");

  // Small Drop Shadow
  private static final Image Shadow2Bottom = load("/icons/shadow2-b.png");
  private static final Image Shadow2BottomLeft = load("/icons/shadow2-bl.png");
  private static final Image Shadow2BottomRight = load("/icons/shadow2-br.png");
  private static final Image Shadow2Right = load("/icons/shadow2-r.png");
  private static final Image Shadow2TopRight = load("/icons/shadow2-tr.png");
}
