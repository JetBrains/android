...
public class RenderErrorModelFactory {
  ...
  @SuppressWarnings("unused") private static final int MEDIUM_PRIORITY = 10;
  @SuppressWarnings("unused") private static final int LOW_PRIORITY = 10;
  ...
  private RenderErrorModelFactory(@NotNull RenderResult result, @Nullable DataContext dataContext) {
    myResult = result;
  ...
  public static RenderErrorModel createErrorModel(@NotNull RenderResult result, @Nullable DataContext dataContext) {
    RenderErrorModelFactory factory = new RenderErrorModelFactory(result, dataContext);
    return factory.getRenderErrorModel();
  }
  ...
  private void reportBrokenClasses(@NotNull RenderLogger logger) {
    ...
    if (module != null) {
      AndroidFacet facet = AndroidFacet.getInstance(module);
      AndroidGradleModel model = facet != null && facet.requiresAndroidModel() ?
                                 AndroidGradleModel.get(facet) :
                                 null;
      if (model != null) {
        // TODO: b/23032391
  ...
  private RenderErrorModel getRenderErrorModel() {
    ...
    return new RenderErrorModel(myIssues);
  }
