...
public record PlatformSkin(@NotNull Path path, @NotNull AndroidVersion version) implements Skin {
  /**
  ...
  public String toString() {
    return path.getFileName() + " (" + AndroidVersionUtils.getFullApiName(version) + ')';
  }
}
