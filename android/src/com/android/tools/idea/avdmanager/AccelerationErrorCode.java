...
public enum AccelerationErrorCode {
  ...
  ACCELERATION_NOT_INSTALLED_WIN_AMD(6, "Android Emulator hypervisor driver is not installed.", INSTALL_AEHD, "Install Android Emulator hypervisor driver for better emulation performance."),
  ...
  DEV_PERMISSION_WIN_AMD(11, "Android Emulator hypervisor driver device: permission denied.", REINSTALL_AEHD, "Reinstall Android Emulator hypervisor driver."),
  ...
  DEV_OPEN_FAILED_WIN_AMD(12, "Android Emulator hypervisor driver device: open failed.", REINSTALL_AEHD, "Reinstall Android Emulator hypervisor driver."),
  ...
  DEV_IOCTL_FAILED_WIN_AMD(13, "Android Emulator hypervisor driver device: ioctl denied.", REINSTALL_AEHD, "Reinstall Android Emulator hypervisor driver."),
  ...
  DEV_OBSOLETE_WIN_AMD(14, "Virtual machine acceleration driver out-of-date.", REINSTALL_AEHD, "Reinstall Android Emulator hypervisor driver."),
  HYPER_V_ENABLED(15, "Android Emulator is incompatible with Hyper-V.", TURNOFF_HYPER_V, SOLUTION_TURN_OFF_HYPER_V),
  EMULATOR_ERROR(138, "Accelerator Detection Problem.", NONE, "Please file a bug against JetBrains Rider."),
  UNKNOWN_ERROR(-1, "Unknown Error", NONE, "Please file a bug against JetBrains Rider."),
  ...
  HAXM_REQUIRES_WINDOWS(-5, "HAXM can only be installed on Windows.", NONE, "Please file a bug against JetBrains Rider."),
  ...
  HAXM_REQUIRES_INTEL_CPU(-8, "HAXM requires an Intel CPU.", NONE, "Please file a bug against Android Studio."),
