...
object LayoutBindingTypeUtil {
   ...
   *
   * It the name is already a fully qualified path, it will be returned directly. Otherwise, it will be assumed to be a view class, e.g.
   * "ImageView" returns "android.widget.ImageView"
   */
  @JvmStatic
  ...
  private fun getViewClassNameFromLayoutAttribute(layoutName: String?, facet: AndroidFacet): String? {
    ...
    val resourceFacet = indexEntry.file.getModule(facet.module.project)?.let { AndroidFacet.getInstance(it) } ?: return null
