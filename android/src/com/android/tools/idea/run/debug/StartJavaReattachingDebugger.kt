...
fun startJavaReattachingDebugger(
  ...
  applicationIds: Collection<String>,
...
private fun startReattachingDebugger(
  ...
  val reattachingListener = ReattachingDebuggerListener(masterProcessHandler, applicationIds, ::startSessionFinal)
  ...
  startSessionFinal(client, onDebugProcessStarted).processed(promise)
...
private class ReattachingDebuggerListener(
  ...
  private val applicationIds: Collection<String>,
  ...
  private fun handleError(e: Throwable) {
    ...
    if (e is ExecutionException) {
      showError(masterProcessHandler.project, e, "Debugging ${masterProcessHandler.targetApplicationId}")
    }
    else {
      LOG.error(e)
    }
