...
internal class R8MemoryProgramResourceProvider(private val classes: List<LiveEditCompiledClass>, private val logger: LiveEditLogger) :
  ProgramResourceProvider {
  override fun getProgramResources(): MutableCollection<ProgramResource> {
    return classes.stream().map { ProgramResource.fromBytes(Origin.root(), ProgramResource.Kind.CF, it.data, mutableSetOf()) }.toList()
  }
}
