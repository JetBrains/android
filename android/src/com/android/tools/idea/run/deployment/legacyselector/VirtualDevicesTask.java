...
import static com.android.tools.idea.run.deployment.legacyselector.Tasks.getTypeFromAndroidDevice;
...
public final class VirtualDevicesTask implements AsyncSupplier<Collection<VirtualDevice>> {
  ...
  public static final class Builder {
    ...
    @NotNull
    public Builder setExecutorService(@NotNull ExecutorService executorService) {
      myExecutorService = executorService;
      return this;
    }

    @NotNull
    public Builder setGetAvds(@NotNull Supplier<Collection<AvdInfo>> getAvds) {
      myGetAvds = getAvds;
      return this;
    }

    @NotNull
    public Builder setNewLaunchableAndroidDevice(@NotNull Function<AvdInfo, AndroidDevice> newLaunchableAndroidDevice) {
      myNewLaunchableAndroidDevice = newLaunchableAndroidDevice;
      return this;
    }

    @NotNull
    public Builder setCheckerSupplier(@NotNull Supplier<LaunchCompatibilityChecker> checkerSupplier) {
