...
final class WorkerAsyncDevicesGetter implements AsyncDevicesGetter {
  @NotNull
  ...
  private WorkerAsyncDevicesGetter(@NotNull Project project) {
    this(project, new KeyToConnectionTimeMap());
  }

  @VisibleForTesting
  WorkerAsyncDevicesGetter(@NotNull Project project, @NotNull KeyToConnectionTimeMap map) {
    myProject = project;
    myMap = map;
