            ...
            if (SdkRepoConstants.NODE_LICENSE.equals(name)) {
                ...
                try {
                    ...
                    while ((archive = findChild(archives,
                        ...
                        try {
                            com.android.tools.idea.sdk.remote.internal.archives.ArchFilter
                              af = com.android.tools.idea.sdk.remote.internal.packages.PackageParserUtils.parseArchFilter(archive);
                            if (af == null || !af.isCompatibleWith(com.android.tools.idea.sdk.remote.internal.archives.ArchFilter.getCurrent())) {
                                continue;
                            }
