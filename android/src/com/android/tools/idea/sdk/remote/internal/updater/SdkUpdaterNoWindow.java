...
public class SdkUpdaterNoWindow {
    ...
    /** The {@link com.android.tools.idea.sdk.remote.internal.updater.UpdaterData} to use. */
    private final com.android.tools.idea.sdk.remote.internal.updater.UpdaterData mUpdaterData;
    ...
    public SdkUpdaterNoWindow(String osSdkRoot,
        ...
        mSdkLog = sdkLog;
        mForce = force;
        mUpdaterData = new com.android.tools.idea.sdk.remote.internal.updater.UpdaterData(osSdkRoot, sdkLog);
        ...
        mUpdaterData.getLocalSdkParser().parseSdk(
                osSdkRoot,
                sdkManager,
                new com.android.tools.idea.sdk.remote.internal.NullTaskMonitor(sdkLog));
    }
    ...
    public Pair<Boolean, File> installPlatformPackage(String hashString) {
        ...
        if (target == null) {
            ...
            List<com.android.tools.idea.sdk.remote.internal.archives.Archive> installed = mUpdaterData.updateOrInstallAll_NoGUI(
                    filter,
                    true,  //includeAll
                    false, //dryMode
                    null); //acceptLicense
    ...
    /**
     * A custom implementation of {@link com.android.tools.idea.sdk.remote.internal.ITaskFactory} that
     * provides {@link ConsoleTaskMonitor} objects.
     */
    private class ConsoleTaskFactory implements com.android.tools.idea.sdk.remote.internal.ITaskFactory {
        @Override
        public void start(String title, com.android.tools.idea.sdk.remote.internal.ITask task) {
            start(title, null /*parentMonitor*/, task);
        }

        @Override
        public void start(String title, com.android.tools.idea.sdk.remote.internal.ITaskMonitor parentMonitor, com.android.tools.idea.sdk.remote.internal.ITask task) {
            if (parentMonitor == null) {
                ...
                com.android.tools.idea.sdk.remote.internal.ITaskMonitor sub = parentMonitor.createSubMonitor(
    ...
    /**
     * A custom implementation of {@link com.android.tools.idea.sdk.remote.internal.ITaskMonitor} that defers all output to the
     * super {@link SdkUpdaterNoWindow#mSdkLog}.
     */
    private class ConsoleTaskMonitor implements com.android.tools.idea.sdk.remote.internal.ITaskMonitor {
         ...
         */
        public ConsoleTaskMonitor(String title, com.android.tools.idea.sdk.remote.internal.ITask task) {
            mSdkLog.info("%s:\n", title);
        }
         ...
         * @see com.android.tools.idea.sdk.remote.internal.ITaskMonitor#displayLoginCredentialsPrompt(String, String)
         */
        @Override
        public com.android.tools.idea.sdk.remote.internal.UserCredentials displayLoginCredentialsPrompt(String title, String message) {
            ...
            return new com.android.tools.idea.sdk.remote.internal.UserCredentials(login, password, workstation, domain);
        }
    ...
    private interface IConsoleSubTaskMonitor extends com.android.tools.idea.sdk.remote.internal.ITaskMonitor {
