...
public class ToolPackage extends FullRevisionPackage implements IMinPlatformToolsDependency {
    ...
    /** The value returned by {@link com.android.tools.idea.sdk.remote.internal.packages.ToolPackage#installId()}. */
    ...
    public ToolPackage(SdkSource source,
        ...
        mPkgDesc = setDescriptions(PkgDesc.Builder.newTool(getRevision(), mMinPlatformToolsRevision))
                .create();
    }
    ...
    public static Package create(
        ...
        return new com.android.tools.idea.sdk.remote.internal.packages.ToolPackage(source, props, revision, license, description,
    ...
    public boolean sameItemAs(Package pkg, PreviewComparison comparePreview) {
        ...
        if (pkg instanceof com.android.tools.idea.sdk.remote.internal.packages.ToolPackage) {
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof com.android.tools.idea.sdk.remote.internal.packages.ToolPackage)) {
            return false;
        }
        com.android.tools.idea.sdk.remote.internal.packages.ToolPackage other = (com.android.tools.idea.sdk.remote.internal.packages.ToolPackage) obj;
