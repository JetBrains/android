...
public class AddonPackage extends MajorRevisionPackage
  ...
  public static Package createBroken(String archiveOsPath, Properties sourceProps, Map<String, String> addonProps, String error) {
    ...
    IPkgDesc desc = PkgDesc.Builder
      .newAddon(new AndroidVersion(apiLevel, null), new MajorRevision(intRevision), new IdDisplay(vendorId, vendorDisp),
                new IdDisplay(nameId, nameDisp)).setDescriptionShort(shortDesc).create();

    return new BrokenPackage(null/*props*/, shortDesc, longDesc, IMinApiLevelDependency.MIN_API_LEVEL_NOT_SPECIFIED, apiLevel,
                             archiveOsPath, desc);
  }
