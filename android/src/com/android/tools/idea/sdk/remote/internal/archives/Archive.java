...
import com.android.tools.idea.sdk.remote.internal.archives.ChecksumType;
...
/**
 * A {@link com.android.tools.idea.sdk.remote.internal.archives.Archive} is the base class for "something" that can be downloaded from
 * the SDK repository.
 * <p/>
 ...
 */
public class Archive implements IDescription, Comparable<com.android.tools.idea.sdk.remote.internal.archives.Archive> {

    private final String mUrl;
    private final long   mSize;
    private final String mChecksum;
    private final ChecksumType
      mChecksumType = ChecksumType.SHA1;
     ...
     *          {@link com.android.tools.idea.sdk.remote.internal.archives.ChecksumType#SHA1} format is supported.
     */
    ...
    /**
     * Returns the checksum type, always {@link com.android.tools.idea.sdk.remote.internal.archives.ChecksumType#SHA1} right now.
     */
    @NonNull
     ...
     */
    @Override
    public int compareTo(com.android.tools.idea.sdk.remote.internal.archives.Archive rhs) {
    ...
    /**
     * Note: An {@link com.android.tools.idea.sdk.remote.internal.archives.Archive}'s hash code does NOT depend on the parent {@link Package} hash code.
     * <p/>
     * {@inheritDoc}
     */
    @Override
    ...
    /**
     * Note: An {@link com.android.tools.idea.sdk.remote.internal.archives.Archive}'s equality does NOT depend on the parent {@link Package} equality.
     * <p/>
     * {@inheritDoc}
     */
    @Override
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof com.android.tools.idea.sdk.remote.internal.archives.Archive)) {
            return false;
        }
        com.android.tools.idea.sdk.remote.internal.archives.Archive other = (com.android.tools.idea.sdk.remote.internal.archives.Archive) obj;
        if (mArchFilter == null) {
