...
public interface ISettingsPage {
    ...
    public interface SettingsChangedCallback {
         ...
         * applied. The application will call {@link com.android.tools.idea.sdk.remote.internal.updater.ISettingsPage#retrieveSettings(Properties)}
         * and apply the new settings.
         */
        public abstract void onSettingsChanged(com.android.tools.idea.sdk.remote.internal.updater.ISettingsPage page);
    }
}
