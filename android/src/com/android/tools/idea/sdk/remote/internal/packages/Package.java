...
/**
 * A {@link com.android.tools.idea.sdk.remote.internal.packages.Package} is the base class for "something" that can be downloaded from
 * the SDK repository.
 * <p/>
 ...
 */
public abstract class Package implements IDescription, IListDescription, Comparable<com.android.tools.idea.sdk.remote.internal.packages.Package> {
    ...
    /**
     * Enum for the result of {@link com.android.tools.idea.sdk.remote.internal.packages.Package#canBeUpdatedBy(com.android.tools.idea.sdk.remote.internal.packages.Package)}. This used so that we can
     * differentiate between a package that is totally incompatible, and one that is the same item
     * but just not an update.
     * @see #canBeUpdatedBy(com.android.tools.idea.sdk.remote.internal.packages.Package)
     */
    ...
    Package(SdkSource source, Node packageNode, String nsUri, Map<String,String> licenses) {
        mSource = source;
        mListDisplay =
                com.android.tools.idea.sdk.remote.internal.packages.PackageParserUtils
                  .getXmlString(packageNode, SdkRepoConstants.NODE_LIST_DISPLAY);
        mDescription =
            com.android.tools.idea.sdk.remote.internal.packages.PackageParserUtils.getXmlString(packageNode, SdkRepoConstants.NODE_DESCRIPTION);
        mDescUrl     =
            com.android.tools.idea.sdk.remote.internal.packages.PackageParserUtils.getXmlString(packageNode, SdkRepoConstants.NODE_DESC_URL);
        mReleaseNote =
            com.android.tools.idea.sdk.remote.internal.packages.PackageParserUtils.getXmlString(packageNode, SdkRepoConstants.NODE_RELEASE_NOTE);
        mReleaseUrl  =
            com.android.tools.idea.sdk.remote.internal.packages.PackageParserUtils.getXmlString(packageNode, SdkRepoConstants.NODE_RELEASE_URL);
        mObsolete    =
            com.android.tools.idea.sdk.remote.internal.packages.PackageParserUtils
    ...
    static String getProperty(
        ...
        return com.android.tools.idea.sdk.remote.internal.packages.PackageParserUtils.getProperty(props, propKey, defaultValue);
    }
    ...
    static int getPropertyInt(
            ...
            @NonNull String propKey,
            int defaultValue) {
        return com.android.tools.idea.sdk.remote.internal.packages.PackageParserUtils.getPropertyInt(props, propKey, defaultValue);
    }
    ...
    private Archive parseArchive(@NonNull Node archiveNode) {
        Archive a = new Archive(
                    this,
                    com.android.tools.idea.sdk.remote.internal.packages.PackageParserUtils.parseArchFilter(archiveNode),
                    com.android.tools.idea.sdk.remote.internal.packages.PackageParserUtils.getXmlString(archiveNode, SdkRepoConstants.NODE_URL),
                    com.android.tools.idea.sdk.remote.internal.packages.PackageParserUtils
                      .getXmlLong(archiveNode, SdkRepoConstants.NODE_SIZE, 0),
    ...
    /**
     * Returns whether the {@link com.android.tools.idea.sdk.remote.internal.packages.Package} has at least one {@link Archive} compatible with
     * the host platform.
     */
     ...
     */
    public abstract boolean sameItemAs(com.android.tools.idea.sdk.remote.internal.packages.Package pkg);
     ...
     *
     * @see #sameItemAs(com.android.tools.idea.sdk.remote.internal.packages.Package)
     */
    @NonNull
    public abstract UpdateInfo canBeUpdatedBy(com.android.tools.idea.sdk.remote.internal.packages.Package replacementPackage);
     ...
     * This is achieved by {@link #sameItemAs(com.android.tools.idea.sdk.remote.internal.packages.Package)} or {@link #canBeUpdatedBy(com.android.tools.idea.sdk.remote.internal.packages.Package)}.
     * <p/>
     ...
     * <p/>
     * This {@link #compareTo(com.android.tools.idea.sdk.remote.internal.packages.Package)} method is purely an implementation detail to
     ...
     */
    @Override
    public int compareTo(com.android.tools.idea.sdk.remote.internal.packages.Package other) {
    ...
    /**
     * Computes a comparison key for each package used by {@link #compareTo(com.android.tools.idea.sdk.remote.internal.packages.Package)}.
     * The key is a string.
     ...
     * {@link #compareTo(com.android.tools.idea.sdk.remote.internal.packages.Package)} method.
     * <p/>
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof com.android.tools.idea.sdk.remote.internal.packages.Package)) {
            return false;
        }
        com.android.tools.idea.sdk.remote.internal.packages.Package other = (com.android.tools.idea.sdk.remote.internal.packages.Package) obj;
