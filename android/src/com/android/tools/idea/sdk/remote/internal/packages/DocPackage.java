...
public class DocPackage extends MajorRevisionPackage implements IAndroidVersionProvider {
    ...
    public static Package create(SdkSource source,
        ...
        return new com.android.tools.idea.sdk.remote.internal.packages.DocPackage(source, props, apiLevel, codename, revision, license, description,
    ...
    public boolean sameItemAs(Package pkg) {
        if (pkg instanceof com.android.tools.idea.sdk.remote.internal.packages.DocPackage) {
            AndroidVersion rev2 = ((com.android.tools.idea.sdk.remote.internal.packages.DocPackage) pkg).getAndroidVersion();
    ...
    public UpdateInfo canBeUpdatedBy(Package replacementPackage) {
        ...
        if (!(replacementPackage instanceof com.android.tools.idea.sdk.remote.internal.packages.DocPackage)) {
            return UpdateInfo.INCOMPATIBLE;
        }

        com.android.tools.idea.sdk.remote.internal.packages.DocPackage
          replacementDoc = (com.android.tools.idea.sdk.remote.internal.packages.DocPackage)replacementPackage;
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof com.android.tools.idea.sdk.remote.internal.packages.DocPackage)) {
            return false;
        }
        com.android.tools.idea.sdk.remote.internal.packages.DocPackage other = (com.android.tools.idea.sdk.remote.internal.packages.DocPackage) obj;
        if (mVersion == null) {
