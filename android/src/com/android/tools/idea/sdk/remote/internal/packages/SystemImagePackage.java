 ...
 */
public class SystemImagePackage extends com.android.tools.idea.sdk.remote.internal.packages.MajorRevisionPackage
        implements com.android.tools.idea.sdk.remote.internal.packages.IAndroidVersionProvider, IPlatformDependency {
     ...
     *
     * @param source The {@link com.android.tools.idea.sdk.remote.internal.sources.SdkSource} where this is loaded from.
     * @param packageNode The XML element being parsed.
     * @param nsUri The namespace URI of the originating XML document, to be able to deal with
     *          parameters that vary according to the originating XML schema.
     * @param licenses The licenses loaded from the XML originating document.
     */
    public SystemImagePackage(com.android.tools.idea.sdk.remote.internal.sources.SdkSource source,
            Node packageNode,
            String nsUri,
        ...
        if (addonNode == null) {
            ...
            desc = setDescriptions(PkgDesc.Builder.newSysImg(mVersion, mTag, mAbi, (MajorRevision)getRevision()))
                    .create();
        } else {
            ...
            desc = setDescriptions(PkgDesc.Builder.newAddonSysImg(mVersion, vendor, mTag, mAbi, (MajorRevision)getRevision()))
                    .create();
        }
    ...
    protected SystemImagePackage(
            com.android.tools.idea.sdk.remote.internal.sources.SdkSource source,
            AndroidVersion platformVersion,
            int revision,
            String abi,
            Properties props,
    ...
    public static com.android.tools.idea.sdk.remote.internal.packages.Package createBroken(File abiDir, Properties props) {
        ...
        return new BrokenPackage(props, shortDesc, longDesc,
                com.android.tools.idea.sdk.remote.internal.packages.IMinApiLevelDependency.MIN_API_LEVEL_NOT_SPECIFIED,
                version==null ? com.android.tools.idea.sdk.remote.internal.packages.IExactApiLevelDependency.API_LEVEL_INVALID : version.getApiLevel(),
