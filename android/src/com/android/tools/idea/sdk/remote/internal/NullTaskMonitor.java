...
/**
 * A no-op implementation of the {@link com.android.tools.idea.sdk.remote.internal.ITaskMonitor} interface.
 * <p/>
 ...
 */
public class NullTaskMonitor implements com.android.tools.idea.sdk.remote.internal.ITaskMonitor {

    private final ILogger mLog;

    /**
     * Creates a no-op {@link com.android.tools.idea.sdk.remote.internal.ITaskMonitor} that defers logging to the specified
     * logger.
     * <p/>
     * This can be passed to methods that require a monitor when the caller doesn't
     * have any UI to update or means to report tracked progress.
