...
public interface ObservableValue<T> {
   ...
   */
  void addListener(@NotNull InvalidationListener<T> listener);

  void removeListener(@NotNull InvalidationListener<T> listener);
   ...
   */
  void addWeakListener(@NotNull InvalidationListener<T> listener);
}
