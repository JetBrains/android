...
public class InstallerData {
  ...
  @VisibleForTesting
  InstallerData(@Nullable String javaDir) {
    myJavaDir = javaDir;
  }

  private static InstallerData parse() {
    Properties properties = readProperties();
    return new InstallerData(getIfExists(properties, "jdk.dir"));
  }
  ...
  public String toString() {
    return Objects.toStringHelper(this).add("jdk.dir", myJavaDir)
      .toString();
  }

  public boolean exists() {
    return myJavaDir != null;
  }
