...
/**
 * The [AbstractTableModel] corresponding to a list of SDK components [SdkComponentTreeNode]. The tree is traversed using depth-first search
 * and each component is added to the table as a new row. Only optional components, where `isEnabled=true` are editable.
 *
