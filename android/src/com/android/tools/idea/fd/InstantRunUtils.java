...
public class InstantRunUtils {
  ...
  private static final Key<Boolean> INVOKED_VIA_ACTION = Key.create("android.instant.run.invoke.update");
  ...
  public static void setInvokedViaAction(@NotNull ExecutionEnvironment env, boolean en) {
    env.putCopyableUserData(INVOKED_VIA_ACTION, en);
  }

  public static boolean isInvokedViaAction(@NotNull ExecutionEnvironment env) {
    return Boolean.TRUE.equals(env.getCopyableUserData(INVOKED_VIA_ACTION));
  }
}
