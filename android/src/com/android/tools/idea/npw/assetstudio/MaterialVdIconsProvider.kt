...
private fun loadMaterialVdIcons(metadata: MaterialIconsMetadata,
  ...
  metadata.families.forEachIndexed { index, style ->
    ...
    }, createLoaderExecutor()).whenCompleteAsync(BiConsumer { icons, throwable ->
 ...
 */
private fun createLoaderExecutor() = ThreadPoolExecutor(
  0,
  1,
  1,
  TimeUnit.MINUTES,
...
private fun getMetadata(urlProvider: MaterialIconsMetadataUrlProvider): MaterialIconsMetadata? {
  val url = urlProvider.getMetadataUrl()
  return url?.let {
    val reader = try {
