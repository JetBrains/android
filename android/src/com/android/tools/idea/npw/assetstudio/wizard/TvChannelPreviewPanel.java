...
import com.android.tools.idea.npw.assetstudio.TvChannelIconGenerator.PreviewShape;
import com.android.tools.idea.npw.assetstudio.TvChannelIconGenerator.TvChannelIconOptions;
...
/**
 * Preview panel for TV channel icons.
 */
class TvChannelPreviewPanel extends PreviewIconsPanel {
  ...
  public void showPreviewImages(@NotNull IconGeneratorResult result) {
    ...
    List<Pair<String, BufferedImage>> list = generatedIcons.stream()
      ...
      .filter(icon -> filterPreviewIcon(icon, ((TvChannelIconOptions)result.getOptions()).previewDensity))
