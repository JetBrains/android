...
class ConfigureAndroidModuleStep(
  ...
  private val rootPanel: StudioWizardStepPanel = StudioWizardStepPanel(validatorPanel)
  private val scrollPanel: JBScrollPane = StudioWizardStepPanel.wrappedWithVScroll(rootPanel)
  ...
  init {
    ...
    bindings.bindTwoWay(SelectedItemProperty(languageCombo), getModel().language)
    bindings.bindTwoWay(SelectedItemProperty(bytecodeCombo), getModel().bytecodeLevel)
