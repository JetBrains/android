...
/**
 * Android implementation of {@link TestsPattern} so the method {@link #getClassFilter(JUnitConfiguration.Data)} can be overridden. This
 * imposes the right {@link com.intellij.psi.search.GlobalSearchScope} all around TestPackage configurations.
 */
public class AndroidTestsPattern extends TestsPattern {
  public AndroidTestsPattern(JUnitConfiguration configuration,
