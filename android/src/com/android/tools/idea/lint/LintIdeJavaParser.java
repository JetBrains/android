...
public class LintIdeJavaParser extends JavaParser {
      ...
      if (type != null) {
        if (type instanceof PsiDisjunctionType) {
          ...
          for (PsiType t : disjunctions) {
            list.add(new LintIdeJavaParser.PsiTypeDescriptor(t));
          }
          return list;
        } else {
          return Collections.<TypeDescriptor>singletonList(new LintIdeJavaParser.PsiTypeDescriptor(type));
        }
      }
    }
  ...
  private static class ResolvedPsiMethod extends ResolvedMethod {
    ...
    public Iterable<ResolvedAnnotation> getAnnotations() {
      return LintIdeJavaParser.getAnnotations(myMethod);
    }
    ...
    public Iterable<ResolvedAnnotation> getParameterAnnotations(int index) {
      ...
      if (index >= 0 && index < parameters.length) {
        return LintIdeJavaParser.getAnnotations(parameters[index]);
      }
    ...
    public boolean isInPackage(@NonNull String pkg, boolean includeSubPackages) {
      return LintIdeJavaParser.isInPackage(myMethod.getContainingClass(), pkg, includeSubPackages);
    }
  ...
  private static class ResolvedPsiVariable extends ResolvedVariable {
    ...
    @Override
    public Iterable<ResolvedAnnotation> getAnnotations() {
      return LintIdeJavaParser.getAnnotations(myVariable);
    }
  ...
  private static class ResolvedPsiField extends ResolvedField {
    ...
    @Override
    public Iterable<ResolvedAnnotation> getAnnotations() {
      return LintIdeJavaParser.getAnnotations(myField);
    }
    ...
    @Override
    public boolean isInPackage(@NonNull String pkg, boolean includeSubPackages) {
      return LintIdeJavaParser.isInPackage(myField.getContainingClass(), pkg, includeSubPackages);
    }
  ...
  private static class ResolvedPsiClass extends ResolvedClass {
    ...
    @Override
    public boolean isInPackage(@NonNull String pkg, boolean includeSubPackages) {
      return LintIdeJavaParser.isInPackage(myClass, pkg, includeSubPackages);
    }
    ...
    @Override
    public Iterable<ResolvedAnnotation> getAnnotations() {
      return LintIdeJavaParser.getAnnotations(myClass);
    }
  ...
  private static class ResolvedPsiPackage extends ResolvedPackage {
    ...
    @Override
    public Iterable<ResolvedAnnotation> getAnnotations() {
      return LintIdeJavaParser.getAnnotations(myPackage);
    }
  }
}
