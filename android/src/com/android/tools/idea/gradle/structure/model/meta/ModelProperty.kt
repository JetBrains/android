 ...
 */
interface ModelProperty<in ModelT, PropertyT> : ReadWriteProperty<ModelT, ParsedValue<PropertyT>> {
  /**
 ...
 */
interface ModelSimpleProperty<in ModelT, PropertyT> : ModelProperty<ModelT, PropertyT> {
  /**
