...
import com.android.tools.idea.gradle.structure.prototype.editor.treeview.ContainerNode;
import com.android.tools.idea.gradle.structure.prototype.editor.treeview.GradleNode;
import com.android.tools.idea.gradle.structure.prototype.editor.treeview.VariantNode;
...
class DependenciesTreeStructure extends AbstractTreeStructure {
  ...
  static class ModuleNode extends DependencyNode {
    ...
    ModuleNode(@NotNull String gradlePath, @Nullable GradleNode parentDescriptor, @Nullable ModuleDependencyMergedModel dependencyModel) {
      ...
      // Add fake children, for demo purposes.
      List<GradleNode> children = Lists.newArrayList();
      for (int i = 1; i < 4; i++) {
        GradleCoordinate coordinate = GradleCoordinate.parseCoordinateString("demo:fakeLibrary" + i + ":1.0.0");
        assert coordinate != null;
        children.add(new ArtifactNode(coordinate, null, null));
      }
