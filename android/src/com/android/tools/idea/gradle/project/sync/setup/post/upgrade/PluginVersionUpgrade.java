...
public abstract class PluginVersionUpgrade {
  private static final ExtensionPointName<PluginVersionUpgrade>
    EXTENSION_POINT_NAME = ExtensionPointName.create("com.android.gradle.sync.pluginVersionUpgrade");

  @NotNull
  public static PluginVersionUpgrade[] getExtensions() {
