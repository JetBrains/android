...
/** There is no new [GradleTask] interface, so we just add an extension [toProto] function for consistency */
fun GradleTask.toProto(): GradleProjectProto.GradleTask = GradleProjectProto.GradleTask.newBuilder()
    .setPath(path)
    .setName(name)
