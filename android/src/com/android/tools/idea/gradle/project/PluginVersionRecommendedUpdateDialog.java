...
public class PluginVersionRecommendedUpdateDialog extends DialogWrapper {
  private static final String SHOW_DO_NOT_ASK_TO_UPGRADE_PLUGIN_PROPERTY_NAME = "show.do.not.ask.upgrade.gradle.plugin.version";
  ...
  public PluginVersionRecommendedUpdateDialog(@NotNull Project project,
                                              @NotNull GradleVersion currentPluginVersion,
                                              @NotNull GradleVersion latestPluginVersion) {
    super(project);
    myProject = project;
    myCurrentPluginVersion = currentPluginVersion;
    ...
    String msg = "To take advantage of all the latest features (such as " +
                 ...
                 latestPluginVersion + " and Gradle to version " + GRADLE_LATEST_VERSION + ".<br/><br/>" +
