...
import static com.google.wireless.android.sdk.stats.GradleSyncStats.Trigger.TRIGGER_QF_ARTIFACT_INSTALLED;
  ...
  protected void execute(@NotNull Project project) {
    ...
    if (dialog != null) {
      ...
      if (dialog.showAndGet()) {
        GradleSyncInvoker.getInstance().requestProjectSyncAndSourceGeneration(project, TRIGGER_QF_ARTIFACT_INSTALLED);
      }
    }
  }
}
