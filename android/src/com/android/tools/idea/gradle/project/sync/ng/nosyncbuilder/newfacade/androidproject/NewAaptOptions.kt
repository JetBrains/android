...
data class NewAaptOptions(override val namespacing: AaptOptions.Namespacing) : AaptOptions {
  constructor(oldAaptOptions: OldAaptOptions) : this(
    AaptOptions.Namespacing.valueOf(oldAaptOptions.namespacing.name)
  )

  constructor(proto: AndroidProjectProto.AaptOptions) : this(
    AaptOptions.Namespacing.valueOf(proto.namespacing.name)
  )
}
