...
data class NewSigningConfig(
  override val name: String,
  override val storeFile: File?,
  override val storePassword: String?,
  override val keyAlias: String?
) : SigningConfig {
  constructor(oldSigningConfig: OldSigningConfig) : this(
    oldSigningConfig.name,
    oldSigningConfig.storeFile,
    oldSigningConfig.storePassword,
    oldSigningConfig.keyAlias
  )
}