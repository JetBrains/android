  ...
  AndroidModuleModel createAndroidModel(@NotNull Module module,
    ...
    if (NewGradleSync.isSingleVariantSync(module.getProject())) {
      if (androidProject.getVariants().isEmpty()) {
        ...
        if (variants != null) {
          AndroidModuleModel androidModel = createAndroidModel(module, androidProject, variants, syncIssues,
    ...
    if (variantToSelect != null) {
      AndroidModuleModel androidModel = createAndroidModel(module, androidProject, singletonList(variantToSelect), syncIssues,
