...
public final class IdeNativeAndroidProject extends IdeModel implements NativeAndroidProject {
  ...
  public IdeNativeAndroidProject(@NotNull NativeAndroidProject project) {
    this(project, new ModelCache());
  }

  @VisibleForTesting
  IdeNativeAndroidProject(@NotNull NativeAndroidProject project, @NotNull ModelCache modelCache) {
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof IdeNativeAndroidProject)) {
      return false;
    }
    IdeNativeAndroidProject project = (IdeNativeAndroidProject)o;
