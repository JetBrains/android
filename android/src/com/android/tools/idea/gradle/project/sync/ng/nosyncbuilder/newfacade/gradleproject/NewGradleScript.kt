...
data class NewGradleScript(private val sourceFile: File?): GradleScript {
  constructor(proto: GradleProjectProto.GradleScript, converter: PathConverter): this(
    if (proto.hasSourceFile()) converter.fileFromProto(proto.sourceFile) else null
  )

  override fun getSourceFile(): File? = sourceFile
}