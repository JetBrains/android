...
abstract class GradleDslModel extends GradleDslPropertiesElement {
  @NotNull private final VirtualFile myFile;
  @NotNull private final Project myProject;

  protected GradleDslModel(@NotNull VirtualFile file, @NotNull Project project, @NotNull String moduleName) {
  ...
  protected void parse(@NotNull GroovyFile myPsiFile) {
    myPsiFile.acceptChildren(new GroovyPsiElementVisitor(new GroovyElementVisitor() {
      ...
      void process(GroovyPsiElement e) {
        GradleDslParser.parse(e, GradleDslModel.this);
      }
    }));
  }
