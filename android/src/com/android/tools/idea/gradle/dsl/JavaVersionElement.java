...
public class JavaVersionElement extends GradleDslElement {
  @Nullable private String myText; // Cached myText of the element
  @Nullable private LanguageLevel myUnsavedValue;

  public JavaVersionElement(@Nullable GradleDslElement parent, @Nullable GrExpression psiElement, @NotNull String name) {
  ...
  public JavaVersionElement(@Nullable GradleDslElement parent, @NotNull String name) {
  ...
  protected GroovyPsiElement create() {
    JavaElement java = (JavaElement)myParent;
    assert java != null;
    GroovyPsiElement javaPsiElement = java.getPsiElement();
    ...
    if (java.sourceCompatibility() != null) {
      JavaVersionElement javaVersionElement = java.getProperty(JavaElement.SOURCE_COMPATIBILITY_FIELD, JavaVersionElement.class);
      if (javaVersionElement != null) {
        anchor = javaVersionElement.getPsiElement();
        value = javaVersionElement.getPsiElement();
      }
    }
    if (anchor == null && java.targetCompatibility() != null) {
      JavaVersionElement javaVersionElement = java.getProperty(JavaElement.TARGET_COMPATIBILITY_FIELD, JavaVersionElement.class);
      if (javaVersionElement != null) {
        anchor = javaVersionElement.getPsiElement();
        value = javaVersionElement.getPsiElement();
      }
