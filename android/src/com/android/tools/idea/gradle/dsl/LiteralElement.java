...
final class LiteralElement extends GradleDslElement {
  ...
  LiteralElement(@NotNull GradleDslElement parent, @NotNull String name) {
    super(parent, null, name);
  }

  LiteralElement(@NotNull GradleDslElement parent, @NotNull GroovyPsiElement psiElement, @NotNull String name, @NotNull GrLiteral literal) {
  ...
  protected GroovyPsiElement create() {
    if (!(myParent instanceof LiteralMapElement)) {
      return super.create();
    }
