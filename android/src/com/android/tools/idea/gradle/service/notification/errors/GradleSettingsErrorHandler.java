...
public class GradleSettingsErrorHandler extends AbstractSyncErrorHandler {
  @Override
  public boolean handleError(@NotNull List<String> message,
    ...
    if (OPEN_GRADLE_SETTINGS.equals(lastLine)) {
      updateNotification(notification, project, error.getMessage(), new OpenGradleSettingsHyperlink());
      return true;
    }
    return false;
  }
