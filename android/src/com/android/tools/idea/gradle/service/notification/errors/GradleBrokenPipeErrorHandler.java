...
public class GradleBrokenPipeErrorHandler extends AbstractSyncErrorHandler {
  @Override
  public boolean handleError(@NotNull List<String> message,
    ...
    if (firstLine.startsWith("Broken pipe")) {
      ...
      NotificationHyperlink hyperlink =
      ...
      updateNotification(notification, project, newMsg, hyperlink);
      return true;
    }
    return false;
  }
