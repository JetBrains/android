 ...
 */
public class GradleModelDataService implements ProjectDataService<GradleModel, Void> {
  ...
  @Override
  public void importData(@NotNull Collection<DataNode<GradleModel>> toImport, @NotNull Project project, boolean synchronous) {
    if (!toImport.isEmpty()) {
      try {
