  ...
  protected AnAction[] createActions() {
    return new AnAction[]{new ToggleAction(AndroidBundle.message("android.captures.analysis.results.manager.run.name"),
      ...
      public void update(@NotNull AnActionEvent e) {
        ...
        if (isSelected(e)) {
          presentation.setText(AndroidBundle.lazyMessage("android.captures.analysis.results.manager.run.disabled.name"));
          presentation.setDescription(AndroidBundle.lazyMessage("android.captures.analysis.results.manager.run.disabled.description"));
          presentation.setIcon(IconLoader.getDisabledIcon(AllIcons.Actions.Execute));
        }
        else {
          presentation.setText(AndroidBundle.lazyMessage("android.captures.analysis.results.manager.run.enabled.name"));
          presentation.setDescription(AndroidBundle.lazyMessage("android.captures.analysis.results.manager.run.enabled.description"));
