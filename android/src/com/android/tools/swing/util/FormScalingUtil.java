 ...
 * HiDPI scaling factor. To avoid double scaling, this class should be used immediately after the
 * <code>$$$setupUI$$$</code> method call generated by the GUI Designer, typically at the start of the
 * constructor of the class associated to the <code>.form</code> file).
 * <p>
...
public class FormScalingUtil {
   ...
   */
  public static void scaleComponentTree(Class clazz, Component root) {
   ...
   * @param root the root component of the component tree to scale
   */
  public void scaleComponentTree(Component root) {
