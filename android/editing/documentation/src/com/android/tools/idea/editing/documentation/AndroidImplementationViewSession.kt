...
class AndroidImplementationViewSessionFactory : ImplementationViewSessionFactory {
  override fun createSession(
    ...
    // createSession() is called on elements in editor. It is also called the first time you ask for
    // quick definitions on a lookupElement.
    // For this reason, we use PsiImplementationViewSession.getElement to decide which element to
    // use.
  ...
  override fun createSessionForLookupElement(
    ...
    // createSessionForLookupElement() is called on the second and subsequent requests for the quick
    // definitions of lookup items.
...
class AndroidImplementationViewSession(
  ...
  // TODO(lukeegan): Create own ImplementationViewElement to show custom text eg. entire Style Tags
  // for styleable attrs.
