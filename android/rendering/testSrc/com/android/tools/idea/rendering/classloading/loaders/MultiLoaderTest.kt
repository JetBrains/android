...
class MultiLoaderTest {
  ...
  fun `load from multiple loads`() {
    val static1 = StaticLoader("a.class1" to ByteArray(1))
    val static2 = StaticLoader("b.class2" to ByteArray(2))
    val static3 = StaticLoader("c.class3" to ByteArray(3))

    val output = StringBuilder()
    val loaders =
      listOf(MultiLoader(static1.withDebug("static1", output), static2.withDebug("static2", output), static3.withDebug("static3", output)))
  ...
  fun `cache keys are limited`() {
    val static1 = StaticLoader("a.b.c.class1" to ByteArray(1), "d.e.f.class2" to ByteArray(2), "g.h.i.class3" to ByteArray(3))
  ...
  fun `affine cache does not create unnecessary keys`() {
    val static1 = StaticLoader("a.b.class1" to ByteArray(1), "a.b.c.class1" to ByteArray(2))
