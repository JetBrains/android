  ...
  fun `check loading from cache`() {
    ...
    val cache =
      object : ClassBinaryCache {
        override fun get(fqcn: String, transformationId: String): ByteArray? = backedMap["$transformationId:$fqcn"]
    ...
    val staticLoader = StaticLoader("a.class1" to ByteArray(1), "a.class2" to ByteArray(2))

    val loader = ClassBinaryCacheLoader(staticLoader, "transformationID", cache)
