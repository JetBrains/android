 ...
 *
 *    The base path is null for the default project (identified by [Project.isDefault] == true), which is used to store defaults. In that
 *    case just the project ID is recorded as "DEFAULT", as this is not a real user project.
...
fun deviceToDeviceInfo(device: IDevice): DeviceInfo {
  return DeviceInfo.newBuilder()
    ...
    .setModel(device.getProperty(IDevice.PROP_DEVICE_MODEL) ?: "")
    .build()
}
