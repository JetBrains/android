...
class ScreenshotOptionsTest {
  ...
  fun testScreenshotViewerOptionsPropertyWithoutOrientationInfo() {
    val screenshotOptions = createScreenshotOptions(emptyDeviceProperties, DeviceType.HANDHELD)
    assertThat(screenshotOptions.screenshotViewerOptions).containsExactly(ScreenshotViewer.Option.ALLOW_IMAGE_ROTATION)
  }

  @Test
  fun testScreenshotViewerOptionsPropertyWithOrientationInfo() {
    val screenshotOptions = createScreenshotOptions(emptyDeviceProperties, DeviceType.HANDHELD, ScreenshotRotation(0, 0))
    assertThat(screenshotOptions.screenshotViewerOptions).isEmpty()
  }

  @Test
  fun testCreateScreenshotImage() {
    val screenshotOptions = createScreenshotOptions(emptyDeviceProperties, DeviceType.HANDHELD, ScreenshotRotation(0, 1))
  ...
  fun testGetFramingOptionsKnownPhone() {
    ...
    val screenshotOptions = createScreenshotOptions(deviceProperties, DeviceType.HANDHELD)
  ...
  fun testGetFramingOptionsAutomotiveMatchingAspectRatio() {
    ...
    val screenshotOptions = createScreenshotOptions(deviceProperties, DeviceType.AUTOMOTIVE)
  ...
  fun testGetFramingOptionsTv() {
    val screenshotOptions = createScreenshotOptions(emptyDeviceProperties, DeviceType.TV)
  ...
  fun testGetFramingOptionsWatch() {
    ...
    val screenshotOptions = createScreenshotOptions(deviceProperties, DeviceType.WEAR)
  ...
  private fun createScreenshotOptions(deviceProperties: DeviceProperties, deviceType: DeviceType, screenshotRotation: ScreenshotRotation? = null) =
      ScreenshotOptions(serialNumber, deviceProperties.model, deviceType, PRIMARY_DISPLAY_ID, screenshotRotation?.let { { it } })
