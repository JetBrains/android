...
public class SmaliMethodStartImpl extends ASTWrapperPsiElement implements SmaliMethodStart {
  ...
  public SmaliParameterDeclaration getParameterDeclaration() {
    return findChildByClass(SmaliParameterDeclaration.class);
  }

  @Override
  @Nullable
  public SmaliRegularMethodStart getRegularMethodStart() {
    return findChildByClass(SmaliRegularMethodStart.class);
  }
