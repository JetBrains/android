...
public class SmaliReturnTypeImpl extends ASTWrapperPsiElement implements SmaliReturnType {
  ...
  @Override
  @Nullable
  public SmaliPrimitiveType getPrimitiveType() {
    return findChildByClass(SmaliPrimitiveType.class);
  }

  @Override
  @Nullable
  public SmaliVoidType getVoidType() {
    return findChildByClass(SmaliVoidType.class);
  }
