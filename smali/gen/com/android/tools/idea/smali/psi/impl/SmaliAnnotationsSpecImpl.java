...
public class SmaliAnnotationsSpecImpl extends ASTWrapperPsiElement implements SmaliAnnotationsSpec {
  ...
  public void accept(@NotNull SmaliVisitor visitor) {
    visitor.visitAnnotationsSpec(this);
  }
  ...
  @Override
  @NotNull
  public List<SmaliAnnotationProperty> getAnnotationPropertyList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, SmaliAnnotationProperty.class);
  }
