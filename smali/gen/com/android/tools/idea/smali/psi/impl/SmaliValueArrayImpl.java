...
public class SmaliValueArrayImpl extends ASTWrapperPsiElement implements SmaliValueArray {

  public SmaliValueArrayImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull SmaliVisitor visitor) {
    visitor.visitValueArray(this);
  }
  ...
  @Override
  @Nullable
  public SmaliSingleValues getSingleValues() {
    return findChildByClass(SmaliSingleValues.class);
  }
