...
public class SmaliClassSpecImpl extends ASTWrapperPsiElement implements SmaliClassSpec {

  public SmaliClassSpecImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull SmaliVisitor visitor) {
    visitor.visitClassSpec(this);
  }
  ...
  @Override
  @NotNull
  public List<SmaliAccessModifier> getAccessModifierList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, SmaliAccessModifier.class);
  }
