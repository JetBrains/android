...
data class SingleModuleSearchQuery(override val groupId: String, override val artifactName: String) :
  GroupArtifactQuery(groupId, artifactName)

data class ArbitraryModulesSearchQuery(override val groupId: String?, override val artifactName: String?) :
  GroupArtifactQuery(groupId, artifactName)
