...
class StackFrameParserTest {
  ...
  fun parsesStack() {
    val locations =
      StackFrameParser.parseStack(
        listOf(
            ...
            "com.example.android.displayingbitmaps.util.ImageFetcher.downloadUrlToStream(ImageFetcher.java:init)", // invalid line number,
            // but valid code
            // location
    ...
    assertThat(locations)
      .containsExactly(
        CodeLocation.Builder("com.example.android.displayingbitmaps.util.ImageFetcher")
          .apply {
        ...
        CodeLocation.Builder("com.example.android.displayingbitmaps.util.ImageFetcher")
          ...
          .build(),
        CodeLocation.Builder("com.example.android.displayingbitmaps.util.ImageWorker\$BitmapWorkerTask")
          .apply {
          ...
          .build(),
        CodeLocation.Builder("com.example.android.displayingbitmaps.util.AsyncTask$2")
          .apply {
            setMethodName("call")
