...
class ApplicationIdProviderAgp35IntegrationTest : ApplicationIdProviderIntegrationTestCase() {
  companion object {
    @Suppress("unused")
    @Contract(pure = true)
    @JvmStatic
...
@RunWith(Parameterized::class)
class ApplicationIdProviderAgp40IntegrationTest : ApplicationIdProviderIntegrationTestCase() {
  companion object {
    @Suppress("unused")
    @Contract(pure = true)
    @JvmStatic
...
@RunWith(Parameterized::class)
class ApplicationIdProviderAgp41IntegrationTest : ApplicationIdProviderIntegrationTestCase() {
  companion object {
    @Suppress("unused")
    @Contract(pure = true)
    @JvmStatic
