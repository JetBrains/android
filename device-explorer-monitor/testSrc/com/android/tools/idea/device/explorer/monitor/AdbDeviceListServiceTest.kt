...
class AdbDeviceListServiceTest {
  ...
  @get:Rule val adbRule = FakeAdbServerAdbLibRule()

  @JvmField @Rule val exceptionRule: ExpectedException = ExpectedException.none()
  ...
  fun testGetDebugBridgeFailure() {
    ...
    Mockito.`when`(mockAdbService.getDebugBridge(Mockito.any(File::class.java)))
