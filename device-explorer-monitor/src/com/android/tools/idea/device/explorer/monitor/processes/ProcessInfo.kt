...
data class ProcessInfo(
  /**
   * A unique identifier of a device the process belongs to. The identifier is unique as long as the device is connected, i.e. an identifier
   * value can be re-used if a device is disconnected and another device becomes connected.
   */
...
private fun JdwpProcessInfo.toDebuggerStatus(): ClientData.DebuggerStatus =
  when {
    ...
    !properties.processName.hasValue -> ClientData.DebuggerStatus.ERROR
