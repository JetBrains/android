...
/**
 * Factory for [DeviceRenderer] instances.
 */
interface DeviceNameRendererFactory {
  fun create(deviceNamePropertiesProvider: DeviceNamePropertiesProvider): DeviceRenderer
}
