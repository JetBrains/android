...
const val COMPOSABLE_ANNOTATION_FQ_NAME_OLD ="androidx.compose.$COMPOSABLE_ANNOTATION_NAME"

// TODO(b/280029260): this is not needed since we don't need to support COMPOSABLE_ANNOTATION_FQ_NAME_OLD.
val COMPOSABLE_FQ_NAMES = setOf(
  COMPOSABLE_ANNOTATION_FQ_NAME,
  COMPOSABLE_ANNOTATION_FQ_NAME_OLD
)
