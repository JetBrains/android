...
object DesignerActions {
  const val GROUP_COMMON = "Android.Designer.CommonActions"
  const val GROUP_TOOLS = "Android.Designer.ToolsActions"
  const val GROUP_LAYOUT_EDITOR = "Android.Designer.LayoutEditorActions"

  //<editor-fold desc="Common Actions">
  const val ACTION_FORCE_REFRESH_PREVIEW = "Android.Designer.ForceRefreshPreview"
  //</editor-fold>

  //<editor-fold desc="Layout Editor Actions">
  const val ACTION_TOGGLE_DEVICE_ORIENTATION = "Android.Designer.ToggleDeviceOrientation"
  //</editor-fold>
}
