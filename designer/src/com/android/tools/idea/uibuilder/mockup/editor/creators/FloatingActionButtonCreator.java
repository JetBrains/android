 ...
 */
public class FloatingActionButtonCreator extends SimpleViewCreator {
  ...
  public JComponent getOptionsComponent(@NotNull DoneCallback doneCallback) {
    ColorChooserForm colorChooserForm =
      new ColorChooserForm("Set color as background tint", createColorSelectedListener(doneCallback));
