 ...
 *
 * We will find all transitive derived styles from the framework TextAppearance style. The resulting styles are organized in a tree with the
 * following headings: "Project", "Library", "AppCompat", "Android" where "Project" are the user defined styles.
 *
 * The Android and AppCompat TextAppearances are limited to the following: Small, Medium, Large, Body1, Body2, Display1, Display2, Display3,
 * Display4
 */
