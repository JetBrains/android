 ...
 *
 * Which is a toggle button i.e. the user can select/un-select the button. The model implements a [selected] property which uses the values
 * specified for [trueValue] and [falseValue].
 */
