...
/**
 * The [attributesMask] indicated which configuration attributes of [sourceConfig] should reflect to [responseConfig]. This mask should be
 * generated by the flags in [ConfigurationListener], e.g. [ConfigurationListener.CFG_NIGHT_MODE] and [ConfigurationListener.CFG_UI_MODE].
 */
...
/** Helper function to register [ModelsProviderConfigurationListener]. The listener will be removed when the given [model] is disposed. */
fun registerModelsProviderConfigurationListener(
  ...
  val listener = ModelsProviderConfigurationListener(model, sourceConfig, responseConfig, attributesMask)
