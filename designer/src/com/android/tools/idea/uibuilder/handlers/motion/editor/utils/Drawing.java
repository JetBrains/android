...
public class Drawing {
  ...
  static final int ZIGZAG = MEUI.scale(2);
  static final int CENTER_ZIGZAG = MEUI.scale(3);
  public static final int MARGIN_SPACING = MEUI.scale(3);
  ...
  static Font sFont = new Font("Helvetica", Font.PLAIN, MEUI.scale(12));
  static Font sFontReference = new Font("Helvetica", Font.ITALIC | Font.BOLD, MEUI.scale(12));

  private static Font sSmallFont = new Font("Helvetica", Font.PLAIN, MEUI.scale(8));

  public static Stroke
    sSpreadDashedStroke = new BasicStroke(1, BasicStroke.CAP_BUTT,
    BasicStroke.JOIN_BEVEL, 0, new float[]{1, MEUI.scale(4)}, 0);

  public static Stroke
    sDashedStroke = new BasicStroke(1, BasicStroke.CAP_BUTT,
    BasicStroke.JOIN_BEVEL, 0, new float[]{MEUI.scale(2)}, 0);

  public static final int ARROW_SIDE = MEUI.scale(6);
  public static final int CONNECTION_ARROW_SIZE = MEUI.scale(5);
  public static final int SMALL_ARROW_SIDE = MEUI.scale(4);
  public static final int SMALL_ARROW_SIZE = MEUI.scale(3);
  ...
  public static void drawRoundRectText(Graphics2D g,
    ...
    g2.drawString(text, (int) (x - tw / 2 + padding),
      (int) (y - th / 2 + fm.getAscent() + padding));
    if (DEBUG) {
      g2.setColor(Color.RED);
      g2.drawLine(x - 50, y, x + 50, y);
      g2.drawLine(x, y - 50, x, y + 50);
  ...
  /**
   * removes a zigzag (veering to right and left alternately.) from the list of points. the point
   * are modified and the shortened length is returned
   *
  ...
  public static void addVerticalSmallSpring(Path2D.Float path, int x0, int y1, int y2) {
    int springHeight = MEUI.scale(2);
    int springWidth = MEUI.scale(2);
  ...
  /**
   * Draw an horizontal, centered zig-zag line. The color and style used for the drawing will be the
   * current ones in the graphics context.
   *
  ...
  /**
   * Draw an horizontal zig-zag line. The color and style used for the drawing will be the current
   * ones in the graphics context.
   *
   * @param path path that will be added to
   * @param x1   start x point
   * @param x2   end x point
  ...
  /**
   * Draw a vertical, centered zig-zag line. The color and style used for the drawing will be the
   * current ones in the graphics context.
   *
   * @param path path that will be added to
   * @param x    x point
  ...
  /**
   * Draw a vertical zig-zag line. The color and style used for the drawing will be the current ones
