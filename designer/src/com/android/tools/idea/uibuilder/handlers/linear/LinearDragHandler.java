...
/**
 * {@link SceneDragHandler} for LinearLayout
 */
class LinearDragHandler extends DragHandler {
  ...
  public LinearDragHandler(@NotNull ViewEditor editor,
    ...
    super(editor, linearLayoutHandler, layout, components, type);
    assert !components.isEmpty();

    myVertical = linearLayoutHandler.isVertical(layout.getNlComponent());
