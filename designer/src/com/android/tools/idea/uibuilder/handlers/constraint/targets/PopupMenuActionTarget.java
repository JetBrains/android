...
public class PopupMenuActionTarget extends ActionTarget {
  static final NlIcon OVERFLOW_ICON = new NlIcon(StudioIcons.Common.OVERFLOW, StudioIcons.Common.OVERFLOW);
  ...
  public void mouseDown(@AndroidDpCoordinate int x, @AndroidDpCoordinate int y) {
    ...
    c.getScene().getDesignSurface().getActionManager().showPopup(mouseEvent, c.getNlComponent());
  }
}
