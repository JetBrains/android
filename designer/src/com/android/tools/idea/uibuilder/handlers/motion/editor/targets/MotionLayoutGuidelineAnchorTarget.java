 ...
 * Guideline anchors
 */
public class MotionLayoutGuidelineAnchorTarget extends MotionLayoutAnchorTarget {
  ...
  public MotionLayoutGuidelineAnchorTarget(@NotNull Type type, boolean isHorizontal) {
    super(type, true);
