...
object LinearPlaceholderFactory {
  ...
  @JvmStatic
  fun createVerticalPlaceholder(host: SceneComponent, anchor: SceneComponent?, snappedY: Int, left: Int, right: Int): Placeholder =
    VerticalPlaceholder(host, anchor, snappedY, left, right)

  @JvmStatic
  fun createHorizontalPlaceholder(host: SceneComponent, anchor: SceneComponent?, snappedX: Int, top: Int, bottom: Int): Placeholder =
    HorizontalPlaceholder(host, anchor, snappedX, top, bottom)
  ...
  private class VerticalPlaceholder(host: SceneComponent, anchor: SceneComponent?, private val snappedY: Int, left: Int, right: Int) :
  ...
  private class HorizontalPlaceholder(host: SceneComponent, anchor: SceneComponent?, private val snappedX: Int, top: Int, bottom: Int) :
    LinearPlaceholder(host, anchor) {
