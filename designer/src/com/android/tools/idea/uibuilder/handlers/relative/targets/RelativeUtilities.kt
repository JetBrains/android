 ...
 */
internal class AlignAttributeRules(val marginAttribute: String,
...
internal val TOP_ATTRIBUTE_RULES = AlignAttributeRules(
...
internal val BOTTOM_ATTRIBUTE_RULES = AlignAttributeRules(
  SdkConstants.ATTR_LAYOUT_MARGIN_BOTTOM,
  SdkConstants.ATTR_LAYOUT_ALIGN_PARENT_BOTTOM, { parent, coordinateY -> parent.drawBottom - coordinateY },
...
internal val START_ATTRIBUTE_RULES = AlignAttributeRules(
...
internal val RTL_START_ATTRIBUTE_RULES = AlignAttributeRules(
  SdkConstants.ATTR_LAYOUT_MARGIN_START,
  SdkConstants.ATTR_LAYOUT_ALIGN_PARENT_START,
...
internal val LEFT_ATTRIBUTE_RULES = AlignAttributeRules(
...
internal val END_ATTRIBUTE_RULES = AlignAttributeRules(
...
internal val RTL_END_ATTRIBUTE_RULES = AlignAttributeRules(
  SdkConstants.ATTR_LAYOUT_MARGIN_END,
  SdkConstants.ATTR_LAYOUT_ALIGN_PARENT_END,
  { parent, coordinateX -> coordinateX - parent.drawLeft },
...
internal val RIGHT_ATTRIBUTE_RULES = AlignAttributeRules(
