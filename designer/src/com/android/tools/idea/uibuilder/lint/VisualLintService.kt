  ...
  fun runVisualLintAnalysis(models: List<NlModel>, issueModel: IssueModel) {
    ...
    for (device in devices) {
      ...
      inflate(param).thenCompose { result ->
        ...
        analyzeAfterModelUpdate(result, inflatedModel, issues, VisualLintBaseConfigIssues())
