...
class AtfIssueExternalAnnotator : ExternalAnnotator<PsiFile, CommonPanelIssueSet>() {
  ...
  override fun doAnnotate(collectedInfo: PsiFile?): CommonPanelIssueSet? {
    ...
    val latch = CommonLintUserDataHandler.getLatch(ATF_ISSUES_LATCH, collectedInfo)
