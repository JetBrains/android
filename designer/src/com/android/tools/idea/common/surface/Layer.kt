...
/**
 * A layer can be thought of as a very lightweight [JComponent] that is stacked on top of a [DesignSurface]. The critical difference between
 * using a [Layer] and a nested [JComponent] is that the layer does not have its own coordinate system and crucially, its own clipping
 * shape.
 */
