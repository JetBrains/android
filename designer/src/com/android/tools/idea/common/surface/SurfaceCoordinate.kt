...
/**
 * The independent scaling system in DesignSurface regardless DPI of display. For example, when zoom level is 50% and ScreenScalingFactor is
 * 2, this value is 50% / 2 = 25%
 */
...
/**
 * Percentage of scaling a.k.a. zoom level (25%, 33%, 50%, etc). This value consider HDPI of display. This value is same as the zoom level
 * shows in [DesignSurface]. SurfaceZoomLevel = Surface Scale * Screen Factor
 */
@Retention(AnnotationRetention.SOURCE)
