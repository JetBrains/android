...
/**
 * Abstraction over the [DesignSurface] viewport. In scrollable surfaces, this will wrap a [JViewport]. For non-scrollable surfaces, this
...
interface DesignSurfaceViewport {
  ...
  /** The contained view in this viewport. For non-scrollable surfaces, this might be the same as [viewportComponent]. */
...
class NonScrollableDesignSurfaceViewport(val viewport: JComponent) : DesignSurfaceViewport {
  ...
  override val extentSize: Dimension
    get() = viewport.visibleRect.size // The extent size in this case is just the visible part of the design surface
