 ...
 */
open class SeamlessTextEditorWithPreview(textEditor: TextEditor, designEditor: FileEditor) :
  TextEditorWithPreview(textEditor, designEditor, "Custom View and Preview") {
