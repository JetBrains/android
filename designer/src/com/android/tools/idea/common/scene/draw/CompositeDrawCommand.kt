...
/**
 * CompositeDrawCommand is an abstract draw command that aggregates a fixed list of child draw commands that have a predefined order.
 * Derived classes provide the list of child commands as well as custom serialization.
 */
