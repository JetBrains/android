...
class DesignerEditorBackgroundHighlightingPass(editor: DesignerEditorPanel,
  ...
  override fun collectInformation(progress: ProgressIndicator) {
    val model = surfaceRef.get()?.models?.singleOrNull() ?: return
    annotator.annotateRenderInformationToLint(model)
  }

  override fun applyInformationToEditor() = Unit
}