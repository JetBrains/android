...
internal class CustomViewPreviewNotificationProvider : EditorNotifications.Provider<EditorNotificationPanel>() {
  ...
  override fun createNotificationPanel(file: VirtualFile, fileEditor: FileEditor, project: Project): EditorNotificationPanel? {
    ...
    return when (previewManager.notificationsState) {
      CustomViewPreviewManager.NotificationsState.CODE_MODIFIED -> EditorNotificationPanel(fileEditor, null, null,
      ...
      CustomViewPreviewManager.NotificationsState.BUILDING -> EditorNotificationPanel(fileEditor, null, null,
                                                                                      EditorNotificationPanel.Status.Info).apply {
        setText("Building...")
