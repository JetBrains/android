...
private val VERTICAL_BARRIER_DIRECTIONS = setOf(SdkConstants.CONSTRAINT_BARRIER_START,
                                                SdkConstants.CONSTRAINT_BARRIER_END,
                                                SdkConstants.CONSTRAINT_BARRIER_LEFT,
                                                SdkConstants.CONSTRAINT_BARRIER_RIGHT)

private val HORIZONTAL_BARRIER_DIRECTION = setOf(SdkConstants.CONSTRAINT_BARRIER_TOP,
                                                 SdkConstants.CONSTRAINT_BARRIER_BOTTOM)
      ...
      component(SdkConstants.CONSTRAINT_LAYOUT.newName())
        ...
        .children(
          component(SdkConstants.CONSTRAINT_LAYOUT_BARRIER.newName())
            ...
            .width("wrap_content")
            .height("wrap_content")
            .withAttribute(SdkConstants.SHERPA_URI, SdkConstants.ATTR_BARRIER_DIRECTION, direction)
        )
    )
