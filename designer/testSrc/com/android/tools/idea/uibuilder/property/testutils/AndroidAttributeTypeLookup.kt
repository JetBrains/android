...
/**
 * This file has data from analyzing the framework code in Android S (API 31). The result were incomplete such that a number of attributes
 * had to be remapped by hand (from the online documentation).
 *
 * This file is assumed to be the truth about the attribute types used in the framework. Use this file to verify any type mappings of
 * android framework attributes.
 *
 * Note: when adding attribute names to this list after updating the framework or a library please look up the code that is reading the
 * attribute. Examples:
 *
 * | Function                         | Type                            | Notes                                 |
 * |----------------------------------|---------------------------------|---------------------------------------|
