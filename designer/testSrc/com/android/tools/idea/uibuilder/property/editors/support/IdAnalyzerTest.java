...
public class IdAnalyzerTest extends LayoutTestCase {
  ...
  public void testConstraintLayout() {
    ...
    NlProperty property =
      new NlPropertyItem(ImmutableList.of(button2), myPropertiesManager, AUTO_URI, new AttributeDefinition(ATTR_LAYOUT_TOP_TO_TOP_OF));
  ...
  public void testRelativeLayout() {
    ...
    NlComponent button2 = findById(model, "button3");
    NlProperty property =
      new NlPropertyItem(ImmutableList.of(button2), myPropertiesManager, ANDROID_URI, new AttributeDefinition(ATTR_LAYOUT_ALIGN_START));
    IdAnalyzer analyzer = new IdAnalyzer(property);
    List<String> ids = analyzer.findIds();
  ...
  public void testRadioGroup() {
    ...
    NlProperty property =
      new NlPropertyItem(ImmutableList.of(group), myPropertiesManager, ANDROID_URI, new AttributeDefinition(ATTR_CHECKED_BUTTON));
    IdAnalyzer analyzer = new IdAnalyzer(property);
    List<String> ids = analyzer.findIds();
  ...
  public void testButton1() {
    ...
    NlProperty labelFor =
      new NlPropertyItem(ImmutableList.of(button1), myPropertiesManager, ANDROID_URI, new AttributeDefinition(ATTR_LABEL_FOR));
  ...
  public void testButton1And2() {
    ...
    NlProperty accessibility = new NlPropertyItem(ImmutableList.of(button1, button2), myPropertiesManager, ANDROID_URI,
                                                  new AttributeDefinition(ATTR_ACCESSIBILITY_TRAVERSAL_BEFORE));
