...
class IdEnumSupportTest {
  ...
  fun testAllIdAttributes() {
    // This test is here to check that all the attributes in
    // AndroidDomUtil.getSpecialAttributeNamesByType(ResourceType.ID) are supported.
  ...
  fun testAccessibilityAttribute() {
    ...
    val property =
      NlPropertyItem(
        ANDROID_URI,
        SdkConstants.ATTR_ACCESSIBILITY_TRAVERSAL_BEFORE,
        NlPropertyType.ID,
        null,
        "",
        "",
