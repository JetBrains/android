...
public class FontEnumSupportTest extends AndroidTestCase {
  ...
  public void testFindPossibleValues() {
    assertThat(mySupport.getAllValues()).containsExactly(
      ...
      new ValueWithDisplayString("sans-serif-thin", "sans-serif-thin"),
      new ValueWithDisplayString("sans-serif-light", "sans-serif-light"),
      new ValueWithDisplayString("sans-serif-medium", "sans-serif-medium"),
      new ValueWithDisplayString("sans-serif-black", "sans-serif-black"),
      new ValueWithDisplayString("sans-serif-condensed", "sans-serif-condensed"),
      new ValueWithDisplayString("sans-serif-condensed-light", "sans-serif-condensed-light"),
      new ValueWithDisplayString("sans-serif-condensed-medium", "sans-serif-condensed-medium"),
