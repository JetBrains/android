 ...
 */
public class ScoutArrangeTest6 extends SceneTest {
  @Override
  @NotNull
  ...
  public void testAlignHorizontallyRight2() {
    ...
    boolean result;
    result = ScoutChainsArrange.chainCheck(list, Scout.ChainTest.InVerticalChain);
    assertFalse(result);
    result = ScoutChainsArrange.chainCheck(list, Scout.ChainTest.InHorizontalChain);
    assertFalse(result);

    result = ScoutChainsArrange.chainCheck(list, Scout.ChainTest.IsTopOfChain);
    assertFalse(result);

    result = ScoutChainsArrange.chainCheck(list, Scout.ChainTest.IsBottomOfChain);
    assertFalse(result);

    result = ScoutChainsArrange.chainCheck(list, Scout.ChainTest.IsNearVerticalChain);
    assertFalse(result);

    result = ScoutChainsArrange.chainCheck(list, Scout.ChainTest.IsNearHorizontalChain);
    assertFalse(result);
