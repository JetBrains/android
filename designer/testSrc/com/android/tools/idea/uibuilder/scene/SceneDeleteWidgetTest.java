...
/**
 * Test delete a widget with another depending on it
 */
public class SceneDeleteWidgetTest extends SceneTest {
    ...
    return model("constraint.xml",
                 component(CONSTRAINT_LAYOUT)
                   ...
                   .children(
                     component(TEXT_VIEW)
                       .id("@id/button")
                       .withBounds(134, 370, 100, 50)
                       .width("100dp")
                       .height("50dp")
                       .withAttribute("android:layout_marginTop", "156dp")
                       .withAttribute("app:layout_constraintTop_toBottomOf", "@+id/button2")
