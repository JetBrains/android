...
class TestPositionableContent(
  ...
  override fun sizeForScale(scale: Double) = Dimension(width, height)
...
class ScanlineUtilsTest {
  ...
  fun testScanlineMapping() {
    ...
    val sceneViews = listOf(TestPositionableContent(100, 101, 10, 11), TestPositionableContent(200, 201, 12, 13))
