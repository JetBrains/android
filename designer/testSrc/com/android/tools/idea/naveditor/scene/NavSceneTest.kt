...
class NavSceneTest : NavTestCase() {
  fun testDisplayList() {
    ...
    assertEquals(
      ...
      "DrawAction,NORMAL,490.0x400.0x76.5x128.0,580.0x389.0x70.0x30.0,NORMAL\n" +
      "DrawArrow,2,UP,612.0x423.0x6.0x5.0,b2a7a7a7\n" +
      "DrawAction,NORMAL,490.0x400.0x76.5x128.0,400.0x389.0x76.5x139.0,NORMAL\n" +
      ...
      "DrawAction,EXIT,580.0x400.0x70.0x19.0,400.0x389.0x76.5x139.0,NORMAL\n" +
  ...
  fun testInclude() {
    ...
    assertEquals(
      ...
      "DrawAction,NORMAL,400.0x400.0x76.5x128.0,490.0x389.0x70.0x30.0,NORMAL\n" +
  ...
  fun testAddComponent() {
    ...
    assertEquals(
      ...
      "DrawRectangle,1,490.0x400.0x76.5x128.0,ffa7a7a7,1.0\n" +
      "DrawNavScreen,491.0x401.0x74.5x126.0\n" +
      "DrawAction,NORMAL,490.0x400.0x76.5x128.0,400.0x389.0x78.5x139.0,NORMAL\n" +
  ...
  fun testSubflow() {
    ...
    assertEquals(
      ...
      "DrawRectangle,1,490.0x400.0x76.5x128.0,ffa7a7a7,1.0\n" +
      "DrawNavScreen,491.0x401.0x74.5x126.0\n" +
      "DrawAction,NORMAL,490.0x400.0x76.5x128.0,580.0x389.0x78.5x139.0,NORMAL\n" +
      ...
      "DrawAction,EXIT,400.0x400.0x70.0x19.0,490.0x389.0x78.5x139.0,NORMAL\n" +
  ...
  fun testGlobalActions() {
    ...
    assertEquals(
      ...
      "DrawRectangle,1,580.0x400.0x76.5x128.0,ffa7a7a7,1.0\n" +
      "DrawNavScreen,581.0x401.0x74.5x126.0\n" +
      "DrawAction,NORMAL,580.0x400.0x76.5x128.0,400.0x389.0x78.5x139.0,NORMAL\n" +
      "DrawArrow,2,UP,436.25x532.0x6.0x5.0,b2a7a7a7\n" +
  ...
  fun testPopToDestination() {
    ...
    assertEquals(
      ...
      "DrawRectangle,1,400.0x400.0x76.5x128.0,ffa7a7a7,1.0\n" +
      "DrawNavScreen,401.0x401.0x74.5x126.0\n" +
      "DrawAction,NORMAL,400.0x400.0x76.5x128.0,490.0x389.0x78.5x139.0,NORMAL\n" +
      "DrawArrow,2,RIGHT,481.0x455.5x5.0x6.0,b2a7a7a7\n" +
  ...
  fun testExitActions() {
    ...
    assertEquals(
      ...
      "DrawAction,NORMAL,400.0x520.0x76.5x128.0,490.0x389.0x78.5x139.0,NORMAL\n" +
  ...
  fun testRegularActions() {
    ...
    assertEquals(
      ...
      "DrawAction,NORMAL,490.0x400.0x76.5x128.0,580.0x389.0x78.5x139.0,NORMAL\n" +
      "DrawArrow,2,RIGHT,571.0x455.5x5.0x6.0,b2a7a7a7\n" +
      "DrawAction,NORMAL,490.0x400.0x76.5x128.0,400.0x419.0x70.0x30.0,NORMAL\n" +
      ...
      "DrawAction,NORMAL,400.0x430.0x70.0x19.0,490.0x389.0x78.5x139.0,NORMAL\n" +
      "DrawArrow,2,RIGHT,481.0x455.5x5.0x6.0,b2a7a7a7\n" +
      "DrawAction,NORMAL,400.0x430.0x70.0x19.0,400.0x389.0x70.0x30.0,NORMAL\n" +
