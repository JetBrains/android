...
public class BlazeProjectSystemBuildManagerTest extends BlazeTestCase {
  ...
  public void testBlazeBuildCounter() {
    BlazeProjectSystemBuildManager.BlazeBuildCounter buildCounter =
        new BlazeProjectSystemBuildManager.BlazeBuildCounter(project);
    assertThat(buildCounter.isBuilding()).isFalse();
    buildCounter.onBuildStarted();
    assertThat(buildCounter.isBuilding()).isTrue();
    buildCounter.onBuildCompleted();
    assertThat(buildCounter.isBuilding()).isFalse();
  }
}
