...
public final class BinaryDeployInfoExtractor implements DeployInfoExtractor {
  ...
  public BinaryDeployInfoExtractor(Project project, boolean useMobileInstall, Label targetLabel) {
  ...
  public BlazeAndroidDeployInfo extract(
    ...
    return new BlazeAndroidDeployInfo(
        deployData.mergedManifest(), /* testTargetMergedManifest */ null, localApks);
  }
}
