...
import com.google.idea.bazel.java.run.BlazeJavaDebuggingSetupHandler;
...
public class BlazeKotlinDebuggingSetupHandler implements BlazeJavaDebuggingSetupHandler {
  ...
  private static Optional<String> getCoroutinesDebuggingLib(BlazeCommandRunConfiguration config) {
