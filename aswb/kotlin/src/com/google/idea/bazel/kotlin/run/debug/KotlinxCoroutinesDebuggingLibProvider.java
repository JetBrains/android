 ...
 */
package com.google.idea.bazel.kotlin.run.debug;
...
public interface KotlinxCoroutinesDebuggingLibProvider {
  ...
  static final ExtensionPointName<KotlinxCoroutinesDebuggingLibProvider> EP_NAME =
      ExtensionPointName.create("com.google.idea.bazel.kotlinxCoroutinesDebuggingLibProvider");

  Optional<String> getKotlinxCoroutinesDebuggingLib(BlazeCommandRunConfiguration config);
