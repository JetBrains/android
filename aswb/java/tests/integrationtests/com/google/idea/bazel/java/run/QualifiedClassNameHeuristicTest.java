 ...
 */
package com.google.idea.bazel.java.run;
...
public class QualifiedClassNameHeuristicTest extends BlazeIntegrationTestCase {
  ...
  public void testMatchesQualifiedClassNames() {
    ...
    TargetInfo target = new TargetInfo(Label.create("//foo:lib.JavaClass"), "java_test");
    assertThat(
            new QualifiedClassNameHeuristic()
                .matchesSource(getProject(), target, psiFile, file, null))
        .isTrue();

    target = new TargetInfo(Label.create("//foo:google.lib.JavaClass"), "java_test");
    assertThat(
            new QualifiedClassNameHeuristic()
                .matchesSource(getProject(), target, psiFile, file, null))
        .isTrue();

    target = new TargetInfo(Label.create("//foo:com.google.lib.JavaClass"), "java_test");
    assertThat(
            new QualifiedClassNameHeuristic()
                .matchesSource(getProject(), target, psiFile, file, null))
        .isTrue();
  ...
  public void testDoesNotMatchUnqualifiedClassName() {
    ...
    TargetInfo target = new TargetInfo(Label.create("//foo:JavaClass"), "java_test");
    assertThat(
            new QualifiedClassNameHeuristic()
                .matchesSource(getProject(), target, psiFile, file, null))
        .isFalse();
  ...
  public void testDoesNotMatchQualifiedClassNameWithAdditionalPathPrefix() {
    ...
    TargetInfo target =
        new TargetInfo(Label.create("//foo:foo.com.google.lib.JavaClass"), "java_test");
    assertThat(
            new QualifiedClassNameHeuristic()
                .matchesSource(getProject(), target, psiFile, file, null))
        .isFalse();
