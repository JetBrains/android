...
class MultipleJavaClassesTestContextProvider implements TestContextProvider {
  ...
  @Nullable
  private static TestContext fromClasses(@Nullable TargetInfo target, Set<PsiClass> classes) {
    if (target == null) {
      return null;
    }
  ...
  @Nullable
  private static Set<PsiClass> findAllTestClassesBeneathDirectory(PsiDirectory dir) {
    Project project = dir.getProject();
