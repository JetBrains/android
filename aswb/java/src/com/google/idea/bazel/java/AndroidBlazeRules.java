 ...
 */
package com.google.idea.bazel.java;
...
public final class AndroidBlazeRules implements Kind.Provider {
  ...
  public enum RuleTypes {
    ...
    WRAPPED_ANDROID_LOCAL_TEST(
        "_wrapped_android_local_test", LanguageClass.ANDROID, RuleType.TEST, 0),
    ...
    RuleTypes(
        String name, Collection<LanguageClass> languageClasses, RuleType ruleType, int priority) {
      this.name = name;
