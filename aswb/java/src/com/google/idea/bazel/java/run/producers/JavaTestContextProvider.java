...
class JavaTestContextProvider implements TestContextProvider {
  ...
  private static TestContext fromClass(PsiClass testClass) {
    ...
    TargetInfo target = TestTargetHeuristic.targetForPsiElement(testClass, testSize);
    if (target == null) {
      return null;
    }
  ...
  private static TestContext fromClassAndMethods(
    ...
    TargetInfo target = TestTargetHeuristic.targetForPsiElement(containingClass, testSize);
    if (target == null) {
      return null;
    }
    String methodNames =
