...
public class QuerySyncLanguageTest {

  @Test
  public void proto_to_enum_mapping_is_exhaustive() {
    for (EnumValueDescriptor lc : LanguageClass.getDescriptor().getValues()) {
      LanguageClassProto.LanguageClass protoValue = LanguageClassProto.LanguageClass.valueOf(lc);
