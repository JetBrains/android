...
public class QuerySpecTest {
  ...
  public void testGetQueryExpression_empty_query() {
    QuerySpec qs = QuerySpec.builder(QuerySpec.QueryStrategy.PLAIN)
      .supportedRuleClasses(BlazeQueryParser.getAllSupportedRuleClasses())
      .build();
