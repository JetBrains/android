 ...
 */
public class TargetTreeImpl implements TargetTree {

  public static final TargetTreeImpl EMPTY = new TargetTreeImpl(Node.EMPTY);
  private static final Joiner PATH_JOINER = Joiner.on('/');

  private final Node root;

  private TargetTreeImpl(Node root) {
    this.root = root;
  }
  ...
  public Collection<Label> getSubpackages(Path pkg) {
    return root.find(pkg.iterator())
        ...
        .map(TargetTreeImpl::new)
        .orElse(TargetTreeImpl.EMPTY)
        .getTargets();
  }
  ...
  abstract static class Node {
    ...
    static final Node EMPTY =
        new AutoValue_TargetTreeImpl_Node(ROOT_NAME, ImmutableSet.of(), ImmutableSet.of());
    ...
    static Node create(String name, ImmutableSet<Node> children, ImmutableSet<String> content) {
      return new AutoValue_TargetTreeImpl_Node(name, content, children);
    }
  ...
  static TargetTree create(Collection<Label> targets) {
    final var builder = TargetTreeImpl.builder();
  ...
  /** Builder for {@link TargetTreeImpl}. */
  private static class Builder {
    ...
    public TargetTree build() {
      return new TargetTreeImpl(buildNode());
    }
