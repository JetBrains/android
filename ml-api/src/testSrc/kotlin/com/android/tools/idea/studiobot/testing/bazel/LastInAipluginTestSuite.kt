 ...
 */
package com.android.studio.ml.testing.bazel

import com.android.tools.idea.studiobot.testing.bazel.LeakCheckerRule
import com.intellij.openapi.util.SystemInfo
import org.junit.Assume
import org.junit.Ignore
import org.junit.Test

/** A copy of LastInIdeaTestSuite, copied for the same reason as AipluginTestSuite. */
class LastInAipluginTestSuite {
  /**
  ...
  fun checkForLeaks() {
    ...
    ) // TODO(b/330534295): debug leaked projects on Windows with IntelliJ 2024.1.
