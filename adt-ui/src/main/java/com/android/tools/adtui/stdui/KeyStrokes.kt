...
object KeyStrokes {
  ...
  val CMD_BROWSE: KeyStroke = KeyStroke.getKeyStroke(KeyEvent.VK_B, AdtUiUtils.getActionMask())
  val CMD_F: KeyStroke = KeyStroke.getKeyStroke(KeyEvent.VK_F, AdtUiUtils.getActionMask())
  val CMD_HOME: KeyStroke = KeyStroke.getKeyStroke(KeyEvent.VK_SPACE, AdtUiUtils.getActionMask())
  val CMD_END: KeyStroke = KeyStroke.getKeyStroke(KeyEvent.VK_SPACE, AdtUiUtils.getActionMask())
