...
object ColoredIconGenerator {
   ...
   *
   * This method is meant to be used in renderer of selected content where the background is dark
   * blue.
   */
  @JvmStatic
   ...
   *
   * The alpha value of the source icon is maintained. It is assumed that the alpha of the target
   * [color] is 1. Note: that the actual instance of [color] may be an [JBColor] and we may end up
   * with 3 different icons in the cache created.
   */
  ...
  /**
   * Generate an icon where all the alpha values are decreased thus giving a more faint version of
   * the specified [icon].
   */
          ...
          override fun getFilter(): RGBImageFilter =
            object : RGBImageFilter() {
              ...
              override fun filterRGB(x: Int, y: Int, rgb: Int): Int =
                Color(rgb, true).deEmphasize().rgb
            }
        },
      )
    }
  ...
  /**
   * Return a [Color] where the alpha value is decreased to make a more faint version of the given
   * [Color].
   */
