...
class AttachedToolWindow<T> implements ToolWindowCallback, Disposable {
  ...
  private final class SearchAction extends AnAction implements DumbAware {
  ...
  private final class GearAction extends AnAction implements DumbAware {
    private GearAction() {
  ...
  private final class SwapAction extends AnAction implements DumbAware {
    private SwapAction() {
      super("Swap");
    }
