...
/**
 * Wraps the given [JComponent] and [JTextField] in a panel that has the appearance of a regular TextField, with the [leftComponent] placed
 * left to the [textField].
 *
