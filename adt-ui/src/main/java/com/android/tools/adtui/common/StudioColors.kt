...
val contentSelectionBackground =
  JBColor.namedColor("Content.selectionBackground", JBColor(Color(0x330478DA, true), Color(0x4C2395F5, true)))
...
val contentDeselectionBackground =
  JBColor.namedColor("Content.selectionInactiveBackground", JBColor(Color(0x33121212, true), Color(0x33EDEDED, true)))
