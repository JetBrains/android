...
/**
 * The custom cursors cannot be created in headless environment thus we cannot test them by bazel. For testing purpose, replace the
 * [AdtUiCursorType] with built-in cursors to make them testable. Be aware that the replacing cursors must not be used during the testing,
 * otherwise the test result may be false positive.
 *
