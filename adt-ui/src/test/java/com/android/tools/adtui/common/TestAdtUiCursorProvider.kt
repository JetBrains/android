 ...
 * Be aware that the replacing cursors must not be used during the testing, otherwise the test
...
class TestAdtUiCursorsProvider : AdtUiCursorsProvider {
  ...
  init {
    replacedCursorMap[AdtUiCursorType.SW_RESIZE] =
      Cursor.getPredefinedCursor(Cursor.SW_RESIZE_CURSOR)
    replacedCursorMap[AdtUiCursorType.SE_RESIZE] =
      Cursor.getPredefinedCursor(Cursor.SE_RESIZE_CURSOR)
    replacedCursorMap[AdtUiCursorType.NW_RESIZE] =
      Cursor.getPredefinedCursor(Cursor.NW_RESIZE_CURSOR)
    replacedCursorMap[AdtUiCursorType.NE_RESIZE] =
  ...
  override fun getCursor(type: AdtUiCursorType): Cursor =
    replacedCursorMap.getOrDefault(type, Cursor.getDefaultCursor())

  /**
   * Replace the given [AdtUiCursorType] type to a predefined [Cursor] for testing in headless
   * environment.
   */
