...
/**
 * Returns the first descendant satisfying the given [predicate] by doing breadth-first search starting from `this` [Component], or `null`
 * if no components satisfy the [predicate].
 */
@TestOnly
...
/**
 * Returns the first descendant of type [type] satisfying the given [predicate] by doing breadth-first search starting from `this`
...
/**
 * Returns the first descendant satisfying the given [predicate] by doing breadth-first search starting from `this` [Component].
 *
...
/** Returns a [Sequence] of descendants satisfying the given [predicate] by doing breadth-first search starting from `this` [Component]. */
@TestOnly
...
/**
 * Returns a [Sequence] of descendants of type [type] satisfying the given [predicate] by doing breadth-first search starting from `this`
 * [Component].
 */
@TestOnly
