...
public class AttachedToolWindowTest extends WorkBenchTestCase {
  ...
  public void setUp() throws Exception {
    ...
    when(myActionManager.getAction(ToolwindowHeaderDecorator.TOGGLE_DOCK_MODE_ACTION_ID)).thenReturn(new SomeAction("Docked"));
    when(myActionManager.getAction(ToolwindowHeaderDecorator.TOGGLE_FLOATING_MODE_ACTION_ID)).thenReturn(new SomeAction("Floating"));
    when(myActionManager.getAction(ToolwindowHeaderDecorator.TOGGLE_SIDE_MODE_ACTION_ID)).thenReturn(new SomeAction("Split"));
