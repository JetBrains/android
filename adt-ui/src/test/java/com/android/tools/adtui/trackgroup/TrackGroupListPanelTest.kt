...
class TrackGroupListPanelTest {
  ...
  fun multiSelectionModel() {
    ...
    val trackGroupModel1 = TrackGroupModel.newBuilder().setTitle("Group1").setSelector(TrackGroupModel.makeBatchSelector("tag1")).build()
    ...
    val trackGroupModel3 = TrackGroupModel.newBuilder().setTitle("Group3").setSelector(TrackGroupModel.makeBatchSelector("tag3")).build()
