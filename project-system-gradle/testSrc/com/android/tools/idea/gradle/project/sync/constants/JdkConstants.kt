...
val JDK_INTERNAL by lazy { ExternalSystemJdkProvider.getInstance().internalJdk.name }
...
val JDK_INTERNAL_PATH by lazy { ExternalSystemJdkProvider.getInstance().internalJdk.homePath.orEmpty() }