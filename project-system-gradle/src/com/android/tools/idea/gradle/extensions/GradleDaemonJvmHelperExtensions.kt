...
fun GradleDaemonJvmHelper.isProjectUsingDaemonJvmCriteria(project: Project, rootProjectPath: @SystemIndependent String?): Boolean {
  if (rootProjectPath == null) return false
  ...
  return GradleSyncStateHolder.getInstance(project).lastSyncedGradleVersion?.let { isProjectUsingDaemonJvmCriteria(rootProjectPath, it) }
    ?: false
}
