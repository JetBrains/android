...
internal fun findCommonAncestor(file1: File, file2: File): File {
  ...
  return path1
    .zip(path2)
    .fold(path1.root) { acc, (part1, part2) ->
...
private fun Map<out ExternalSystemSourceType?, Set<File>>.convertToExternalSourceSetModel() =
  object : ExternalSourceSet {
    override fun getSources() =
      this@convertToExternalSourceSetModel.entries.associate { (type, srcDirs) ->
        type to
          object : ExternalSourceDirectorySet {
