...
class VersionCatalogFilesGradleModel : VersionCatalogFilesModel {
  ...
  override fun getCatalogNameToFileMapping(module: Module): Map<String, String> {
    val externalProjectPath: String = ExternalSystemModulePropertyManager.getInstance(module).getRootProjectPath() ?: return mapOf()
    val projectInfo =
      ProjectDataManager.getInstance().getExternalProjectData(module.project, GradleConstants.SYSTEM_ID, externalProjectPath)
    return extractCatalogData(projectInfo)
  }
