...
@NonNls private const val SPLITTER_PROPERTY = "BuildAnalyzer.WarningsView.Splitter.Proportion"
...
class WarningsPageView(
  ...
  override val additionalControls =
    JPanel().apply {
  ...
  val detailsPanel =
    object : CardLayoutPanel<WarningsPageId, WarningsPageId, JComponent>() {
      override fun prepare(key: WarningsPageId): WarningsPageId = key

      override fun create(pageId: WarningsPageId): JComponent =
