...
class WarningsViewDetailPagesFactory(
  ...
  private fun createConfigurationCachingRootDetailsPage(uiData: ConfigurationCachingCompatibilityProjectResult,
    ...
    val contentHtml = when (uiData) {
      is AGPUpdateRequired -> """
        ...
        AGP supports configuration caching from ${uiData.recommendedVersion}.
      ...
      is NoIncompatiblePlugins -> """
        ...
        All plugins applied in this build that we know about are compatible with configuration caching.
        ...
        <a href=''>Enable configuration caching in gradle.properties.</a>
      ...
      is IncompatiblePluginsDetected -> {
        ...
        Some of the plugins applied are known to be not compatible with configuration caching in versions used in this build.
        $pluginsCountLines
  ...
  private fun createConfigurationCachingWarningPage(data: IncompatiblePluginWarning,
    ...
    val contentHtml = if (data.requiredVersion != null) """
        ...
        Update this plugin to ${data.requiredVersion} or higher to make configuration caching available.
