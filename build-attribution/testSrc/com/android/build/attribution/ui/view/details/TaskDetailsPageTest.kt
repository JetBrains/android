...
class TaskDetailsPageTest {
  ...
  fun testTaskPageOnLogicalCriticalPathWithReasons() {
    val taskData =
      mockTask(":module1", "task1", "myPlugin", 100, criticalPathDurationMs = 1000).apply {
  ...
  fun testTaskPageOnExtendedCriticalPathWithWarnings() {
    val taskData =
      mockTask(":module1", "task1", "myPlugin", 100, criticalPathDurationMs = 1000).apply {
        ...
        onExtendedCriticalPath = true
        issues = listOf(TaskIssueUiDataContainer.AlwaysRunNoOutputIssue(this), TaskIssueUiDataContainer.AlwaysRunUpToDateOverride(this))
      }
  ...
  fun testTaskPageNotOnCriticalPath() {
    val taskData =
      mockTask(":module1", "task1", "myPlugin", 50, criticalPathDurationMs = 1000).apply {
        onLogicalCriticalPath = false
  ...
  fun testTaskWhenNoPluginInfoBecauseOfConfigCache() {
    val taskData =
      mockTask(":module1", "task1", "Unknown plugin", 100, criticalPathDurationMs = 1000, pluginUnknownBecauseOfCC = true).apply {
        onLogicalCriticalPath = false
        onExtendedCriticalPath = false
      }
  ...
  fun testTaskPageShowsTaskCategoryWhenFlagEnabled() {
    ...
    val taskData =
      mockTask(":module1", "task1", "myPlugin", 50, criticalPathDurationMs = 1000, taskCategory = TaskCategory.ANDROID_RESOURCES).apply {
        onLogicalCriticalPath = false
        onExtendedCriticalPath = false
      }
