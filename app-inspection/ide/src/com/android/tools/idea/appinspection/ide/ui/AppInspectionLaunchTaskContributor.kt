...
@VisibleForTesting interface AppInspectionLaunchTask : LaunchTask
...
class AppInspectionLaunchTaskContributor : AndroidLaunchTaskContributor {
  override fun getTask(
    ...
    object : AppInspectionLaunchTask {
      private val project = configuration.project

      override fun getId() = APP_INSPECTION_ID
      override fun getDescription() =
        AppInspectionBundle.message("launch.app.inspection.tool.window")
