 ...
 *
 * When an aspect is changed, all dependent listeners receive a callback. This is useful
 * for cases such as when the user selects a connection in the details view and we want to
 * notify the rest of the UI to react to it.
 */
enum class NetworkInspectorAspect {
  ...
  /**
   * Aspect associated with the panel that shows details of a connection or a rule. The panel may
   * be empty when there is no active selection or the panel is closed manually.
   */
  DETAILS
}
