 ...
 */
package com.android.tools.idea.appinspection.inspectors.livestore.ide
...
class LiveStoreInspectorTabProvider : AppInspectorTabProvider {
  ...
  override val displayName = "LiveStore Inspector"
  override val inspectorAgentJar = AppInspectorJar("livestore-inspector_dex.jar",
