...
public class DeviceSpecCutoutTImpl extends ASTWrapperPsiElement implements DeviceSpecCutoutT {

  public DeviceSpecCutoutTImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull DeviceSpecVisitor visitor) {
    visitor.visitCutoutT(this);
  }
