...
public class DeviceSpecNavigationParamImpl extends DeviceSpecParamImpl implements DeviceSpecNavigationParam {

  public DeviceSpecNavigationParamImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull DeviceSpecVisitor visitor) {
    visitor.visitNavigationParam(this);
  }
  ...
  @Override
  @NotNull
  public DeviceSpecNavigationT getNavigationT() {
    return findNotNullChildByClass(DeviceSpecNavigationT.class);
  }
