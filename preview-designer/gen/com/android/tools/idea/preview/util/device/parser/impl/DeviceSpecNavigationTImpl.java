...
public class DeviceSpecNavigationTImpl extends ASTWrapperPsiElement implements DeviceSpecNavigationT {

  public DeviceSpecNavigationTImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull DeviceSpecVisitor visitor) {
    visitor.visitNavigationT(this);
  }
