...
public class DeviceSpecCutoutParamImpl extends DeviceSpecParamImpl implements DeviceSpecCutoutParam {

  public DeviceSpecCutoutParamImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull DeviceSpecVisitor visitor) {
    visitor.visitCutoutParam(this);
  }
  ...
  @Override
  @NotNull
  public DeviceSpecCutoutT getCutoutT() {
    return findNotNullChildByClass(DeviceSpecCutoutT.class);
  }
