 ...
 * entities. The contents of the file only reside in memory and contain some XML that will be passed to Layoutlib.
 *
 ...
 */
open class InMemoryLayoutVirtualFile(name: String, content: String, private val originFile: VirtualFile) :
