 ...
 * [LayoutEditorFileType.isResourceTypeOf] method. [layoutEditorStateType] is used for analytics (metrics). [toolbarConstructor] should
 * return a [ToolbarActionGroups] that will be displayed in the top of the preview for the [virtualFileClass].
 */
