...
class DeclarativeParserDefinition : ParserDefinition {
  ...
  override fun getCommentTokens(): TokenSet = DeclarativeTokenSets.COMMENT_TOKENS

  override fun getStringLiteralElements(): TokenSet = DeclarativeTokenSets.STRING_LITERALS
