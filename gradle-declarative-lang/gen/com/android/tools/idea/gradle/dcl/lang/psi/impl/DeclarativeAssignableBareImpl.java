...
public class DeclarativeAssignableBareImpl extends DeclarativeAssignablePropertyImpl implements DeclarativeAssignableBare {

  public DeclarativeAssignableBareImpl(@NotNull IElementType type) {
    super(type);
  }

  @Override
  public void accept(@NotNull DeclarativeVisitor visitor) {
    visitor.visitAssignableBare(this);
  }
