...
public abstract class DeclarativePropertyImpl extends CompositePsiElement implements DeclarativeProperty {

  public DeclarativePropertyImpl(@NotNull IElementType type) {
    super(type);
  }
  ...
  @Override
  @Nullable
  public DeclarativeProperty getReceiver() {
