...
public class AndroidInitialConfigurator {
  ...
  public AndroidInitialConfigurator(MessageBus bus,
    ...
    // change default keymaps to add a activate Android ToolWindow shortcut
    setActivateAndroidToolWindowShortcut();
  }

  private void setActivateAndroidToolWindowShortcut() {
  ...
  private KeyboardShortcut removeFirstKeyboardShortcut(Keymap keymap, String actionId) {
