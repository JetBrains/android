...
public final class AndroidStudioUpdateStrategyTest extends LightIdeaTestCase {
  ...
  public void testUpdateStrategyDoesNotPreferSamePlatformVersion() throws Exception {
    ...
    assertThat(new UpdateStrategy(BuildNumber.fromString("AI-182.4505.22.34.5070326"), parseUpdateData(JDOMUtil.load(updatesXml), "AI"), settings)
  ...
  public void testUpdateStrategyIgnoresLowerAndroidStudioVersion() throws Exception {
    ...
    assertThat(new UpdateStrategy(BuildNumber.fromString("AI-191.7479.19.36.5721125"), parseUpdateData(JDOMUtil.load(updatesXml), "AI"), settings)
  ...
  public void testUpdateStrategyPrefersSameAndroidStudioVersion() throws Exception {
    ...
    assertThat(new UpdateStrategy(BuildNumber.fromString("AI-191.7479.19.35.5717577"), parseUpdateData(JDOMUtil.load(updatesXml), "AI"), settings)
      .checkForUpdates().getNewBuild().getNumber().asString())
