...
public class NavGraphAttributeTest {
   ...
   *   <pre>
   *   Test Steps:
   *   1. Create a new project using the Basic Activity template.
  ...
  public void verifyAttibutePanel() throws Exception {
    ...
    NlEditorFixture editorFixture = guiTest.ideFrame()
      .getEditor()
