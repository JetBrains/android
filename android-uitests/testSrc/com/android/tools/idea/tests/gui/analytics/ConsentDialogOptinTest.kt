...
class ConsentDialogOptinTest {
  @get:Rule
  val guiTest = GuiTestRule().withTimeout(10, TimeUnit.SECONDS)

  // When running from IntelliJ, set
  // -Denable.android.analytics.consent.dialog.for.test=true
  // -Denable.android.analytics.logging.for.test=true
