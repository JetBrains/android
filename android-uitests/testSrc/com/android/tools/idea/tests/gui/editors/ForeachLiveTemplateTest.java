...
public class ForeachLiveTemplateTest {
  ...
  private static final Pattern FOR_EACH_PATTERN = Pattern.compile(FOR_EACH, Pattern.DOTALL);
   ...
   *   Expectations:
   *   1. The template for a foreach loop is added to the class file at the location of the cursor.
   *   </pre>
   */
  @Test
